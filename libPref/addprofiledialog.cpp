...
/*private*/ void AddProfileDialog::profileNameActionPerformed(ActionEvent* evt)
{
...
/*private*/ void AddProfileDialog::btnBrowseActionPerformed(ActionEvent* evt)
{
 ...
 if (chooser->showOpenDialog(this) == JFileChooser::APPROVE_OPTION)
 {
     try {
         ...
         Logger::error("Error selecting profile location", ex.getMessage());
     }
 }
}

/*private*/ void AddProfileDialog::profileFolderActionPerformed(ActionEvent* evt) {
    this->profileNameActionPerformed();
}

/*private*/ void AddProfileDialog::profileLocationActionPerformed(ActionEvent* evt) {
    this->profileNameActionPerformed();
}

/*private*/ void AddProfileDialog::btnCancelActionPerformed(ActionEvent* evt)
{
    //his->dispose();
 this->close();
}
...
//        JOptionPane.showMessageDialog(this, ex.getLocalizedMessage(), "Error Creating Profile", JOptionPane.ERROR_MESSAGE);
  Logger::error("Error saving profile", ex.getMessage());
 }
}
