...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PanelPro_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject PanelPro::staticMetaObject = {
    { &Apps::staticMetaObject, qt_meta_stringdata_PanelPro.data,
      qt_meta_data_PanelPro,  qt_static_metacall, nullptr, nullptr}
};
...
void *PanelPro::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PanelPro.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PPWindowListener_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
QT_INIT_METAOBJECT const QMetaObject PPWindowListener::staticMetaObject = {
    { &WindowListener::staticMetaObject, qt_meta_stringdata_PPWindowListener.data,
      qt_meta_data_PPWindowListener,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_PPWindowListener.stringdata0))
        return static_cast<void*>(this);
