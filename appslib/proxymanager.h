...
//    ProxyManager(QObject* parent) : Manager(parent){}
     ...
     */
 /*public*/ virtual void addManager(/*@Nonnull*/ AbstractManager* /*manager*/) =0;
     ...
     */
    /*@Nonnull*/
 /*public*/ virtual AbstractManager* getDefaultManager()  {return  nullptr;}
 ...
 /*public*/ virtual QList<AbstractManager*> getManagerList()  =0;
     ...
     * @return the list of managers
     */
    /*public*/ virtual QList<AbstractManager*> getDisplayOrderManagerList() {return QList<AbstractManager*>();}
};
