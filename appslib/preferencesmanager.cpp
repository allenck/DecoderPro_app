 ...
 *
 */
/*public*/ void PreferencesManager::initialize(/*@Nonnull*/ Profile* profile) {}//throws InitializationException;
...
template<class T>
/*public*/ QList<T>* getRequires() {return NULL;}
...
template <class t>
/*public*/ QList<T>* getProvides() {return NULL;}
/**
