 ...
 */
/*public*/ PreferenceChangeEvent::PreferenceChangeEvent(Preferences* node, QString key,
                             QString newValue) :EventObject((QObject*)node) {
    //super(node);
    this->key = key;
 ...
 */
/*public*/ Preferences* PreferenceChangeEvent::getNode() {
 ...
 */
/*public*/ QString PreferenceChangeEvent::getKey() {
    return key;
}
 ...
 */
/*public*/ QString PreferenceChangeEvent::getNewValue() {
    return newValue;
}
...
/*private*/ /*static*/ /*final*/ long PreferenceChangeEvent::serialVersionUID = 793724513368024975L;
