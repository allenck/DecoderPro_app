...
struct qt_meta_stringdata_DebugMenu_t {
    QByteArrayData data[1];
    char stringdata[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DebugMenu_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DebugMenu_t qt_meta_stringdata_DebugMenu = {
    {
QT_MOC_LITERAL(0, 0, 9) // "DebugMenu"
...
const QMetaObject DebugMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_DebugMenu.data,
      qt_meta_data_DebugMenu,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DebugMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DebugMenu.stringdata))
