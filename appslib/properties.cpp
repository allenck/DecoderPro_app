 ...
 * @since 1.2
 */
/*public*/ /*synchronized*/ void Properties::load(QTextStream* inStream) //throws IOException
{
...
//class LineReader
//{
/*public*/ LineReader::LineReader(QTextStream* inStream)
{
 common();
...
int LineReader::readLine() //throws IOException
{
 int len = 0;
 char c = 0;
...
//                             :inStream->read(inByteBuf);
  ...
  if (c != '\n' && c != '\r')
  {
   ...
   if (len == lineBuf.length())
   {
    ...
    if (newLength < 0)
    {
     newLength = /*Integer.MAX_VALUE*/INT_MAX;
    }
 ...
 */
/*private*/ QString Properties::loadConvert (QByteArray in, int off, int len, QByteArray convtBuf)
{
 if (convtBuf.length() < len)
 {
  ...
  if (newLen < 0)
  {
   newLen = /*Integer.MAX_VALUE*/INT_MAX;
  }
 ...
 * @see     #defaults
 */
/*public*/ QString Properties::getProperty(QString key) {
...
#endif
/*static*/ void Properties::XmlSupport::load(Properties* props, QTextStream* in)
//throw (IOException, InvalidPropertiesFormatException)
{
