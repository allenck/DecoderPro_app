...
/*private*/ /*static*/ /*final*/ PreferencesFactory* Preferences::_factory = Preferences::factory();

/*private*/ /*static*/ PreferencesFactory* Preferences::factory() {
#if 0
    // 1. Try user-specified system property
    QString factoryName = AccessController::doPrivileged(
...
/*private*/ /*static*/ PreferencesFactory* Preferences::factory1() {
#if 0
    ...
    QString osName = System.getProperty("os.name");
    QString platformFactory;
 ...
 */
/*public*/ /*static*/ /*final*/ int Preferences::MAX_KEY_LENGTH = 80;

/**
 * Maximum length of string allowed as a value (8192 characters).
 */
/*public*/ /*static*/ /*final*/ int Preferences::MAX_VALUE_LENGTH = 8*1024;

/**
 * Maximum length of a node name (80 characters).
 */
/*public*/ /*static*/ /*final*/ int Preferences::MAX_NAME_LENGTH = 80;
 ...
 */
/*public*/ /*static*/ Preferences* Preferences::userNodeForPackage(QString c) {
 ...
 * @see    RuntimePermission
 */
/*public*/ /*static*/ Preferences* Preferences::systemNodeForPackage(QString c) {
 ...
 */
/*private*/ /*static*/ QString Preferences::nodeName(QString c) {
//    if (c.isArray())
...
//            "Arrays have no associated preferences node.");
    ...
    if (pkgEndIndex < 0)
        return "/<unnamed>";
    QString packageName = className.mid(0, pkgEndIndex);
 ...
 * other operations).
 */
/*private*/ /*static*/ Permission* Preferences::prefsPerm = new RuntimePermission("preferences");
 ...
 * @see    RuntimePermission
 */
/*public*/ /*static*/ Preferences* Preferences::userRoot() {
#if 0
    SecurityManager security = System.getSecurityManager();
    if (security != NULL)
        security.checkPermission(prefsPerm);
#endif
    return _factory->userRoot();
}
 ...
 * @see    RuntimePermission
 */
/*public*/ /*static*/ Preferences* Preferences::systemRoot() {
#if 0
    SecurityManager security = System.getSecurityManager();
    if (security != NULL)
        security.checkPermission(prefsPerm);
#endif
    return _factory->systemRoot();
}
 ...
 */
/*public*/ /*abstract*/ void Preferences::put(QString /*key*/, QString /*value*/) {}
 ...
 */
/*public*/ /*abstract*/ QString Preferences::get(QString /*key*/, QString /*def*/) {return "";}
 ...
 *         removed with the {@link #removeNode()} method.
 */
/*public*/ /*abstract*/ void Preferences::remove(QString /*key*/) {}
 ...
 * @see #removeNode()
 */
/*public*/ /*abstract*/ void Preferences::clear() {} //throws BackingStoreException;
 ...
 */
/*public*/ /*abstract*/ void Preferences::putInt(QString /*key*/, int /*value*/) {}
 ...
 */
/*public*/ /*abstract*/ int Preferences::getInt(QString /*key*/, int /*def*/) {}
 ...
 */
/*public*/ /*abstract*/ void Preferences::putLong(QString /*key*/, long /*value*/) {}
 ...
 * @see #get(String,String)
 */
/*public*/ /*abstract*/ long Preferences::getLong(QString /*key*/, long /*def*/) {}
 ...
 * @see #get(String,String)
 */
/*public*/ /*abstract*/ void Preferences::putBoolean(QString /*key*/, bool /*value*/) {}
 ...
 */
/*public*/ /*abstract*/ bool Preferences::getBoolean(QString /*key*/, bool /*def*/) {return false;}
 ...
 */
/*public*/ /*abstract*/ void Preferences::putFloat(QString /*key*/, float /*value*/) {}
 ...
 * @see #get(String,String)
 */
/*public*/ /*abstract*/ float Preferences::getFloat(QString /*key*/, float /*def*/) {return 0.0;}
 ...
 */
/*public*/ /*abstract*/ void Preferences::putDouble(QString /*key*/, double /*value*/) {}
 ...
 * @see #get(String,String)
 */
/*public*/ /*abstract*/ double Preferences::getDouble(QString /*key*/, double /*def*/) { return 0.0;}
 ...
 * @see #get(String,String)
 */
/*public*/ /*abstract*/ void Preferences::putByteArray(QString /*key*/,QByteArray* /*value*/) {}
 ...
 */
/*public*/ /*abstract*/ QByteArray* Preferences::getByteArray(QString /*key*/, QByteArray* /*def*/) {return NULL;}
 ...
 *         removed with the {@link #removeNode()} method.
 */
/*public*/ /*abstract*/ QStringList Preferences::keys() { return QStringList();}//throws BackingStoreException;
 ...
 *         removed with the {@link #removeNode()} method.
 */
/*public*/ /*abstract*/ QStringList Preferences::childrenNames(){return QStringList();} //throws BackingStoreException;
 ...
 *         removed with the {@link #removeNode()} method.
 */
/*public*/ /*abstract*/ Preferences* Preferences::parent() {return NULL;}
 ...
 * @see #flush()
 */
/*public*/ /*abstract*/ Preferences* Preferences::node(QString pathName) {return NULL;}
 ...
 */
/*public*/ /*abstract*/ bool Preferences::nodeExists(QString pathName) {return false;}
 ...
 * @see #flush()
 */
/*public*/ /*abstract*/ void Preferences::removeNode() {} //throws BackingStoreException;
 ...
 */
/*public*/ /*abstract*/ QString Preferences::name() {return "";}
 ...
 */
/*public*/ /*abstract*/ QString Preferences::absolutePath() {return "";}
 ...
 *         preference tree.
 */
/*public*/ /*abstract*/ bool Preferences::isUserNode() {return false;}
 ...
 */
/*public*/ /*abstract*/ QString Preferences::toString() {return "";}
 ...
 */
/*public*/ /*abstract*/ void Preferences::addPreferenceChangeListener(
 ...
 */
/*public*/ /*abstract*/ void Preferences::removePreferenceChangeListener(
    PreferenceChangeListener* pcl) {}
 ...
 * @see #addPreferenceChangeListener(PreferenceChangeListener)
 */
/*public*/ /*abstract*/ void Preferences::addNodeChangeListener(NodeChangeListener* ncl) {}
 ...
 * @see #addNodeChangeListener(NodeChangeListener)
 */
/*public*/ /*abstract*/ void Preferences::removeNodeChangeListener(NodeChangeListener* ncl) {}
 ...
 *         removed with the {@link #removeNode()} method.
 */
/*public*/ /*abstract*/ void Preferences::exportNode(QTextStream* os){} //    throws IOException, BackingStoreException;
 ...
 */
/*public*/ /*abstract*/ void Preferences::exportSubtree(QTextStream* os) {}
 ...
 * @see    RuntimePermission
 */
/*public*/ /*static*/ void Preferences::importPreferences(QTextStream* is)
