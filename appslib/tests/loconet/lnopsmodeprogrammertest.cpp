...
//    Assert::assertEquals("message", "[EF 0E 7C 2F 00 7D 01 00 00 01 00 7F 7F 00]", lnis->outbound.at(lnis->outbound.size() - 1)->toString().toUpper());
 ...
 /*public*/ void LnOpsModeProgrammerTest::testBoardReadTimeout() throw (ProgrammerException) {
    ...
    Assert::assertEquals("still one message sent", 1, lnis->outbound.size());
    Assert::assertEquals("Reply status Not OK", ProgListener::FailedTimeout, pl->getRcvdStatus());
 ...
 /*public*/ void LnOpsModeProgrammerTest::testOpsReadDecoderTransponding() throw (ProgrammerException) {
    ...
    Assert::assertEquals("sent", "EF 0E 7C 2F 00 00 04 00 00 0B 00 7F 7F 00", lnis->outbound.at(0)->toString().toUpper());
 ...
 /*public*/ void LnOpsModeProgrammerTest::testOpsReadLocoNetMode() throw (ProgrammerException) {
    ...
    Assert::assertEquals("sent", "EF 0E 7C 2F 00 00 04 00 00 0B 00 7F 7F 00", lnis->outbound.at(0)->toString());
