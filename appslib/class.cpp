...
//                              Type,
//                              AnnotatedElement {
    /*private*/ /*static*/ /*final*/ int Class::ANNOTATION= 0x00002000;
    /*private*/ /*static*/ /*final*/ int Class::ENUM      = 0x00004000;
    /*private*/ /*static*/ /*final*/ int Class::SYNTHETIC = 0x00001000;
#if 0
    /*private*/ /*static*/ /*native*/ void Class::registerNatives();
     ...
     * generated.
     */
    /*private*/ Class::Class(ClassLoader* loader) {
     ...
     * @since 1.8
     */
    /*public*/ QString Class::toGenericString() {
        if (isPrimitive()) {
            return toString();
        } else {
...
//        return forName0(className, true, ClassLoader.getClassLoader(caller), caller);
    ...
    /*public*/ Field[] getFields() throws SecurityException {
        ...
        return copyFields(/*private*/GetPublicFields(null));
    }
    ...
    /*public*/ Method[] getMethods() throws SecurityException {
        checkMemberAccess(Member.PUBLIC, Reflection.getCallerClass(), true);
        return copyMethods(/*private*/GetPublicMethods());
    }
    ...
    /*public*/ Constructor<?>[] getConstructors() throws SecurityException {
        checkMemberAccess(Member.PUBLIC, Reflection.getCallerClass(), true);
        return copyConstructors(/*private*/GetDeclaredConstructors(true));
    }
    ...
    /*public*/ Field[] getDeclaredFields() throws SecurityException {
        ...
        return copyFields(/*private*/GetDeclaredFields(false));
    }
    ...
    /*public*/ Method[] getDeclaredMethods() throws SecurityException {
        checkMemberAccess(Member.DECLARED, Reflection.getCallerClass(), true);
        return copyMethods(/*private*/GetDeclaredMethods(false));
    }
    ...
    /*public*/ Constructor<?>[] getDeclaredConstructors() throws SecurityException {
        checkMemberAccess(Member.DECLARED, Reflection.getCallerClass(), true);
        return copyConstructors(/*private*/GetDeclaredConstructors(false));
    }
    ...
    /*public*/ Field getDeclaredField(String name)
        throws NoSuchFieldException, SecurityException {
        checkMemberAccess(Member.DECLARED, Reflection.getCallerClass(), true);
        Field field = searchFields(/*private*/GetDeclaredFields(false), name);
        if (field == null) {
            throw new NoSuchFieldException(name);
        }
        return field;
    ...
    /*public*/ Method getDeclaredMethod(String name, Class<?>... parameterTypes)
        throws NoSuchMethodException, SecurityException {
        checkMemberAccess(Member.DECLARED, Reflection.getCallerClass(), true);
        Method method = searchMethods(/*private*/GetDeclaredMethods(false), name, parameterTypes);
        if (method == null) {
            throw new NoSuchMethodException(getName() + "." + name + argumentTypesToString(parameterTypes));
        }
        return method;
    ...
    // be propagated to the outside world, but must instead be copied
    // via ReflectionFactory.copyField.
    /*private*/ Field[] /*private*/GetPublicFields(Set<Class<?>> traversedInterfaces) {
        checkInitted();
        Field[] res;
        ReflectionData<T> rd = reflectionData();
        if (rd != null) {
        ...
        // Local fields
        Field[] tmp = /*private*/GetDeclaredFields(true);
        addAll(fields, tmp);
        ...
        for (Class<?> c : getInterfaces()) {
            if (!traversedInterfaces.contains(c)) {
                ...
                addAll(fields, c./*private*/GetPublicFields(traversedInterfaces));
            }
        }
    ...
    // be propagated to the outside world, but must instead be copied
    // via ReflectionFactory.copyMethod.
    /*private*/ Method[] /*private*/GetPublicMethods() {
        checkInitted();
        Method[] res;
        ReflectionData<T> rd = reflectionData();
        if (rd != null) {
        ...
        for (Class<?> i : getInterfaces()) {
            inheritedMethods.addInterfaceMethods(i./*private*/GetPublicMethods());
        }
        if (!isInterface()) {
            Class<?> c = getSuperclass();
            if (c != null) {
                MethodArray supers = new MethodArray();
                supers.addAll(c./*private*/GetPublicMethods());
    ...
    /*private*/ Method getMethod0(String name, Class<?>[] parameterTypes, boolean includeStaticMethods) {
        ...
        Method res =  /*private*/GetMethodRecursive(name, parameterTypes, includeStaticMethods, interfaceCandidates);
        if (res != null)
            return res;
    ...
    /*private*/ Method /*private*/GetMethodRecursive(String name,
            Class<?>[] parameterTypes,
    ...
    {
        Constructor<T>[] constructors = /*private*/GetDeclaredConstructors((which == Member.PUBLIC));
