#ifndef JTABLEPERSISTENCEMANAGER_H
#define JTABLEPERSISTENCEMANAGER_H
#include "jtable.h"
 ...
 */
/*public*/ /*interface*/ class JTablePersistenceManager
{
  //Q_OBJECT
public:
 //JTablePersistenceManager(QObject* parent = 0) : AbstractPreferencesManager(parent){}
     ...
     * @throws NullPointerException     if the table name is null
     */
  virtual /*public*/ void persist(/*@Nonnull*/ JTable* /*table*/, bool /*resetState*/) /*throws IllegalArgumentException, NullPointerException*/{}
     ...
     * @throws NullPointerException if the table name is null
     */
    /*public*/ virtual void stopPersisting(/*@Nonnull*/ JTable* /*table*/) {}//throws NullPointerException;
     ...
     * @throws NullPointerException if the table name is null
     */
    /*public*/ virtual void clearState(/*@Nonnull*/ JTable*/*table*/) {} //throws NullPointerException;
     ...
     * @throws NullPointerException if the table name is null
     */
    /*public*/ virtual void cacheState(/*@Nonnull*/ JTable* /*table*/) {} //throws NullPointerException;
     ...
     * @throws NullPointerException if the table name is null
     */
    /*public*/ virtual void resetState(/*@Nonnull*/ JTable*/*table*/) {}//throws NullPointerException;
...
Q_DECLARE_INTERFACE(JTablePersistenceManager, "JTablePersistenceManager")
#endif // JTABLEPERSISTENCEMANAGER_H
