...
//    /*private*/ static final boolean EXPECT_FAILURE = false;
    ...
    //@Override
    /*public*/  ConditionalNG* StringFormulaTest::getConditionalNG() {
        return conditionalNG;
    }

    //@Override
    /*public*/  LogixNG* StringFormulaTest::getLogixNG() {
        return logixNG;
    }

    /*private*/ /*static*/ int StringFormulaTest::beanID = 901;

    //@Override
    /*public*/  MaleSocket* StringFormulaTest::getConnectableChild() {
        StringExpressionBean* childExpression = new StringExpressionConstant("IQSE"+QString::number(beanID++), "");
        MaleSocket* maleSocketChild = ((DefaultStringExpressionManager*)
                InstanceManager::getDefault("StringExpressionManager"))->registerExpression(childExpression);
        return maleSocketChild;
    }

    //@Override
    /*public*/  QString StringFormulaTest::getExpectedPrintedTree() {
        return QString(
                "String Formula: E1 ::: Use default\n" \
                "   ?* E1\n" \
                "      Get string constant \"Something\" ::: Use default\n" \
                "   ?* E2\n" \
                "      Socket not connected%n");
    }

    //@Override
    /*public*/  QString StringFormulaTest::getExpectedPrintedTreeFromRoot() {
        return QString(
    ...
    //@Override
    /*public*/  NamedBean* StringFormulaTest::createNewBean(QString systemName) /*throws Exception*/ {
        StringFormula* a = new StringFormula(systemName, "");
//        a.setFormula("R1");
        return a;
    }

    //@Override
    /*public*/  bool StringFormulaTest::addNewSocket() /*throws SocketAlreadyConnectedException*/ {
    ...
    //@Test
    /*public*/  void StringFormulaTest::testCtor() /*throws Exception*/ {
        StringFormula* expression2;

        expression2 = new StringFormula("IQSE321", "");
...
//        Assert::assertEquals("String matches", "Formula: R1 or R2", expression2.getLongDescription(), __FILE__, __LINE__);
        ...
        try {
            // Illegal system name
            new StringFormula("IQE55:12:XY11", "");
    ...
    //@Test
    /*public*/  void StringFormulaTest::testCtorAndSetup1() {
        StringExpressionManager* m = (DefaultStringExpressionManager*)InstanceManager::getDefault("StringExpressionManager");
        QString managerName = m->getClassName();

        QList<MaleSocket*> maleSockets = QList<MaleSocket*>();
        maleSockets.append(m->registerExpression(new StringExpressionMemory("IQSE52", "")));
        maleSockets.append(nullptr);  // This is null by purpose
        maleSockets.append(m->registerExpression(new StringExpressionMemory("IQSE554", "")));
        maleSockets.append(nullptr);  // This is null by purpose
        maleSockets.append(m->registerExpression(new StringExpressionMemory("IQSE3", "")));

        QList<StringFormula::SocketData*> expressionSystemNames = QList<StringFormula::SocketData*>();
        expressionSystemNames.append(new StringFormula::SocketData("XYZ123", "IQSE52", managerName));
        expressionSystemNames.append(new StringFormula::SocketData("ZH12", "", managerName));   // This is null by purpose
        expressionSystemNames.append(new StringFormula::SocketData("Hello", "IQSE554", managerName));
        // IQSE61232 doesn't exist by purpose
        expressionSystemNames.append(new StringFormula::SocketData("SomethingElse", "IQSE61232", managerName));
        expressionSystemNames.append(new StringFormula::SocketData("Yes123", "IQSE3", managerName));

        StringFormula* expression = new StringFormula("IQSE321", "", expressionSystemNames);
        ...
        for (int i=0; i < 5; i++) {
            StringFormula::SocketData* entry = expressionSystemNames.at(i);
            Assert::assertEquals("expression female socket name is "+entry->_socketName,
                    entry->_socketName, expression->getChild(i)->getName(), __FILE__, __LINE__);
        ...
        JUnitAppender::assertMessage("cannot load string expression IQSE61232", __FILE__, __LINE__);
...
//                        expression->getChild(i).getConnectedSocket(), __FILE__, __LINE__);
    ...
    //@Test
    /*public*/  void StringFormulaTest::testCtorAndSetup2() {
                StringExpressionManager* m = (DefaultStringExpressionManager*)InstanceManager::getDefault("StringExpressionManager");
        ...
        QList<MaleSocket*> maleSockets = QList<MaleSocket*>();
        maleSockets.append(m->registerExpression(new StringExpressionMemory("IQSE52", "")));
        maleSockets.append(m->registerExpression(new StringExpressionMemory("IQSE99", "")));
        maleSockets.append(m->registerExpression(new StringExpressionMemory("IQSE554", "")));
        maleSockets.append(m->registerExpression(new StringExpressionMemory("IQSE61232", "")));
        maleSockets.append(m->registerExpression(new StringExpressionMemory("IQSE3", "")));

        QList<StringFormula::SocketData*> expressionSystemNames = QList<StringFormula::SocketData*>();
        expressionSystemNames.append(new StringFormula::SocketData("XYZ123", "IQSE52", managerName));
        expressionSystemNames.append(new StringFormula::SocketData("ZH12", "IQSE99", managerName));
        expressionSystemNames.append(new StringFormula::SocketData("Hello", "IQSE554", managerName));
        expressionSystemNames.append(new StringFormula::SocketData("SomethingElse", "IQSE61232", managerName));
        expressionSystemNames.append(new StringFormula::SocketData("Yes123", "IQSE3", managerName));
...
//                        expression->getChild(i).getConnectedSocket(), __FILE__, __LINE__);
    ...
    //@Test
    /*public*/  void StringFormulaTest::testCtorAndSetup3() /*throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException*/ {
        QList<StringFormula::SocketData*> expressionSystemNames = QList<StringFormula::SocketData*>();
        expressionSystemNames.append(new StringFormula::SocketData("XYZ123", "IQSE52", ""));
    ...
    //@Test
    /*public*/  void StringFormulaTest::testSetChildCount() /*throws SocketAlreadyConnectedException*/ {
        StringFormula* a = (StringFormula*)_base->bself();
...
//        });
    ...
    //@Test
    /*public*/  void StringFormulaTest::testFormula() /*throws ParserException, SocketAlreadyConnectedException*/ {
        StringFormula* a = (StringFormula*)_base->bself();
    ...
    //@Test
    /*public*/  void StringFormulaTest::testGetChild() /*throws Exception*/ {
        StringFormula* expression2 = new StringFormula("IQSE321", "");
//        expression2.setFormula("R1");
        ...
        for (int i=0; i < 3; i++) {
          ...
          assertIndexOutOfBoundsException(new RWI02(expression2), i+1, i+1);
#endif
            // Connect a new child expression
            StringExpressionConstant* expr = new StringExpressionConstant("IQSE"+i, "");
            MaleSocket* maleSocket = ((DefaultStringExpressionManager*)
                    InstanceManager::getDefault("StringExpressionManager"))->registerExpression(expr);
            expression2->getChild(i)->_connect(maleSocket);
        }
    }

    //@Test
    /*public*/  void StringFormulaTest::testCategory() {
    ...
    //@Test
    /*public*/  void StringFormulaTest::testConnected_getExpressionSystemName() /*throws SocketAlreadyConnectedException*/ {
        StringFormula* expression = new StringFormula("IQSE121", "");

        StringExpressionMemory* stringExpressionMemory = new StringExpressionMemory("IQSE122", "");
        MaleSocket* maleSAMSocket =((DefaultStringExpressionManager*)
                                    InstanceManager::getDefault("StringExpressionManager"))->registerExpression(stringExpressionMemory);
        ...
        Assert::assertEquals("getExpressionSystemName(0) is correct", "IQSE122", expression->getExpressionSystemName(0), __FILE__, __LINE__);
        ...
        Assert::assertEquals("Num children is correct", 2, expression->getChildCount(), __FILE__, __LINE__);
        Assert::assertNull("getExpressionSystemName(0) is null", expression->getExpressionSystemName(0), __FILE__, __LINE__);
        Assert::assertEquals("getExpressionSystemName(1) is correct", "IQSE122", expression->getExpressionSystemName(1), __FILE__, __LINE__);
    ...
    //@Test
    /*public*/  void StringFormulaTest::testDescription() {
        StringFormula* expression = new StringFormula("IQSE321", "");
        Assert::assertEquals("strings matches", "String Formula", expression->getShortDescription(QLocale()), __FILE__, __LINE__);
        Assert::assertEquals("strings matches", "String Formula: empty", expression->getLongDescription(QLocale()), __FILE__, __LINE__);
    }

    //@Test
    /*public*/  void StringFormulaTest::testEvaluateEmptyFormula() /*throws ParserException, JmriException*/ {
        StringFormula* expression = new StringFormula("IQSE321", "");
        expression->setFormula("");
        Assert::assertEquals("Empty formula returns empty string", "", expression->evaluate(), __FILE__, __LINE__);
    }
/*
    ...
    private void testCalculate(int expectedResult, QString formula,
...
//        }
        ...
        for (int i=0; i < conditionalVariablesList.size(); i++) {
            ix1.getChild(i)->_connect((MaleSocket)conditionalVariablesList.get(i));
        }
...
*/
    ...
    //@Before
    /*public*/  void StringFormulaTest::setUp() /*throws Exception*/ {
        JUnitUtil::setUp();
        ...
        MaleSocket* maleSocket = ((DefaultDigitalActionManager*)
                InstanceManager::getDefault("DigitalActionManager"))->registerAction(doStringAction);
        conditionalNG->getChild(0)->_connect(maleSocket);

        expressionFormula = new StringFormula("IQSE321", "");
//        expressionFormula.setFormula("1");
//        expressionFormula.setFormula("true");
        expressionFormula->setFormula("E1");
        MaleSocket* maleSocketExpressionFormula = ((DefaultStringExpressionManager*)
                InstanceManager::getDefault("StringExpressionManager"))->registerExpression(expressionFormula);
        doStringAction->getChild(0)->_connect(maleSocketExpressionFormula);

        StringExpressionConstant* childExpression = new StringExpressionConstant("IQSE322", "");
        ...
        stringMemory = ((DefaultMemoryManager*)InstanceManager::getDefault("MemoryManager"))->provide("IM2");
        stringActionMemory = new StringActionMemory("IQSA1", "");
        stringActionMemory->setMemory(stringMemory);
        MaleSocket* socketAtomicBoolean = ((DefaultStringActionManager*)InstanceManager::getDefault("StringActionManager"))->registerAction(stringActionMemory);
        doStringAction->getChild(1)->_connect(socketAtomicBoolean);
    ...
    //@After
    /*public*/  void StringFormulaTest::tearDown() {
