...
//    /*public*/  abstract NamedBean createNewBean(String systemName);
    ...
    //@Test
    /*public*/  void AbstractDigitalBooleanActionTestBase::testBadSystemName() {
...
//    }
    ...
    //@Test
    /*public*/  void AbstractDigitalBooleanActionTestBase::testGetBeanType() {
        Assert::assertTrue("String matches", "Digital boolean action" == (((DigitalBooleanActionBean*)_base->bself())->getBeanType()), __FILE__, __LINE__);
    }
