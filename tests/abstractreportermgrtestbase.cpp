...
///*public*/ abstract class AbstractReporterMgrTestBase extends AbstractProvidingManagerTestBase<ReporterManager, Reporter> {
    ...
    /*public*/ void AbstractReporterMgrTestBase::testCreate() {
        Assert::assertNotNull(l->mself(), __FILE__, __LINE__);
    }
    ...
    /*public*/ void AbstractReporterMgrTestBase::testProvideName() {
        // Create
        Reporter* t = (Reporter*)((ReporterManager*)l->mself())->provide("" + getNameToTest1());
        Assert::assertTrue("real object returned ", t->self() != nullptr, __FILE__, __LINE__);
        Assert::assertTrue("system name correct ", ((NamedBean*)t->self())->equals (((ProxyReporterManager*)l->mself())->AbstractProxyManager::getBySystemName(getSystemName(getNameToTest1()))->self()), __FILE__, __LINE__);
    }

    //@Test
    /*public*/ void AbstractReporterMgrTestBase::testReporterProvideReporter() {
        // Create
        Reporter* t = ((AbstractReporterManager*)l->mself())->provideReporter("" + getNameToTest1());
        ((NamedBean*)t->self())->setUserName("Fred");
        // check
        Assert::assertTrue("real object returned ", t != nullptr, __FILE__, __LINE__);
        Assert::assertTrue("user name correct ", ((NamedBean*)t->self()) == ((AbstractReporterManager*)l->mself())->getByUserName("Fred"), __FILE__, __LINE__);
        Assert::assertTrue("system name correct ", ((NamedBean*)t->self()) == ((AbstractReporterManager*)l->mself())->getBySystemName(getSystemName(getNameToTest1())), __FILE__, __LINE__);

        // Check that "providing" an already-created Reporter* returns the same object.
        Reporter* t2 = ((AbstractReporterManager*)l->mself())->provideReporter(((NamedBean*)t->self())->getSystemName());
    ...
    /*public*/ void AbstractReporterMgrTestBase::testProvideFailure() {
        try {
            ((AbstractReporterManager*)l->mself())->provideReporter("");
        } catch (IllegalArgumentException* ex) {
          JUnitAppender::assertErrorMessage("Invalid system name for Reporter: System name must start with \"" + ((AbstractReporterManager*)l->mself())->AbstractManager::getSystemNamePrefix() + "\".", __FILE__, __LINE__);
//          throw ex;
        }
    }
    ...
    /*public*/ void AbstractReporterMgrTestBase::testReporterGetBySystemName() {
        ...
        t = (Reporter*)((AbstractReporterManager*)l->mself())->getBySystemName(getSystemName(getNameToTest1()));
        Assert::assertTrue("get retrieved existing object ", t != nullptr, __FILE__, __LINE__);

        // Try a nonexistant one. Should return null
        if (maxN()<2) return;
        t = (Reporter*)((AbstractReporterManager*)l->mself())->getBySystemName(getSystemName(getNameToTest2()));
    ...
    /*public*/ void AbstractReporterMgrTestBase::testReporterGetByUserName() {
        ...
        // Try a successful one
        t = (Reporter*)((AbstractReporterManager*)l->mself())->getByUserName("Fred");
        Assert::assertTrue("get retrieved existing object ", t != nullptr, __FILE__, __LINE__);

        // Try a nonexistant one. Should return null
        t = (Reporter*)((AbstractReporterManager*)l->mself())->getBySystemName("Barney");
        Assert::assertTrue("get nonexistant object ", t == nullptr, __FILE__, __LINE__);
    }
    ...
    /*public*/ void AbstractReporterMgrTestBase::testReporterGetByDisplayName() {
        ...
        // Try a successful one
        t = ((AbstractReporterManager*)l->mself())->getByDisplayName(getSystemName(getNameToTest1()));
        Assert::assertTrue("get retrieved existing object ", t != nullptr, __FILE__, __LINE__);

        Reporter* t2 = ((AbstractReporterManager*)l->mself())->getByDisplayName("Fred");
    ...
    /*public*/ void AbstractReporterMgrTestBase::testReporterProvideByNumber() {
        // Create
        Reporter* t = ((AbstractReporterManager*)l->mself())->provideReporter("1");
    ...
    /*public*/ void AbstractReporterMgrTestBase::testSingleObject() {
        ...
        Reporter* t1 = ((ProxyReporterManager*)l->mself())->newReporter(getSystemName(getNameToTest1()), "mine");
        Assert::assertTrue("t1 real object returned ", t1 != nullptr, __FILE__, __LINE__);
        Assert::assertTrue("same by user ", ((NamedBean*)t1->self()) == ((AbstractReporterManager*)l->mself())->getByUserName("mine"), __FILE__, __LINE__);
        Assert::assertTrue("same by system ", ((NamedBean*)t1->self()) == ((AbstractReporterManager*)l->mself())->getBySystemName(getSystemName(getNameToTest1())), __FILE__, __LINE__);

        Reporter* t2 = ((AbstractReporterManager*)l->mself())->newReporter(getSystemName(getNameToTest1()), "mine");
    ...
    /*public*/ void AbstractReporterMgrTestBase::testMisses() {
        ...
        Assert::assertTrue(nullptr == ((AbstractReporterManager*)l->mself())->getByUserName("foo"), __FILE__, __LINE__);
        Assert::assertTrue(nullptr == ((AbstractReporterManager*)l->mself())->getBySystemName("bar"), __FILE__, __LINE__);
    }
    ...
    /*public*/ void AbstractReporterMgrTestBase::testUpperLower() {
        ...
        Assert::assertNull(((AbstractReporterManager*)l->mself())->getReporter(name.toLower())->self(), __FILE__, __LINE__);
    }

    //@Test
    /*public*/ void AbstractReporterMgrTestBase::testRename() {
        // get reporter
        Reporter* t1 = ((ProxyReporterManager*)l->mself())->newReporter(getSystemName(getNameToTest1()), "before");
        Assert::assertNotNull("t1 real object ", t1->self(), __FILE__, __LINE__);
        ((NamedBean*)t1->self())->setUserName("after");
        Reporter* t2 =(Reporter*) ((AbstractReporterManager*)l->mself())->getByUserName("after");
        Assert::assertEquals("same object", t1, t2, __FILE__, __LINE__);
        Assert::assertEquals("no old object", nullptr, ((AbstractReporterManager*)l->mself())->getByUserName("before")->self(), __FILE__, __LINE__);
    }
