 ...
 * @author Jim Graham
 */
/*public*/ /*interface*/ class PathIterator : public QObject
{
 Q_OBJECT
public:
 PathIterator() : QObject() {}
 enum OPTIONS
 {
    /**
     ...
     */
    /*QNative*/ /*public*/  WIND_EVEN_ODD       = 0,
     ...
     * @see #WIND_NON_ZERO
     */
    /*public*/ virtual int getWindingRule() {return 0;}
