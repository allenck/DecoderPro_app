...
class TreePath;
/*public*/ class LIBLAYOUTEDITORSHARED_EXPORT TreeModel  : public AbstractNamedBean
{
    Q_OBJECT
public:
 TreeModel(QObject* parent) : AbstractNamedBean(parent) {}
    /**
     ...
     */
    /*public*/ virtual QObject* getRoot() = 0;
     ...
     */
    /*public*/ virtual QObject* getChild(QObject* parent, int index) = 0;
     ...
     */
    /*public*/ virtual bool isLeaf(QObject* node) = 0;
    ...
    /**
      ...
      */
    /*public*/ virtual void valueForPathChanged(TreePath* path, QVariant newValue) = 0;
     ...
     */
    /*public*/ virtual int getIndexOfChild(QObject* parent, QObject* child) = 0;
...
//
     ...
     */
    virtual void addTreeModelListener(TreeModelListener*/* l*/) {}
