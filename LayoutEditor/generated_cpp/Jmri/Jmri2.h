...
{
public:
    PythonQtShell_VetoableChangeSupport(QObject*  parent = nullptr):VetoableChangeSupport(parent),_wrapper(NULL) {}
...
public:
public slots:
VetoableChangeSupport* new_VetoableChangeSupport(QObject*  parent = nullptr);
