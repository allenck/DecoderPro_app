...
/*public*/ class  DropTargetListener : public EventListener
{
    ...
    virtual void dragEnter(DropTargetDragEvent* /*dtde*/) {}
    ...
    virtual void dragOver(DropTargetDragEvent* /*dtde*/) {}
    ...
    virtual void dropActionChanged(DropTargetDragEvent* /*dtde*/) {}
    ...
    virtual void dragExit(DropTargetEvent* /*dte*/) {}
    ...
    virtual void drop(DropTargetDropEvent* /*dtde*/){}
