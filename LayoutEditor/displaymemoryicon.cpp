...
/*public*/ DisplayMemoryIcon::DisplayMemoryIcon(QString s, Editor* editor, QObject *parent) :    PositionableLabel(s,editor,(Positionable*)parent)
{
    //super(s, editor);
...
/*public*/ DisplayMemoryIcon::DisplayMemoryIcon(NamedIcon* s, Editor* editor, QObject *parent):
...
/*public*/ Positionable* DisplayMemoryIcon::deepClone()
{
 MemoryIcon* pos = new MemoryIcon("", _editor);
 return finishClone((Positionable*)pos);
}

/*public*/ Positionable* DisplayMemoryIcon::finishClone(Positionable* p)
{
...
/*public*/ NamedIcon* DisplayMemoryIcon::getDefaultIcon() {
    return defaultIcon;
}

/*private*/ void DisplayMemoryIcon::setMap()
{
...
void DisplayMemoryIcon::on_propertyChange(QString sType, QVariant /*sOld*/, QVariant sNew)
{
 ...
 */
/*public*/ void DisplayMemoryIcon::setMemory(NamedBeanHandle<Memory*>* m)
{
 if (namedMemory != NULL)
 {
...
/*public*/ NamedBeanHandle<Memory*>* DisplayMemoryIcon::getNamedMemory()
{ return namedMemory; }

/*public*/ Memory* DisplayMemoryIcon::getMemory()
{
 if (namedMemory==NULL)
 {
  return NULL;
...
/*public*/ NamedBean* DisplayMemoryIcon::getNamedBean(){
    return getMemory();
}

/*public*/ QMap<QString, NamedIcon*>* DisplayMemoryIcon::getMap() { return map; }
// display icons

/*public*/ void DisplayMemoryIcon::addKeyAndIcon(NamedIcon* icon, QString keyValue)
{
...
/*public*/ QString DisplayMemoryIcon::getNameString() {
    QString name;
...
/*public*/ bool DisplayMemoryIcon::showPopUp(QMenu* popup)
{
...
void DisplayMemoryIcon::on_act_triggered(QString key)
{
 setValue(key);
}
...
*/
/*public*/ bool DisplayMemoryIcon::setTextEditMenu(QMenu* popup)
{
...
void DisplayMemoryIcon::on_editMemoryValueAction_triggered()
{
...
/*protected*/ void DisplayMemoryIcon::flipIcon(int flip)
{
 ...
 * Memory.
 */
/*public*/ void DisplayMemoryIcon::displayState()
{
...
/*protected*/ void DisplayMemoryIcon::displayState(QVariant key)
{
 if (key != QVariant())
 {
  if (map == NULL)
...
/*protected*/ QVariant DisplayMemoryIcon::updateMemoryFromRosterVal(RosterEntry* roster)
{
 re=roster;
...
/*public*/ void DisplayMemoryIcon::updateSize()
{
...
/*public*/ void DisplayMemoryIcon::setOriginalLocation(int x, int y)
{
 originalX=x;
 originalY=y;
 updateSize();
...
/*public*/ int DisplayMemoryIcon::getOriginalY()
{
 return originalY;
}

/*public*/ void DisplayMemoryIcon::setLocation(int x, int y)
{
 if(_popupUtil->getFixedWidth()==0)
 {
...
/*protected*/ void DisplayMemoryIcon::edit()
{
...
void DisplayMemoryIcon::editMemory() {
...
/*protected*/ void DisplayMemoryIcon::editMemoryValue(){
...
#endif
/*public*/ void DisplayMemoryIcon::updateBlockValueOnChange(bool boo){
    updateBlockValue = boo;
}

/*public*/ bool DisplayMemoryIcon::updateBlockValueOnChange()
{
    return updateBlockValue;
}


/*protected*/ void DisplayMemoryIcon::addRosterToMemory(RosterEntry* roster)
{
...
//            options[2]);
 int n = QMessageBox::question(getEditor(), tr("Assign Loco"), tr("Would you like to assign loco ")
    ...
    /*protected*/ void DisplayMemoryIcon::setValue(QVariant val)
    {
