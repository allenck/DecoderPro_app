...
public:
     ...
     */
    /*public*/ static /*final*/ QString ARGV;// = "javax.script.argv";

    /**
     * Reserved key for a named value that is
     * the name of the file being executed.
     */
    /*public*/ static /*final*/ QString FILENAME;// = "javax.script.filename";

    /**
     * Reserved key for a named value that is
     * the name of the <code>ScriptEngine</code> implementation.
     */
    /*public*/ static /*final*/ QString ENGINE;// = "javax.script.engine";

    /**
     * Reserved key for a named value that identifies
     * the version of the <code>ScriptEngine</code> implementation.
     */
    /*public*/ static /*final*/ QString ENGINE_VERSION;// = "javax.script.engine_version";
     ...
     **/
    /*public*/ virtual Bindings* createBindings() {return NULL;}
     ...
     */
    /*public*/ virtual ScriptContext* getContext() {return NULL;}
     ...
     */
    /*public*/ virtual ScriptEngineFactory* getFactory() {return NULL;}
};
