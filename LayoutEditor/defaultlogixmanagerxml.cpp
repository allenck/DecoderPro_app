...
/*public*/ QDomElement DefaultLogixManagerXml::store(QObject* o)
{
 ...
 LogixManager* tm = (DefaultLogixManager*) o;
 if (tm!=NULL)
 {
  ...
  while (iter.hasNext())
  {
   ...
   Logix* x = (DefaultLogix*)tm->getBySystemName(sname)->self();
...
/*public*/ void DefaultLogixManagerXml::loadLogixs(QDomElement logixs) {
 ...
 LogixManager* tm = (DefaultLogixManager*)InstanceManager::getDefault("LogixManager");
