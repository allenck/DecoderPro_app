...
HitPointType::HitPointType(QObject *parent) : QObject(parent)
{
...
//    TURNTABLE_RAY_63   //     113
     ...
     */
    /*protected*/ /*static*/ bool HitPointType::isConnectionHitType(HitPointType::TYPES hitType) {
        switch (hitType) {
            case POS_POINT:
            case TURNOUT_A:
            case TURNOUT_B:
     ...
     */
    /*protected*/ /*static*/ bool HitPointType::isControlHitType(HitPointType::TYPES hitType) {
        switch (hitType) {
            case TURNOUT_CENTER:
            case SLIP_CENTER:
            case SLIP_LEFT:
    ...
    /*protected*/ /*static*/ bool HitPointType::isSlipHitType(HitPointType::TYPES hitType) {
    ...
    /*protected*/ /*static*/ bool HitPointType::isTurntableRayHitType(HitPointType::TYPES hitType) {
        return (hitType >=  (HitPointType::TURNTABLE_RAY_0) ) && (hitType <=  (HitPointType::TURNTABLE_RAY_63));
    }
     ...
     */
    /*protected*/ /*static*/ bool HitPointType::isPopupHitType(HitPointType::TYPES hitType) {
        switch (hitType) {
            case LEVEL_XING_CENTER:
            case POS_POINT:
            case SLIP_CENTER:
...
//        return HitPointType::values()[(SHAPE_POINT_0.ordinal() + i)];
     ...
     */
    /*protected*/ /*static*/ QVector<HitPointType::TYPES> HitPointType::shapePointValues() {
        return QVector<HitPointType::TYPES>{SHAPE_POINT_0, SHAPE_POINT_1, SHAPE_POINT_2, SHAPE_POINT_3, SHAPE_POINT_4, SHAPE_POINT_5, SHAPE_POINT_6, SHAPE_POINT_7, SHAPE_POINT_8, SHAPE_POINT_9};
    }

    /*protected*/ /*static*/ bool HitPointType::isShapePointOffsetHitPointType(HitPointType::TYPES t) {
        return (t >= (SHAPE_POINT_0)) && (t <= (SHAPE_POINT_9));
    }
    // limited use, remove?
...
//    }
    ...
    // limited use, remove?
    /*public*/ /*static*/ /*final*/ int HitPointType::NUM_BEZIER_CONTROL_POINTS = 9;
