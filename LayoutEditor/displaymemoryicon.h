...
class LIBLAYOUTEDITORSHARED_EXPORT DisplayMemoryIcon : public PositionableLabel
{
    Q_OBJECT
public:
    //explicit DisplayMemoryIcon(QObject *parent = 0);
    /*public*/ DisplayMemoryIcon(QString s, Editor* editor, QObject *parent = 0);
    /*public*/ DisplayMemoryIcon(NamedIcon* s, Editor* editor, QObject *parent = 0);
...
/*protected*/ QVariant updateMemoryFromRosterVal(RosterEntry* roster);
/*protected*/ bool flipRosterIcon;// = false;
//This is used by the LayoutEditor
/*protected*/ bool updateBlockValue;// = false;
/*protected*/ virtual void addRosterToMemory(RosterEntry* roster);
...
public:
 AddIconActionListener(DisplayMemoryIcon* parent);
