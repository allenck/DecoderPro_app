...
//    explicit TrackSegment(QObject *parent = 0);
  /*public*/ TrackSegment(/*@Nonnull*/ QString id,
...
//    /*private*/ QList<QPointF> bezierControlPoints;// = QList<QPointF>(); // list of control point displacements
    ...
    /*private*/ QString getConnectName(LayoutTrack* o, HitPointType::TYPES type);
...
// /*private*/ int tunnelEntranceWidth = 16;
  ...
  */
 /*private*/ double centreSegX = 0.;
 /*private*/ double centreSegY = 0.;
...
protected:
 ...
 /*protected*/ void setNewConnect1(LayoutTrack *o, HitPointType::TYPES type);
 /*protected*/ void setNewConnect2(LayoutTrack* o, HitPointType::TYPES type);
 /*protected*/ LayoutTrack* connect1 = nullptr;
 /*protected*/ HitPointType::TYPES type1 = HitPointType::NONE;
 /*protected*/ LayoutTrack* connect2 = nullptr;
 /*protected*/ HitPointType::TYPES type2 = HitPointType::NONE;
