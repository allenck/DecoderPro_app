...
PositionablePropertiesUtil::PositionablePropertiesUtil(PositionablePopupUtil* p, QWidget* parent):
    QDialog(parent),
...
// ui->fontComboBox->setCurrentFont(((PositionableLabel*)pop->_parent)->getFont());
 QFont f = font();
 if(qobject_cast<PositionableLabel*>(pop->_parent))
 {
  f = ((PositionableLabel*)pop->_parent)->getFont();
  ui->fontComboBox->setCurrentFont(((PositionableLabel*)pop->_parent)->getFont());
...
//      }
 ...
 if(qobject_cast<SensorIcon*>(pop->_parent) != NULL)
 {
 ...
 ((SensorIcon*)pop->_parent)->setLocation(ui->xPosition->value(), ui->yPosition->value());
 ...
 if(qobject_cast<MemoryIcon*>(pop->_parent))
 {
...
//  yPos = ((PositionableLabel*)pop->_parent)->getY();
  ((PositionableLabel*)pop->_parent)->setLocation(ui->xPosition->value(),ui->yPosition->value());
 }
...
//  pop->getBackground();
 ...
 if(qobject_cast<MemoryIcon*>(pop->_parent)!= NULL)
 {
  MemoryIcon* pm = (MemoryIcon*) pop->_parent;
  xPos = pm->getOriginalX();
  yPos = pm->getOriginalY();
