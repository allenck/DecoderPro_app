...
ConsistToolFrame::ConsistToolFrame(QWidget *parent) :
  JmriJFrame(parent)
{
}
#if 0
...
/*public*/ ConsistToolFrame() {
    ...
    isAdvancedConsist = new QRadioButton(tr("AdvancedConsistButtonText"));
    isCSConsist = new QRadioButton(tr("CommandStationConsistButtonText"));
    deleteButton = new QPushButton();
     throttleButton = new QPushButton();
    reverseButton = new QPushButton();
    textLocoLabel = new QLabel();
    locoSelector = new DccLocoAddressSelector();
    locoRosterBox;
     addLocoButton = new QPushButton();
     resetLocoButton = new QPushButton();
    locoDirectionNormal = new QCheckBox(rb.getString("DirectionNormalText"));
    consistModel = new ConsistDataModel(1, 4);
    consistTable = new JTable(consistModel);
    ConsistMan = NULL;
    _status = new QLabel*(tr("DefaultStatusText"));
