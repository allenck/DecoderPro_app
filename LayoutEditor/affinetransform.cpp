 ...
 * The implementations of <code>qSin()</code> and
 * <code>qCos()</code> correspondingly never return 0.0
 * for any case other than <code>qSin(0.0)</code>.
 ...
 * <code>qSin()</code> and <code>qCos()</code> methods
 ...
 * rotation if either <code>qSin(<em>theta</em>)</code> or
 * <code>qCos(<em>theta</em>)</code> returns exactly 1.0 or -1.0.
...
/*
    ...
    */
   /*private*/ /*static*/ /*final*/ int AffineTransform::TYPE_UNKNOWN = -1;
    ...
    * @since 1.2
    */
   /*public*/ /*static*/ /*final*/ int AffineTransform::TYPE_IDENTITY = 0;
    ...
    * @since 1.2
    */
   /*public*/ /*static*/ /*final*/ int AffineTransform::TYPE_TRANSLATION = 1;
    ...
    * @since 1.2
    */
   /*public*/ /*static*/ /*final*/ int AffineTransform::TYPE_UNIFORM_SCALE = 2;
    ...
    * @since 1.2
    */
   /*public*/ /*static*/ /*final*/ int AffineTransform::TYPE_GENERAL_SCALE = 4;
    ...
    * @since 1.2
    */
   /*public*/ /*static*/ /*final*/ int AffineTransform::TYPE_MASK_SCALE = (AffineTransform::TYPE_UNIFORM_SCALE |
    ...
    * @since 1.2
    */
   /*public*/ /*static*/ /*final*/ int AffineTransform::TYPE_FLIP = 64;
    ...
    * @since 1.2
    */
   /*public*/ /*static*/ /*final*/ int AffineTransform::TYPE_QUADRANT_ROTATION = 8;
 ...
 * @since 1.2
 */
/*public*/ /*static*/ /*final*/ int AffineTransform::TYPE_GENERAL_ROTATION = 16;
 ...
 * @since 1.2
 */
/*public*/ /*static*/ /*final*/ int AffineTransform::TYPE_MASK_ROTATION = (TYPE_QUADRANT_ROTATION | TYPE_GENERAL_ROTATION);
 ...
 * @since 1.2
 */
/*public*/ /*static*/ /*final*/ int AffineTransform::TYPE_GENERAL_TRANSFORM = 32;
 ...
 * @see #state
 */
/*static*/ /*final*/ int AffineTransform::APPLY_IDENTITY = 0;
 ...
 * @see #state
 */
/*static*/ /*final*/ int AffineTransform::APPLY_TRANSLATE = 1;
 ...
 * @see #state
 */
/*static*/ /*final*/ int AffineTransform::APPLY_SCALE = 2;
 ...
 * @see #state
 */
/*static*/ /*final*/ int AffineTransform::APPLY_SHEAR = 4;
 ...
 */
/*private*/ /*static*/ /*final*/ int AffineTransform::HI_SHIFT = 3;
/*private*/ /*static*/ /*final*/ int AffineTransform::HI_IDENTITY = AffineTransform::APPLY_IDENTITY << AffineTransform::HI_SHIFT;
/*private*/ /*static*/ /*final*/ int AffineTransform::HI_TRANSLATE = AffineTransform::APPLY_TRANSLATE << AffineTransform::HI_SHIFT;
/*private*/ /*static*/ /*final*/ int AffineTransform::HI_SCALE = AffineTransform::APPLY_SCALE << AffineTransform::HI_SHIFT;
/*private*/ /*static*/ /*final*/ int AffineTransform::HI_SHEAR = AffineTransform::APPLY_SHEAR << AffineTransform::HI_SHIFT;



/*private*/ AffineTransform::AffineTransform(double m00, double m10,
                        double m01, double m11,
                        double m02, double m12,
                        int state) {
 log = new Logger("AffineTransform");
    this->m00 = m00;
    this->m10 = m10;
    this->m01 = m01;
    this->m11 = m11;
 ...
 * @since 1.2
 */
/*public*/ AffineTransform::AffineTransform(const AffineTransform& Tx) {
 log = new Logger("AffineTransform");
    this->m00 = Tx.m00;
    this->m10 = Tx.m10;
    this->m01 = Tx.m01;
...
/*public*/ AffineTransform::AffineTransform(float m00, float m10,
                       float m01, float m11,
                       float m02, float m12) {
 log = new Logger("AffineTransform");
    this->m00 = m00;
 ...
 * @since 1.2
 */
/*public*/ AffineTransform(QVector<float>* flatmatrix) {
    m00 = flatmatrix[0];
    m10 = flatmatrix[1];
    m01 = flatmatrix[2];
    m11 = flatmatrix[3];
 ...
 * @since 1.2
 */
/*public*/ AffineTransform(QVector<double>* flatmatrix) {
    m00 = flatmatrix[0];
    m10 = flatmatrix[1];
    m01 = flatmatrix[2];
    m11 = flatmatrix[3];
 ...
 */
/*private*/ void AffineTransform::stateError() {
    log->error("missing case in transform state switch");
}
#if 0
/**
 ...
 * @since 1.2
 */
/*public*/ void getMatrix(QVector<double>* flatmatrix) {
    flatmatrix[0] = m00;
    flatmatrix[1] = m10;
    flatmatrix[2] = m01;
    flatmatrix[3] = m11;
...
/*public*/ void rotate(double theta) {
    double sin = qSin(theta);
    if (sin == 1.0) {
        rotate90();
    } else if (sin == -1.0) {
        rotate270();
    } else {
        double cos = qCos(theta);
        if (cos == -1.0) {
            rotate180();
        } else if (cos != 1.0) {
            double M0, M1;
...
/*public*/ void rotate(double vecx, double vecy) {
    if (vecy == 0.0) {
        ...
        double len = qSqrt(vecx * vecx + vecy * vecy);
        double sin = vecy / len;
        double cos = vecx / len;
        double M0, M1;
        M0 = m00;
 ...
 * @since 1.2
 */
/*public*/ void AffineTransform::setToTranslation(double tx, double ty) {
    m00 = 1.0;
    m10 = 0.0;
    m01 = 0.0;
    m11 = 1.0;
 ...
 * @since 1.2
 */
/*public*/ void AffineTransform::setToRotation(double theta) {
    double sin = qSin(theta);
    double cos;
    if (sin == 1.0 || sin == -1.0) {
        cos = 0.0;
 ...
 * @since 1.2
 */
/*public*/ void AffineTransform::setToRotation(double theta, double anchorx, double anchory) {
    setToRotation(theta);
    double sin = m10;
 ...
 * @since 1.6
 */
/*public*/ void AffineTransform::setToRotation(double vecx, double vecy) {
    double sin, cos;
    if (vecy == 0) {
        sin = 0.0;
        if (vecx < 0.0) {
 ...
 * @since 1.2
 */
/*public*/ AffineTransform* AffineTransform::createInverse()
...
//        /* NOTREACHED */
//        return null;
    if(state == (APPLY_SHEAR | APPLY_SCALE | APPLY_TRANSLATE))
    {
        det = m00 * m11 - m01 * m10;
        if (qAbs(det) <= DBL_MIN) {
            log->error("Determinant is "+
                                                      QString::number(det));
        }
    ...
    if(state == (APPLY_SHEAR | APPLY_SCALE))
    {
        det = m00 * m11 - m01 * m10;
        if (qAbs(det) <= DBL_MIN) {
            log->error("Determinant is "+
    ...
    if(state == (APPLY_SHEAR | APPLY_TRANSLATE))
    {
        if (m01 == 0.0 || m10 == 0.0) {
            log->error("Determinant is 0");
        }
    ...
    if(state == (APPLY_SCALE | APPLY_TRANSLATE))
    {
        if (m00 == 0.0 || m11 == 0.0) {
            log->error("Determinant is 0");
        }
 ...
 * @since 1.2
 */
/*public*/ void AffineTransform::transform(QVector<float>* srcPts, int srcOff,
...
//        return;
    if(state == (APPLY_SHEAR | APPLY_SCALE | APPLY_TRANSLATE))
    {
        ...
        M10 = m10; M11 = m11; M12 = m12;
        while (--numPts >= 0) {
            double x = srcPts->at(srcOff++);
            double y = srcPts->at(srcOff++);
            dstPts->replace(dstOff++, (float) (M00 * x + M01 * y + M02));
            dstPts->replace(dstOff++, (float) (M10 * x + M11 * y + M12));
        }
        return;
    }
    else if(state == (APPLY_SHEAR | APPLY_SCALE))
    {
        M00 = m00; M01 = m01;
        M10 = m10; M11 = m11;
        while (--numPts >= 0) {
            double x = srcPts->at(srcOff++);
            double y = srcPts->at(srcOff++);
            dstPts->replace(dstOff++, (float) (M00 * x + M01 * y));
            dstPts->replace(dstOff++, (float) (M10 * x + M11 * y));
        }
        return;
    }
     else if(state == (APPLY_SHEAR | APPLY_TRANSLATE))
    {
        M01 = m01; M02 = m02;
        M10 = m10; M12 = m12;
        while (--numPts >= 0) {
            double x = srcPts->at(srcOff++);
            dstPts->replace(dstOff++, (float) (M01 * srcPts->at(srcOff++) + M02));
            dstPts->replace(dstOff++, (float) (M10 * x + M12));
        }
        return;
    }
     else if(state == (APPLY_SHEAR))
    {
        M01 = m01; M10 = m10;
        while (--numPts >= 0) {
            double x = srcPts->at(srcOff++);
            dstPts->replace(dstOff++, (float) (M01 * srcPts->at(srcOff++)));
            dstPts->replace(dstOff++, (float) (M10 * x));
        }
        return;
    }
     else if(state == (APPLY_SCALE | APPLY_TRANSLATE))
    {
        M00 = m00; M02 = m02;
        M11 = m11; M12 = m12;
        while (--numPts >= 0) {
            dstPts->replace(dstOff++, (float) (M00 * srcPts->at(srcOff++) + M02));
            dstPts->replace(dstOff++, (float) (M11 * srcPts->at(srcOff++) + M12));
        }
        return;
    }
     else if(state == (APPLY_SCALE))
    {
        M00 = m00; M11 = m11;
        while (--numPts >= 0) {
            dstPts->replace(dstOff++, (float) (M00 * srcPts->at(srcOff++)));
            dstPts->replace(dstOff++, (float) (M11 * srcPts->at(srcOff++)));
        }
        return;
    }
     else if(state == (APPLY_TRANSLATE))
    {
        M02 = m02; M12 = m12;
        while (--numPts >= 0) {
            dstPts->replace(dstOff++, (float) (srcPts->at(srcOff++) + M02));
            dstPts->replace(dstOff++, (float) (srcPts->at(srcOff++) + M12));
        }
        return;
    }
     else if(state == (APPLY_IDENTITY))
    {
...
void AffineTransform::arraycopy(QVector<float>* srcPts, int srcOff, QVector<float>* dstPts, int dstOff, int numPts)
{
 for(int i = 0; i < numPts; i++)
 {
  dstPts->replace(i + dstOff, srcPts->at(i+srcOff));
 }
}

void AffineTransform::arraycopy(QVector<double>* srcPts, int srcOff, QVector<double>* dstPts, int dstOff, int numPts)
{
 for(int i = 0; i < numPts; i++)
 {
  dstPts->replace(i + dstOff, srcPts->at(i+srcOff));
 ...
 * @since 1.2
 */
/*public*/ void AffineTransform::transform(QVector<double>* srcPts, int srcOff,
...
//        return;
     if(state == (APPLY_SHEAR | APPLY_SCALE | APPLY_TRANSLATE))
     {
        ...
        while (--numPts >= 0) {
            double x = srcPts->at(srcOff++);
            double y = srcPts->at(srcOff++);
            dstPts->replace(dstOff++,  M00 * x + M01 * y + M02);
            dstPts->replace(dstOff++,  M10 * x + M11 * y + M12);
        }
        return;
     }
     else if(state == (APPLY_SHEAR | APPLY_SCALE))
     {
        ...
        while (--numPts >= 0) {
            double x = srcPts->at(srcOff++);
            double y = srcPts->at(srcOff++);
            dstPts->replace(dstOff++,  M00 * x + M01 * y);
            dstPts->replace(dstOff++,  M10 * x + M11 * y);
        }
        return;
     }
     else if(state == (APPLY_SHEAR | APPLY_TRANSLATE))
     {
        ...
        while (--numPts >= 0) {
            double x = srcPts->at(srcOff++);
            dstPts->replace(dstOff++,  M01 * srcPts->at(srcOff++) + M02);
            dstPts->replace(dstOff++,  M10 * x + M12);
        }
        return;
     }
     else if(state == (APPLY_SHEAR))
     {
        ...
        while (--numPts >= 0) {
            double x = srcPts->at(srcOff++);
            dstPts->replace(dstOff++,  M01 * srcPts->at(srcOff++));
            dstPts->replace(dstOff++,  M10 * x);
        }
        return;
     }
     else if(state == (APPLY_SCALE | APPLY_TRANSLATE))
     {
        ...
        M11 = m11; M12 = m12;
        while (--numPts >= 0) {
            dstPts->replace(dstOff++,  M00 * srcPts->at(srcOff++) + M02);
            dstPts->replace(dstOff++,  M11 * srcPts->at(srcOff++) + M12);
        }
        return;
     }
     else if(state == (APPLY_SCALE))
     {
        M00 = m00; M11 = m11;
        while (--numPts >= 0) {
            dstPts->replace(dstOff++,  M00 * srcPts->at(srcOff++));
            dstPts->replace(dstOff++,  M11 * srcPts->at(srcOff++));
        }
        return;
     }
     else if(state == (APPLY_TRANSLATE))
     {
        M02 = m02; M12 = m12;
        while (--numPts >= 0) {
            dstPts->replace(dstOff++,  srcPts->at(srcOff++) + M02);
            dstPts->replace(dstOff++,  srcPts->at(srcOff++) + M12);
        }
        return;
     }
     else if(state == (APPLY_IDENTITY))
...
//        return;
    ...
    {
        while (--numPts >= 0) {
            dstPts->replace(dstOff++,  srcPts->at(srcOff++));
            dstPts->replace(dstOff++,  srcPts->at(srcOff++));
        }
        return;
    }
...
/*public*/ void transform(QVector<double>* srcPts, int srcOff,
    ...
    case (APPLY_SHEAR | APPLY_TRANSLATE):
        ...
        while (--numPts >= 0) {
            double x = srcPts[srcOff++];
            dstPts->replace(dstOff++,  (float) (M01 * srcPts[srcOff++] + M02);
            dstPts->replace(dstOff++,  (float) (M10 * x + M12);
        }
        return;
    case (APPLY_SHEAR):
        ...
        while (--numPts >= 0) {
            double x = srcPts[srcOff++];
            dstPts->replace(dstOff++,  (float) (M01 * srcPts[srcOff++]);
            dstPts->replace(dstOff++,  (float) (M10 * x);
        }
        return;
    case (APPLY_SCALE | APPLY_TRANSLATE):
        ...
        M11 = m11; M12 = m12;
        while (--numPts >= 0) {
            dstPts->replace(dstOff++,  (float) (M00 * srcPts[srcOff++] + M02);
            dstPts->replace(dstOff++,  (float) (M11 * srcPts[srcOff++] + M12);
        }
        return;
    case (APPLY_SCALE):
        M00 = m00; M11 = m11;
        while (--numPts >= 0) {
            dstPts->replace(dstOff++,  (float) (M00 * srcPts[srcOff++]);
            dstPts->replace(dstOff++,  (float) (M11 * srcPts[srcOff++]);
        }
        return;
    case (APPLY_TRANSLATE):
        M02 = m02; M12 = m12;
        while (--numPts >= 0) {
            dstPts->replace(dstOff++,  (float) (srcPts[srcOff++] + M02);
            dstPts->replace(dstOff++,  (float) (srcPts[srcOff++] + M12);
        }
        return;
    case (APPLY_IDENTITY):
        while (--numPts >= 0) {
            dstPts->replace(dstOff++,  (float) (srcPts[srcOff++]);
            dstPts->replace(dstOff++,  (float) (srcPts[srcOff++]);
        }
        return;
    }
 ...
 * @since 1.2
 */
/*public*/ void inverseTransform(QVector<double>* srcPts, int srcOff,
                             QVector<double>* dstPts, int dstOff,
                             int numPts)
    throws NoninvertibleTransformException
{
    ...
    case (APPLY_SHEAR | APPLY_SCALE | APPLY_TRANSLATE):
        ...
        while (--numPts >= 0) {
            ...
            dstPts->replace(dstOff++,  (x * M11 - y * M01) / det;
            dstPts->replace(dstOff++,  (y * M00 - x * M10) / det;
        }
        return;
    case (APPLY_SHEAR | APPLY_SCALE):
        M00 = m00; M01 = m01;
    ...
    case (APPLY_SHEAR | APPLY_TRANSLATE):
        ...
        while (--numPts >= 0) {
            double x = srcPts[srcOff++] - M02;
            dstPts->replace(dstOff++,  (srcPts[srcOff++] - M12) / M10;
            dstPts->replace(dstOff++,  x / M01;
        }
        return;
    case (APPLY_SHEAR):
        M01 = m01; M10 = m10;
        ...
        while (--numPts >= 0) {
            double x = srcPts[srcOff++];
            dstPts->replace(dstOff++,  srcPts[srcOff++] / M10;
            dstPts->replace(dstOff++,  x / M01;
        }
        return;
    case (APPLY_SCALE | APPLY_TRANSLATE):
        ...
        while (--numPts >= 0) {
            dstPts->replace(dstOff++,  (srcPts[srcOff++] - M02) / M00;
            dstPts->replace(dstOff++,  (srcPts[srcOff++] - M12) / M11;
        }
        return;
    case (APPLY_SCALE):
        M00 = m00; M11 = m11;
        ...
        while (--numPts >= 0) {
            dstPts->replace(dstOff++,  srcPts[srcOff++] / M00;
            dstPts->replace(dstOff++,  srcPts[srcOff++] / M11;
        }
        return;
    case (APPLY_TRANSLATE):
        M02 = m02; M12 = m12;
        while (--numPts >= 0) {
            dstPts->replace(dstOff++,  srcPts[srcOff++] - M02;
            dstPts->replace(dstOff++,  srcPts[srcOff++] - M12;
        }
        return;
    case (APPLY_IDENTITY):
        if (srcPts != dstPts || srcOff != dstOff) {
 ...
 * @since 1.2
 */
/*public*/ void deltaTransform(QVector<double>* srcPts, int srcOff,
                           QVector<double>* dstPts, int dstOff,
                           int numPts) {
    ...
    case (APPLY_SHEAR | APPLY_SCALE):
        ...
        while (--numPts >= 0) {
            double x = srcPts[srcOff++];
            double y = srcPts[srcOff++];
            dstPts->replace(dstOff++,  x * M00 + y * M01;
            dstPts->replace(dstOff++,  x * M10 + y * M11;
        }
        return;
    case (APPLY_SHEAR | APPLY_TRANSLATE):
    case (APPLY_SHEAR):
        ...
        while (--numPts >= 0) {
            double x = srcPts[srcOff++];
            dstPts->replace(dstOff++,  srcPts[srcOff++] * M01;
            dstPts->replace(dstOff++,  x * M10;
        }
        return;
    case (APPLY_SCALE | APPLY_TRANSLATE):
    case (APPLY_SCALE):
...
// Note that qSin(Math.PI) has an error of about 10^-16
