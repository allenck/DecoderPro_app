 ...
 * @since 1.2
 */
/*public*/ GeneralPath::GeneralPath() : Float(Path2D::WIND_NON_ZERO, Path2D::INIT_SIZE){
 ...
 * @since 1.2
 */
/*public*/ GeneralPath::GeneralPath(int rule) : Float(rule, Path2D::INIT_SIZE)
{
 ...
 * @since 1.2
 */
/*public*/ GeneralPath::GeneralPath(int rule, int initialCapacity) : Float(rule, initialCapacity)
{
 ...
 * @since 1.2
 */
/*public*/ GeneralPath::GeneralPath(JShape* s) : Float(s, NULL)
{
    //super(s, null);
}

GeneralPath::GeneralPath(int windingRule,
