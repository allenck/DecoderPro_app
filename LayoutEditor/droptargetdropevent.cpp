...
//DropTargetDropEvent::DropTargetDropEvent(QObject *parent) :
//    DropTargetEvent(parent)
//{
//}
/**
...
/*static*/ /*final*/ /*private*/ QPoint  DropTargetDropEvent::zero     = QPoint(0,0);
...
/*public*/ DropTargetDropEvent::DropTargetDropEvent(DropTargetContext* dtc, QPoint cursorLocn, int dropAction, int srcActions, bool isLocal, QObject */*parent*/)  : DropTargetEvent(dtc)
{
 //super(dtc);
    isLocalTx = isLocal;

    if (cursorLocn.isNull()) throw new NullPointerException("cursorLocn");
...
/*public*/ QPoint DropTargetDropEvent::getLocation() {
    return location;
}
...
/*public*/ QVector<DataFlavor*>* DropTargetDropEvent::getCurrentDataFlavors() {
...
/*public*/ QList<DataFlavor*> DropTargetDropEvent::getCurrentDataFlavorsAsList() {
...
/*public*/ bool DropTargetDropEvent::isDataFlavorSupported(DataFlavor* df) {
 ...
 */
/*public*/ int DropTargetDropEvent::getSourceActions() { return actions; }
 ...
 */
/*public*/ int DropTargetDropEvent::getDropAction() { return dropAction; }
...
/*public*/ Transferable* DropTargetDropEvent::getTransferable()
{
 DropTargetContext* context = getDropTargetContext();
...
/*public*/ void DropTargetDropEvent::acceptDrop(int dropAction) {
...
/*public*/ void DropTargetDropEvent::rejectDrop() {
...
/*public*/ void DropTargetDropEvent::dropComplete(bool success) {
...
/*public*/ bool DropTargetDropEvent::isLocalTransfer() {
    return isLocalTx;
}

/*public*/ void DropTargetDropEvent::setDropEvent(QDropEvent *de)
{
 this->de = de;
}
