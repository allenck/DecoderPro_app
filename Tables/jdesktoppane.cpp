...
//JDesktopPane::JDesktopPane(QWidget *parent) :
 ...
 * @see #readObject
 */
/*private*/ /*static*/ /*final*/ QString JDesktopPane::uiClassID = "DesktopPaneUI";
...
/**
  ...
  * @see #setDragMode
  */
/*public*/ /*static*/ /*final*/ int JDesktopPane::LIVE_DRAG_MODE = 0;
...
/**
  ...
  * @see #setDragMode
  */
/*public*/ /*static*/ /*final*/ int JDesktopPane::OUTLINE_DRAG_MODE = 1;


/**
 * Creates a new <code>JDesktopPane</code>.
 */
/*public*/ JDesktopPane::JDesktopPane(QWidget *parent) :
QStackedWidget(parent)
{
selectedFrame = NULL;
dragModeSet = false;
