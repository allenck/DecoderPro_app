...
//JInternalFrame::JInternalFrame(QWidget *parent) :
//  QWidget(parent)
//{
//}
/**
 ...
 * @see #readObject
 */
/*private*/ /*static*/ /*final*/ QString JInternalFrame::uiClassID = "InternalFrameUI";
...
/** Bound property name. */
/*public*/ /*final*/ /*static*/ QString JInternalFrame::CONTENT_PANE_PROPERTY = "contentPane";
/** Bound property name. */
/*public*/ /*final*/ /*static*/ QString JInternalFrame::MENU_BAR_PROPERTY = "JMenuBar";
/** Bound property name. */
/*public*/ /*final*/ /*static*/ QString JInternalFrame::TITLE_PROPERTY = "title";
/** Bound property name. */
/*public*/ /*final*/ /*static*/ QString JInternalFrame::LAYERED_PANE_PROPERTY = "layeredPane";
/** Bound property name. */
/*public*/ /*final*/ /*static*/ QString JInternalFrame::ROOT_PANE_PROPERTY = "rootPane";
/** Bound property name. */
/*public*/ /*final*/ /*static*/ QString JInternalFrame::GLASS_PANE_PROPERTY = "glassPane";
/** Bound property name. */
/*public*/ /*final*/ /*static*/ QString JInternalFrame::FRAME_ICON_PROPERTY = "frameIcon";

/**
 * Constrained property name indicated that this frame has
 * selected status.
 */
/*public*/ /*final*/ /*static*/ QString JInternalFrame::IS_SELECTED_PROPERTY = "selected";
/** Constrained property name indicating that the internal frame is closed. */
/*public*/ /*final*/ /*static*/ QString JInternalFrame::IS_CLOSED_PROPERTY = "closed";
/** Constrained property name indicating that the internal frame is maximized. */
/*public*/ /*final*/ /*static*/ QString JInternalFrame::IS_MAXIMUM_PROPERTY = "maximum";
/** Constrained property name indicating that the internal frame is iconified. */
/*public*/ /*final*/ /*static*/ QString JInternalFrame::IS_ICON_PROPERTY = "icon";

/*private*/ /*static*/ /*final*/ QString  JInternalFrame::PROPERTY_CHANGE_LISTENER_KEY =
    QString("InternalFramePropertyChangeListener");

/*private*/ /*static*/ void JInternalFrame::addPropertyChangeListenerIfNecessary()
{
#if 0
...
/*private*/ /*static*/ void JInternalFrame::updateLastFocusOwner(QWidget* component)
{
 if (component != NULL)
 {
  QWidget* parent = component;
#if 0
 ...
 */
/*public*/ JInternalFrame::JInternalFrame(QWidget *parent) :
  QMdiSubWindow(parent)
{
 common("", false, false, false, false,parent);
 normalBounds = QRect();
}
 ...
 */
/*public*/ JInternalFrame::JInternalFrame(QString title, QWidget *parent) :
  QMdiSubWindow(parent)
{
    common(title, false, false, false, false, parent);
}
 ...
 */
/*public*/ JInternalFrame::JInternalFrame(QString title, bool resizable, QWidget* parent) :
  QMdiSubWindow(parent) {
    common(title, resizable, false, false, false, parent);
}
 ...
 */
/*public*/ JInternalFrame::JInternalFrame(QString title, bool resizable, bool closable, QWidget*parent) :
  QMdiSubWindow(parent) {
    common(title, resizable, closable, false, false, parent);
}
 ...
 */
/*public*/ JInternalFrame::JInternalFrame(QString title, bool resizable, bool closable,
                      bool maximizable, QWidget*parent):
  QMdiSubWindow(parent)
{
    common(title, resizable, closable, maximizable, false, parent);
}
 ...
 */
/*public*/ JInternalFrame::JInternalFrame(QString title, bool resizable, bool closable, bool maximizable, bool iconifiable, QWidget *parent) :
  QMdiSubWindow(parent)
{
 common(title, resizable, closable, maximizable, iconifiable,parent);
}

void JInternalFrame::common(QString title, bool resizable, bool closable, bool maximizable, bool iconifiable, QWidget* parent)
{
 normalBounds = QRect();
 ...
 listenerList = QList<EventListener*>();
...
//    addPropertyChangeListenerIfNecessary();
 connect(this, SIGNAL(windowStateChanged(Qt::WindowStates,Qt::WindowStates)), this, SLOT(on_windowStateChanged(Qt::WindowStates,Qt::WindowStates)));
}
 ...
 */
/*public*/ void JInternalFrame::updateUI() {
#if 0
 ...
 */
/*public*/ QWidget* JInternalFrame::getContentPane() {
 ...
 */
/*public*/ void JInternalFrame::setContentPane(QWidget* c)
{
// QWidget* oldValue = getContentPane();
 QWidget* oldValue = widget();
// getRootPane()->setContentPane(c);
 setWidget(c);
 firePropertyChange(CONTENT_PANE_PROPERTY, VPtr<QWidget>::asQVariant(oldValue), VPtr<QWidget>::asQVariant(c));
}
#if 0
/**
 ...
 */
/*public*/ JRootPane* JInternalFrame::getRootPane() {
    return rootPane;
}
...
//     try {
//         setRootPaneCheckingEnabled(false);
  thisLayout->addWidget(rootPane, /*BorderLayout.CENTER*/0, Qt::AlignCenter);
//     }
//     finally {
//         setRootPaneCheckingEnabled(checkingEnabled);
//     }
 ...
 * some user action.
 * @param b a bool value, where <code>true</code> means this internal frame can be closed
 * @beaninfo
 *     preferred: true
 *           bound: true
 ...
 */
/*public*/ void setClosed(bool b) throws PropertyVetoException {
    if (isClosed == b) {
        return;
    }
 ...
 * user action.
 *
 * @param b  a bool, where <code>true</code> means this internal frame can be resized
 * @beaninfo
 *     preferred: true
 *           bound: true
 ...
 *
 * @param b  a bool, where <code>true</code> means this internal frame can be iconified
 * @beaninfo
 *     preferred: true
           bound: true
 ...
 */
/*public*/ bool JInternalFrame::isIcon() {
    return _isIcon;
}
 ...
 *
 * @param b a bool, where <code>true</code> means to iconify this internal frame and
 ...
 */
/*public*/ void JInternalFrame::setIcon(bool b) /*throws PropertyVetoException*/ {
 if(isMinimized() != _isIcon)
  _isIcon = isMinimized();
 if (_isIcon == b) {
      return;
  }
 ...
 /* If an internal frame is being iconified before it has a
    ...
    this frame yet */
 firePropertyChange("ancestor", QVariant(), VPtr<QObject>::asQVariant(parent()));

 bool oldValue = _isIcon;// ? Boolean.TRUE : Boolean.FALSE;
 bool newValue = b;// ? Boolean.TRUE : Boolean.FALSE;
 ...
 */
/*public*/ bool JInternalFrame::isMaximum()
{
 if(_isMaximum != isMaximized())
  _isMaximum = isMaximized();
    return _isMaximum;
}
 ...
 * actual size.
 *
 * @param b  a bool, where <code>true</code> maximizes this internal frame and <code>false</code>
 *           restores it
 * @exception PropertyVetoException when the attempt to set the
 *            property is vetoed by the <code>JInternalFrame</code>
 * @beaninfo
 ...
 */
/*public*/ void JInternalFrame::setMaximum(bool b) /*throws PropertyVetoException*/
{
 if(_isMaximum != isMaximized())
  _isMaximum = isMaximized();
  ...
  bool oldValue = _isMaximum;// ? Boolean.TRUE : Boolean.FALSE;
  bool newValue = b;// ? Boolean.TRUE : Boolean.FALSE;
 ...
 * @see #setTitle
 */
/*public*/ QString JInternalFrame::getTitle() {
    return title;
}
 ...
 */
/*public*/ void JInternalFrame::setTitle(QString title) {
 ...
 * is fired.
 *
 * @param selected  a bool, where <code>true</code> means this internal frame
 ...
 *                  the active frame.
 */
/*public*/ void JInternalFrame::setSelected(bool selected) /*throws PropertyVetoException*/ {
...
//        return;
//    }
    if(_isSelected == selected || selected && isShaded())
     return;

    bool oldValue = _isSelected;// ? Boolean.TRUE : Boolean.FALSE;
    bool newValue = selected;// ? Boolean.TRUE : Boolean.FALSE;
...
//    }
    ...
    /*static*/(IS_SELECTED_PROPERTY, oldValue, newValue);
    if (_isSelected)
 ...
 * @see #setSelected
 */
/*public*/ bool JInternalFrame::isSelected() {
    return _isSelected;
}
#if 0
/**
...
/**
  ...
  */
/*public*/ void JInternalFrame::moveToFront()
{
#if 0 // TODO:
    if (isIcon()) {
...
/**
  ...
  * parent is a <code>JLayeredPane</code>.
  */
/*public*/ void JInternalFrame::moveToBack()
{
#if 0
    if (isIcon()) {
        if (getDesktopIcon().getParent() instanceof JLayeredPane) {
 ...
 * @since 1.3
 */
/*public*/ void JInternalFrame::restoreSubcomponentFocus()
{
#if 0
    if (isIcon()) {
 ...
 */
/*public*/ void JInternalFrame::addInternalFrameListener(InternalFrameListener* l) {  // remind: sync ??
 listenerList.append(/*"InternalFrameListener",*/(EventListener*) l);
  // remind: needed?
 ...
 * @param l the internal frame listener
 */
/*public*/ void JInternalFrame::removeInternalFrameListener(InternalFrameListener* l) {  // remind: sync??
 listenerList.removeOne(/*"InternalFrameListener",*/ (EventListener*)l);
}
#if 0
/**
 ...
 */
/*protected*/ void JInternalFrame::fireInternalFrameEvent(int id)
{
  //Object[] listeners = listenerList.getListenerList();
 QList<EventListener*> listeners = listenerList;
 ...
 * @see javax.swing.event.InternalFrameEvent#INTERNAL_FRAME_CLOSING
 */
/*public*/ void JInternalFrame::doDefaultCloseAction()
{
 fireInternalFrameEvent(InternalFrameEvent::INTERNAL_FRAME_CLOSING);
...
//          try {
//            fireVetoableChange(IS_CLOSED_PROPERTY, false,
//                            true);
         _isClosed = true;
         setVisible(false);
         firePropertyChange(IS_CLOSED_PROPERTY, false,
                            true);
         dispose();
//          } catch (PropertyVetoException pve) {}
       break;
 ...
 */
/*public*/ void JInternalFrame::setDefaultCloseOperation(int operation) {
...
* @see #setDefaultCloseOperation
*/
/*public*/ int JInternalFrame::getDefaultCloseOperation() {
 ...
 */
/*public*/ void JInternalFrame::pack()
{
 if(isMinimized() != _isIcon)
  _isIcon = isMinimized();
 ...
 * @see #setClosed
 */
/*public*/ void JInternalFrame::dispose() {
    if (isVisible()) {
        setVisible(false);
    }
    if (isSelected()) {
 ...
 * @see       #moveToFront
 */
/*public*/ void JInternalFrame::toFront() {
    moveToFront();
}
 ...
 * @see       #moveToBack
 */
/*public*/ void JInternalFrame::toBack() {
    moveToBack();
}
#if 0
/**
 ...
 * @since 1.4
 */
/*public*/ /*final*/ void setFocusCycleRoot(bool focusCycleRoot) {
}
 ...
 * @since 1.4
 */
/*public*/ /*final*/ bool isFocusCycleRoot() {
    return true;
}
...
/*protected*/ class AccessibleJInternalFrame extends AccessibleJComponent
     ...
     */
    /*public*/ bool setCurrentAccessibleValue(Number n) {
        // TIGER - 4422535
        if (n == NULL) {
            return false;
        }
...
//}
#endif
 void JInternalFrame::firePropertyChange(QString property, QVariant oldv, QVariant newv)
{
 emit propertyChange(new PropertyChangeEvent((QObject*)this, property, oldv, newv));
}

 void JInternalFrame::setLocation(int x, int y) { move(QPoint(x,y));}
 ...
 * @since JDK1.1
 */
/*public*/ QString JInternalFrame::getName()
 {
 ...
 * @since JDK1.1
 */
/*public*/ void JInternalFrame::setName(QString name) {
    QString oldName;
    /*synchronized(getObjectLock())*/ {
        oldName = this->name;
        this->name = name;
 ...
 /*private*/ void JInternalFrame::closeEvent(QCloseEvent *closeEvent)
 {
...
/*private*/ void JInternalFrame::on_windowStateChanged(Qt::WindowStates, Qt::WindowStates newState)
{
  switch(newState)
  {
