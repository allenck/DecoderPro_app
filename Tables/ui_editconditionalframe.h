...
public:
    ...
    void setupUi(QWidget *editConditionalFrame)
    {
        if (editConditionalFrame->objectName().isEmpty())
            editConditionalFrame->setObjectName(QLatin1String("editConditionalFrame"));
        ...
        panel1->setObjectName(QLatin1String("panel1"));
        verticalLayout1 = new QVBoxLayout(panel1);
        verticalLayout1->setObjectName(QLatin1String("verticalLayout1"));
        p1HBoxLayout1 = new QHBoxLayout();
        p1HBoxLayout1->setObjectName(QLatin1String("p1HBoxLayout1"));
        ...
        p1HBoxLayout2->setObjectName(QLatin1String("p1HBoxLayout2"));
        ...
        conditionalUserName->setObjectName(QLatin1String("conditionalUserName"));
        ...
        logicPanel->setObjectName(QLatin1String("logicPanel"));
        ...
        widget_3->setObjectName(QLatin1String("widget_3"));
        ...
        actionPanel->setObjectName(QLatin1String("actionPanel"));
        verticalLayout_7 = new QVBoxLayout(actionPanel);
        verticalLayout_7->setObjectName(QLatin1String("verticalLayout_7"));
        ...
        tableView_2->setObjectName(QLatin1String("tableView_2"));
        ...
        widget_4->setObjectName(QLatin1String("widget_4"));
    ...
    {
        editConditionalFrame->setWindowTitle(QApplication::translate("editConditionalFrame", "Form", nullptr));
        label->setText(QApplication::translate("editConditionalFrame", "Conditional System Name ", nullptr));
        label_2->setText(QApplication::translate("editConditionalFrame", "IX:AUTO:0001C3", nullptr));
        label_3->setText(QApplication::translate("editConditionalFrame", "Conditional User Name", nullptr));
...
#endif // QT_NO_TOOLTIP
        logicPanel->setTitle(QApplication::translate("editConditionalFrame", "Logical Expression", nullptr));
        label_4->setText(QApplication::translate("editConditionalFrame", "Antecedent Variables (the 'if' part)", nullptr));
        pushButton->setText(QApplication::translate("editConditionalFrame", "Add State Variable", nullptr));
        pushButton_2->setText(QApplication::translate("editConditionalFrame", "Check State Variables", nullptr));
        label_5->setText(QApplication::translate("editConditionalFrame", "Logic Operator", nullptr));
        comboBox->setItemText(0, QApplication::translate("editConditionalFrame", "AND", nullptr));
        comboBox->setItemText(1, QApplication::translate("editConditionalFrame", "OR", nullptr));
        comboBox->setItemText(2, QApplication::translate("editConditionalFrame", "Mixed", nullptr));

        actionPanel->setTitle(QApplication::translate("editConditionalFrame", "Actions", nullptr));
        label_6->setText(QApplication::translate("editConditionalFrame", "Consequent Actions (the 'then' part)", nullptr));
        pushButton_3->setText(QApplication::translate("editConditionalFrame", "Add Action", nullptr));
        pushButton_4->setText(QApplication::translate("editConditionalFrame", "Reorder", nullptr));
        pushButton_5->setText(QApplication::translate("editConditionalFrame", "Update Conditional", nullptr));
        pushButton_6->setText(QApplication::translate("editConditionalFrame", "Cancel", nullptr));
        pushButton_7->setText(QApplication::translate("editConditionalFrame", "Delete Conditional", nullptr));
    } // retranslateUi
