...
///*public*/ class RouteExportToLogix {
    ...
    RouteExportToLogix::RouteExportToLogix(QString systemName, QObject* parent) : QObject(parent)
    {
...
//                InstanceManager.getDefault(ConditionalManager.class));
     ...
     this->routeManager = (RouteManager*)InstanceManager::getDefault("RouteManager");
     this->logixManager = (LogixManager*)InstanceManager::getDefault("LogixManager");
     this->conditionalManager = (ConditionalManager*)InstanceManager::getDefault("ConditionalManager");
     common();
    }

    RouteExportToLogix::RouteExportToLogix(QString systemName, RouteManager* routeManager,LogixManager* logixManager,ConditionalManager* conditionalManager, QObject* parent) : QObject(parent){
        this->systemName = systemName;
    ...
    void RouteExportToLogix::common()
    {
        QString logixPrefix = logixManager->getSystemNamePrefix();
        logixSysName = logixPrefix + ":RTX:";
        conditionalSysPrefix = logixSysName + "C";
    }

    /*public*/ void RouteExportToLogix::_export() {
#if 0
    ...
    /*private*/ bool removeConditionals(String cSystemName, Logix logix) {
     ...
     */
    /*private*/ int makeSensorConditional(Sensor selectedSensor, int sensorMode, int numConds, bool onChange, ArrayList<ConditionalAction> actionList, ArrayList<ConditionalVariable> vetoList, Logix logix, String prefix, String uName) {
     ...
     * @throws IllegalArgumentException if "user input no good"
     */
    /*private*/ int makeTurnoutConditional(Turnout turnout, int state, int numConds, bool onChange, ArrayList<ConditionalAction> actionList,
    ...
    /*private*/ ConditionalVariable makeCtrlTurnoutVar(Turnout turnout, int mode, bool makeVeto, bool onChange) {
    ...
    /*private*/ ConditionalVariable makeCtrlSensorVar(Sensor selectedSensor, int mode, bool makeVeto, bool onChange) {
...
#endif
    /*private*/ /*static*/ /*final*/ Logger* RouteExportToLogix::log = LoggerFactory::getLogger("RouteExportToLogix");
