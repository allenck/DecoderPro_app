...
///*public*/ class OBlockTablePanel extends JPanel {
    ...
    /*public*/ OBlockTablePanel::OBlockTablePanel(OBlockTableModel* oblocks,
        ...
        oblockTable->setDefaultEditor("JButton", new ButtonEditor(new JButton()));
        ...
        oblockTable->getColumnModel()->getColumn(OBlockTableModel::UNITSCOL)->setCellEditor(
                new ToggleButtonEditor(new JToggleButton(), tr("cm"), tr("in")));
        ...
        oblockTable->getColumnModel()->getColumn(OBlockTableModel::REPORT_CURRENTCOL)->setCellEditor(
                new ToggleButtonEditor(new JToggleButton(), tr("Current"), tr("Last")));
        ...
        oblockTable->getColumnModel()->getColumn(OBlockTableModel::PERMISSIONCOL)->setCellEditor(
                new ToggleButtonEditor(new JToggleButton(), tr("Permissive"), tr("Absolute")));
...
//        oblockTable->setPreferredScrollableViewportSize(QSize(550, 300)); // a wide table
        ...
        // style table
        portalTable->setDefaultEditor("JButton", new ButtonEditor(new JButton()));
...
//        portalDataScroll = new JScrollPane(portalTable);
        ...
        // style table
        signalTable->setDefaultEditor("JButton", new ButtonEditor(new JButton()));
...
//        blockportalDataScroll = new JScrollPane(blockportalTable);
        ...
        this->setLayout(thisLayout = new BorderLayout());

        // install the four items in GUI as tabs
        oblockTabs = new JTabbedPane();
        oblockTabs->addTab(tr("BeanNameOBlocks"), /*oblockDataScroll*/oblockTable);
        oblockTabs->addTab(tr("BeanNamePortals"), /*portalDataScroll*/portalTable);
        ...
        thisLayout-> addWidget(oblockTabs, BorderLayout::Center);
        ...
        thisLayout-> addWidget(bottomBox, BorderLayout::South);
...
#if 1
    /*public*/ QAction* OBlockTablePanel::getPrintItem() { // copied from AudioTablePanel
...
//        Objects.requireNonNull(name, "the table name must be nonnull");
    ...
    /*public*/ void OBlockTablePanel::configureWarrantTable(JTable* table) {
        ...
        table->setDefaultEditor("JToggleButton", new ToggleButtonEditor(new JToggleButton(), tr("cm"), tr("in")));
        table->setDefaultRenderer("JRadioButton", new ToggleButtonRenderer(tr("Current"), tr("Last"))); // overrides
        table->setDefaultEditor("JRadioButton", new ToggleButtonEditor(new JToggleButton(), tr("Current"), tr("Last")));
        table->setDefaultRenderer("JCheckBox", new ToggleButtonRenderer(tr("Permissive"), tr("Absolute")));
        table->setDefaultEditor("JCheckBox", new ToggleButtonEditor(new JToggleButton(), tr("Permissive"), tr("Absolute")));
#if 0
