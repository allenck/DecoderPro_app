...
//    private VetoableChangeListenerMap map = new VetoableChangeListenerMap();
   ...
   /**
     ...
     */
    /*public*/ void JVetoableChangeSupport::addVetoableChangeListener(VetoableChangeListener* listener) {
        if (listener == nullptr) {
            return;
        }
...
//        connect(this, SIGNAL(vetoablePropertyChange(PropertyChangeEvent*)), listener, SLOT(vetoableChange(PropertyChangeEvent*)));
     ...
     */
    /*public*/ void JVetoableChangeSupport::removeVetoableChangeListener(VetoableChangeListener* listener) {
        if (listener == nullptr) {
            return;
        }
...
//        disconnect(this, SIGNAL(vetoablePropertyChange(PropertyChangeEvent*)), listener, SLOT(vetoableChange(PropertyChangeEvent*)));
     ...
     * @since 1.4
     */
    /*public*/ QVector<VetoableChangeListener*> JVetoableChangeSupport::getVetoableChangeListeners(){
     ...
     * @param listener  The VetoableChangeListener to be added
     */
    /*public*/ void JVetoableChangeSupport::addVetoableChangeListener(QString propertyName, VetoableChangeListener* listener) \
    {
     ...
     * @param listener  The VetoableChangeListener to be removed
     */
    /*public*/ void JVetoableChangeSupport::removeVetoableChangeListener(
     ...
     * @since 1.4
     */
    /*public*/ QVector<VetoableChangeListener*> JVetoableChangeSupport::getVetoableChangeListeners(QString propertyName) {
#if 1
 ...
 return QVector<VetoableChangeListener*>();
     ...
     */
    /*public*/ void JVetoableChangeSupport::fireVetoableChange(QString propertyName, QVariant oldValue, QVariant newValue)
     ...
     * @throws PropertyVetoException if one of listeners vetoes the property update
     */
    /*public*/ void JVetoableChangeSupport::fireVetoableChange(QString propertyName, int oldValue, int newValue)
            /*throws PropertyVetoException */{
     ...
     * @throws PropertyVetoException if one of listeners vetoes the property update
     */
    /*public*/ void JVetoableChangeSupport::fireVetoableChange(QString propertyName, bool oldValue, bool newValue)
            /*throws PropertyVetoException */{
        if (oldValue != newValue) {
            fireVetoableChange(propertyName, (oldValue), (newValue));
        }
     ...
     * @throws PropertyVetoException if one of listeners vetoes the property update
     */
    /*public*/ void JVetoableChangeSupport::fireVetoableChange(PropertyChangeEvent* event)
            /*throws PropertyVetoException */{
     ...
     */
    /*public*/ bool JVetoableChangeSupport::hasListeners(QString propertyName) {
