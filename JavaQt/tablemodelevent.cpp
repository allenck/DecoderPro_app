 ...
 * @see TableModel
 */
///*public*/class TableModelEvent : public EventObject
//{
/** Identifies the addition of new rows or columns. */
/*public*/ /*static*/ /*final*/ int TableModelEvent::INSERT =  1;
/** Identifies a change to existing data. */
/*public*/ /*static*/ /*final*/ int TableModelEvent::UPDATE =  0;
/** Identifies the removal of rows or columns. */
/*public*/ /*static*/ /*final*/ int TableModelEvent::DELETE = -1;

/** Identifies the header row. */
/*public*/ /*static*/ /*final*/ int TableModelEvent::HEADER_ROW = -1;

/** Specifies all columns in a row or rows. */
/*public*/ /*static*/ /*final*/ int TableModelEvent::ALL_COLUMNS = -1;
...
//
     ...
     *  have not changed.
     */
    /*public*/TableModelEvent::TableModelEvent(TableModel* source) : EventObject(source){

        // Use Integer.MAX_VALUE instead of getRowCount() in case rows were deleted.
        common(source, 0, /*Integer.MAX_VALUE*/INT_MAX, ALL_COLUMNS, UPDATE);
    }
     ...
     */
    /*public*/ TableModelEvent::TableModelEvent(TableModel* source, int row) : EventObject(source)
{
     ...
     */
    /*public*/ TableModelEvent::TableModelEvent(TableModel* source, int firstRow, int lastRow) : EventObject(source) {
     ...
     */
    /*public*/ TableModelEvent::TableModelEvent(TableModel* source, int firstRow, int lastRow, int column) : EventObject(source){
     ...
     */
    /*public*/ TableModelEvent::TableModelEvent(TableModel* source, int firstRow, int lastRow, int column, int type) : EventObject(source)
{
        //super(source);
        common(source, firstRow, lastRow, column, type);
}
/*private*/  void TableModelEvent::common(TableModel* source, int firstRow, int lastRow, int column, int type)
{
...
//
   ...
   /** Returns the first row that changed.  HEADER_ROW means the meta data,
     ...
     */
    /*public*/int TableModelEvent::getFirstRow() { return firstRow; }

    /** Returns the last row that changed. */
    /*public*/int TableModelEvent::getLastRow() { return lastRow; }
     ...
     *  rows changed.
     */
    /*public*/int TableModelEvent::getColumn() { return column; }

    /**
     *  Returns the type of event - one of: INSERT, UPDATE and DELETE.
     */
    /*public*/int TableModelEvent::getType() { return type; }
//}
