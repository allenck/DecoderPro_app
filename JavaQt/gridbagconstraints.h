#ifndef GRIDBAGCONSTRAINTS_H
#define GRIDBAGCONSTRAINTS_H
#include <QObject>
#include "insets.h"
#include "javaqt_global.h"

class JAVAQTSHARED_EXPORT GridBagConstraints //: public QObject
{
 //Q_OBJECT
public:
    GridBagConstraints(/*QObject* parent = 0*/);
    /**
    ...
    static const long _RELATIVE = -1;

    /**
     * Specifies that this component is the
     * last component in its column or row.
     */
    /*public*/ static /*final*/ const int REMAINDER = 0;

    /**
     * Do not resize the component.
     */
    /*public*/ static /*final*/ const int NONE = 0;

    /**
     * Resize the component both horizontally and vertically.
     */
    /*public*/ static /*final*/ const int BOTH = 1;

    /**
     * Resize the component horizontally but not vertically.
     */
    /*public*/ static /*final*/ const int HORIZONTAL = 2;

    /**
     * Resize the component vertically but not horizontally.
     */
    /*public*/ static /*final*/ const int VERTICAL = 3;

    /**
     * Put the component in the center of its display area.
     */
    /*public*/ static /*final*/ const int CENTER = 10;

    /**
     * Put the component at the top of its display area,
     * centered horizontally.
     */
    /*public*/ static /*final*/ const int NORTH = 11;

    /**
     * Put the component at the top-right corner of its display area.
     */
    /*public*/ static /*final*/ const int NORTHEAST = 12;

    /**
     * Put the component on the right side of its display area,
     * centered vertically.
     */
    /*public*/ static /*final*/ const int EAST = 13;

    /**
     * Put the component at the bottom-right corner of its display area.
     */
    /*public*/ static /*final*/ const int SOUTHEAST = 14;

    /**
     * Put the component at the bottom of its display area, centered
     * horizontally.
     */
    /*public*/ static /*final*/ const int SOUTH = 15;

    /**
     * Put the component at the bottom-left corner of its display area.
     */
    /*public*/ static /*final*/ const int SOUTHWEST = 16;

    /**
     * Put the component on the left side of its display area,
     * centered vertically.
     */
    /*public*/ static /*final*/ const int WEST = 17;

    /**
     * Put the component at the top-left corner of its display area.
     */
    /*public*/ static /*final*/ const int NORTHWEST = 18;
     ...
     * orientations.
     */
    /*public*/ static /*final*/ const int PAGE_START = 19;
     ...
     * orientations.
     */
    /*public*/ static /*final*/ const int PAGE_END = 20;
     ...
     * orientations.
     */
    /*public*/ static /*final*/ const int LINE_START = 21;
     ...
     * orientations.
     */
    /*public*/ static /*final*/ const int LINE_END = 22;
     ...
     * orientations.
     */
    /*public*/ static /*final*/ const int FIRST_LINE_START = 23;
     ...
     * orientations.
     */
    /*public*/ static /*final*/ const int FIRST_LINE_END = 24;
     ...
     * orientations.
     */
    /*public*/ static /*final*/ const int LAST_LINE_START = 25;
     ...
     * orientations.
     */
    /*public*/ static /*final*/ const int LAST_LINE_END = 26;
     ...
     * @since 1.6
     */
    /*public*/ static /*final*/ const int BASELINE = 0x100;
     ...
     * @since 1.6
     */
    /*public*/ static /*final*/ const int BASELINE_LEADING = 0x200;
     ...
     * @since 1.6
     */
    /*public*/ static /*final*/ const int BASELINE_TRAILING = 0x300;
     ...
     * @since 1.6
     */
    /*public*/ static /*final*/ const int ABOVE_BASELINE = 0x400;
     ...
     * @since 1.6
     */
    /*public*/ static /*final*/ const int ABOVE_BASELINE_LEADING = 0x500;
     ...
     * @since 1.6
     */
    /*public*/ static /*final*/ const int ABOVE_BASELINE_TRAILING = 0x600;
     ...
     * @since 1.6
     */
    /*public*/ static /*final*/ const int BELOW_BASELINE = 0x700;
     ...
     * @since 1.6
     */
    /*public*/ static /*final*/ const int BELOW_BASELINE_LEADING = 0x800;
     ...
     * @since 1.6
     */
    /*public*/ static /*final*/ const int BELOW_BASELINE_TRAILING = 0x900;
...
private:
    ...
    */
   /*private*/ static /*final*/ const long serialVersionUID = -1000070633030801713L;

};

#endif // GRIDBAGCONSTRAINTS_H
