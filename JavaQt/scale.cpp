...
// /*public*/ class Scale extends ConstrainedBean {
    ...
    /*public*/ Scale::Scale(QObject *parent) : ConstrainedBean(parent)
    {
        //super();
    }

    /*public*/ Scale::Scale(/*@Nonnull*/ QString name, double ratio, QString userName,QObject *parent) : ConstrainedBean(parent) {
        //super();
        _name = name;
        _userName = (userName.isNull()) ? name : userName;
        _ratio = ratio;
        _factor = 1.0 / _ratio;
    }


    /*public*/ QString Scale::getScaleName() {
        return _name;
    }

    /*public*/ QString Scale::getUserName() {
        return _userName;
    }

    /*public*/ double Scale::getScaleRatio() {
        return _ratio;
    }

    /*public*/ double Scale::getScaleFactor() {
        return _factor;
    }
 ...
 // TODO:       jmri.configurexml.ScaleConfigXML.doStore();
    ...
    //@Override
    /*public*/ QString Scale::toString() {
        return QString("%1 (%2.1f)").arg(getUserName()).arg(getScaleRatio());
    }

    /*private*/ /*final*/ /*static*/ Logger* Scale::log = LoggerFactory::getLogger("Scale");
