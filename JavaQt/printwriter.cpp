...
PrintWriter::PrintWriter(QTextStream* out, bool autoFlush)
{
 trouble = false;
 ...
 */
/*public*/ PrintWriter::PrintWriter(QTextStream* out) {
    //(out, false);
 this->out = (Writer*)out;
 ...
 * @see java.io.OutputStreamWriter#OutputStreamWriter(java.io.OutputStream)
 */
/*public*/ PrintWriter::PrintWriter(QDataStream* out, bool autoFlush) {
...
/*private*/ void PrintWriter::ensureOpen() //throws IOException
{
//    if (out == NULL)
 ...
 * character (<code>'\n'</code>).
 */
/*public*/ void PrintWriter::println() {
    newLine();
}
#if 0
/**
 ...
 */
/*public*/ void PrintWriter::println(const QString x)
{
//    synchronized (lock)
 {
  print(x);
