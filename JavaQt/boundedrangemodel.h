...
/*public*/ class JAVAQTSHARED_EXPORT BoundedRangeModel
{
 public:
     ...
     */
    virtual void setMinimum(int newMinimum) = 0;
     ...
     * @see #addChangeListener
     */
    virtual void setMaximum(int newMaximum) = 0;
     ...
     */
    virtual bool getValueIsAdjusting() = 0;
     ...
     * @see #setValue
     */
    virtual void setExtent(int newExtent) = 0;
     ...
     * @param adjusting a bool, true if a series of changes are in
     *                    progress
     *
     * @see #setValue
     * @see #setExtent
     ...
     * @see #setValueIsAdjusting
     */
    virtual  void setRangeProperties(int value, int extent, int min, int max, bool adjusting) = 0;
     ...
     */
    virtual void addChangeListener(ChangeListener* x) = 0;
     ...
     * @see #addChangeListener
     */
    virtual void removeChangeListener(ChangeListener* x) = 0;

};
#endif // BOUNDEDRANGEMODEL_H
