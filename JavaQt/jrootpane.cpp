...
//JRootPane::JRootPane(QWidget *parent) :
//  QMainWindow(parent)
//{
//}
#if 0
 ...
 */
/*public*/ JRootPane::JRootPane(QWidget *parent) :
  QMainWindow(parent) {
 ...
 */
/*protected*/ QWidget* JRootPane::createContentPane()
{
    QWidget* c = new QWidget();
    c->setObjectName(this->objectName()+".contentPane");
 ...
 */
/*public*/ void JRootPane::setContentPane(QWidget* content)
{
 if(content == NULL)
     Logger::error("contentPane cannot be set to NULL.");
 ...
 */
/*public*/ QWidget* JRootPane::getContentPane() { return contentPane; }
#if 0
