...
template <class E>
/*static*/ QStringList Manager_t<E>::legacyPrefixes = QStringList() << "DX" << "DCCPP" << "DP" << "MR" << "MC" << "PI" << "TM";

template <class E>
/*public*/ /*static*/ bool Manager_t<E>::isLegacySystemPrefix(/*@Nonnull*/ QString prefix) {
    return legacyPrefixes.contains(prefix);
}

template <class E>
/*public*/ /*static*/ int Manager_t<E>::startsWithLegacySystemPrefix(/*@Nonnull*/ QString prefix) {
...
//@Nonnull
template <class E>
/*public*/ QString Manager_t<E>::getBeanTypeHandled(bool /*plural*/) const { return "??";}

template <class E>
/*static*/ /*public*/ int Manager_t<E>::getSystemPrefixLength(/*@Nonnull*/ QString inputName) throw (NamedBean::BadSystemNameException)
{
...
//@Nonnull
template <class E>
/*public*/ /*static*/ QString Manager_t<E>::getSystemPrefix(/*@Nonnull*/ QString inputName) {
    return inputName.mid(0, getSystemPrefixLength(inputName));
}

template <class E>
/*public*/ /*default*/ QString Manager_t<E>::makeSystemName(/*@Nonnull*/ QString name) const {
...
//@Nonnull
template <class E>
/*public*/ /*default*/ QString Manager_t<E>::makeSystemName(/*@Nonnull*/ QString name, bool logErrors) const {
...
//@Nonnull
template <class E>
/*public*/ /*default*/ QString Manager_t<E>::makeSystemName(/*@Nonnull*/ QString name, bool /*logErrors*/, QLocale locale) const {
...
//@Nonnull
template <class E>
/*public*/ /*default*/ QString Manager_t<E>::validateSystemNameFormat(/*@Nonnull*/ QString name) const throw (NamedBean::BadSystemNameException)
{
...
//@Nonnull
template <class E>
/*public*/ /*default*/ QString Manager_t<E>::validateSystemNameFormat(/*@Nonnull*/ QString name, /*@Nonnull*/ QLocale locale) const throw (NamedBean::BadSystemNameException)
{
...
//@Nonnull
template <class E>
/*public*/ /*default*/ QString Manager_t<E>::validateSystemNamePrefix(/*@Nonnull*/ QString name, /*@Nonnull*/ QLocale locale) const throw (NamedBean::BadSystemNameException) {
    QString prefix = getSystemNamePrefix();
    if (name == (prefix)) {
...
//@Nonnull
template <class E>
/*public*/ /*default*/ QString Manager_t<E>::validateTrimmedSystemNameFormat(/*@Nonnull*/ QString name, /*@Nonnull*/ QLocale locale) {
...
//@Nonnull
template <class E>
/*public*/ /*default*/ QString Manager_t<E>::validateUppercaseTrimmedSystemNameFormat(/*@Nonnull*/ QString name, /*@Nonnull*/ QLocale locale) {
...
//@Nonnull
template <class E>
/*public*/ /*default*/ QString Manager_t<E>::validateIntegerSystemNameFormat(/*@Nonnull*/ QString name, int min, int max, /*@Nonnull*/ QLocale locale) {
    name = validateTrimmedSystemNameFormat(name, locale);
    QString prefix = getSystemNamePrefix();
    QString suffix = name.mid(prefix.length());
    try {
...
//@Nonnull
template <class E>
/*public*/ /*default*/ QString Manager_t<E>::validateNmraAccessorySystemNameFormat(/*@Nonnull*/ QString name, /*@Nonnull*/ QLocale locale) {
 ...
 */
template <class E>
/*public*/ /*default*/ bool Manager_t<E>::isValidSystemNameFormat(/*@Nonnull*/ QString systemName) {
...
template <class E>
/*static*/ /*final*/ Logger* Manager_t<E>::deprecatedManagerLogger = LoggerFactory::getLogger("Manager");
...
//@CheckReturnValue
//@CheckForNull
// /*public*/ NamedBean* Manager_t<E>::getBySystemName(/*@Nonnull*/ QString systemName)  {return nullptr;}
...
//@CheckReturnValue
//@CheckForNull
// /*public*/ NamedBean* Manager_t<E>::getByUserName(/*@Nonnull*/ QString userName {return nullptr;}
...
//@Nonnull
template <class E>
/*default*/ /*public*/ QList<NamedBeanPropertyDescriptor*> Manager_t<E>::getKnownBeanProperties() {
...
//  public:
  ...
  */
 /*final*/ /*static*/ /*public*/ int Manager_t<E>::ManagerDataEvent::CONTENTS_CHANGED = 0;
 /**
  * Equal to {@link javax.swing.event.ListDataEvent#INTERVAL_ADDED}
  */
 /*final*/ /*static*/ /*public*/ int Manager_t<E>::ManagerDataEvent::INTERVAL_ADDED = 1;
 /**
  * Equal to {@link javax.swing.event.ListDataEvent#INTERVAL_REMOVED}
  */
 /*final*/ /*static*/ /*public*/ int Manager_t<E>::ManagerDataEvent::INTERVAL_REMOVED = 2;
//   private:
...
//        public:
  ...
  */
template <class E>
 /*public*/ Manager_t<E>::ManagerDataEvent::ManagerDataEvent(/*@Nonnull*/ Manager/*<E>*/* source, int type, int index0, int index1, /*E*/NamedBean* changedBean)
 : EventObject(source)
 {
     //super(source);
     this->source = source;
 ...
 //@Override
template <class E>
 /*public*/ Manager/*<E>*/* Manager_t<E>::ManagerDataEvent::getSource() {
     return source;
 }
  ...
  */
template <class E>
 /*public*/ int Manager_t<E>::ManagerDataEvent::getIndex0() {
     return index0;
 }
  ...
  */
template <class E>
 /*public*/ int Manager_t<E>::ManagerDataEvent::getIndex1() {
     return index1;
 }
  ...
  */
template <class E>
 /*public*/ E Manager_t<E>::ManagerDataEvent::getChangedBean() {
     return changedBean;
 }
  ...
  */
template <class E>
 /*public*/ int Manager_t<E>::ManagerDataEvent::getType() {
     return type;
 }
 ...
 //@Override
template <class E>
/*public*/ QString Manager_t<E>::ManagerDataEvent::toString() {
 ...
 */
template <class E>
/*public*/ void Manager_t<E>::addDataListener(ManagerDataListener<E> * /*e*/) {}
 ...
 */
template <class E>
/*public*/ void Manager_t<E>::removeDataListener(/*ManagerDataListener<E>*/QObject* /*e*/) {}
 ...
 */
template <class E>
/*public*/ /*default*/ void Manager_t<E>::setDataListenerMute(bool /*muted*/) {
}
