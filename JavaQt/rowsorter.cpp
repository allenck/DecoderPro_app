...
//RowSorter::RowSorter(QObject *parent) : QObject(parent)
//{
 ...
 */
/*public*/ RowSorter::RowSorter(QObject *parent) : QSortFilterProxyModel(parent) {
}
 ...
 */
//template<class M>
/*public*/ /*abstract*/ QAbstractItemModel* RowSorter::getModel() {return sourceModel();}
 ...
 */
/*public*/ /*abstract*/ void RowSorter::toggleSortOrder(int /*column*/) {}
 ...
 *         range of the view
 */
/*public*/ /*abstract*/ int RowSorter::convertRowIndexToModel(int /*index*/) {return 0;}
 ...
 */
/*public*/ /*abstract*/ int RowSorter::convertRowIndexToView(int /*index*/) {return 0;}
 ...
 */
/*public*/ /*abstract*/ void RowSorter::setSortKeys(QList</*? extends*/ SortKey*>* /*keys*/) {}
 ...
 */
/*public*/ /*abstract*/ QList</*? extends*/ SortKey*>* RowSorter::getSortKeys() {return NULL;}
 ...
 */
/*public*/ /*abstract*/ int RowSorter::getViewRowCount() {return 0;}
 ...
 * @see #getViewRowCount
 */
/*public*/ /*abstract*/ int RowSorter::getModelRowCount() {return 0;}
 ...
 */
/*public*/ /*abstract*/ void RowSorter::modelStructureChanged() {}
 ...
 * to allow view classes to call it.
 */
/*public*/ /*abstract*/ void RowSorter::allRowsChanged() {}
 ...
 */
/*public*/ /*abstract*/ void RowSorter::rowsInserted(int /*firstRow*/, int /*endRow*/) {}
 ...
 *         <code>firstRow</code> &gt; <code>endRow</code>
 */
/*public*/ /*abstract*/ void RowSorter::rowsDeleted(int /*firstRow*/, int /*endRow*/) {}
 ...
 *         <code>firstRow</code> &gt; <code>endRow</code>
 */
/*public*/ /*abstract*/ void RowSorter::rowsUpdated(int /*firstRow*/, int /*endRow*/) {}
 ...
 *          model
 */
/*public*/ /*abstract*/ void RowSorter::rowsUpdated(int /*firstRow*/, int /*endRow*/, int /*column*/) {}
 ...
 */
/*public*/ void RowSorter::addRowSorterListener(RowSorterListener* /*l*/) {
 ...
 * @param l the <code>RowSorterListener</code>
 */
/*public*/ void RowSorter::removeRowSorterListener(RowSorterListener* /*l*/) {
...
//    /*private*/ SortOrder sortOrder;
     ...
     */
    /*public*/ /*final*/ int SortKey::getColumn() {
        return column;
    }
     ...
     */
    /*public*/ /*final*/ SortOrder SortKey::getSortOrder() {
        return sortOrder;
    }
#if 0
    /**
     ...
     */
    /*public*/ bool SortKey::equals(QObject* o) {
        if ((SortKey*)o == this) {
            return true;
        }
        //if (o instanceof SortKey)
        if(qobject_cast<SortKey*>(o) != NULL)
    {
