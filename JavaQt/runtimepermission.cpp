...
/*public*/ RuntimePermission::RuntimePermission(QString name) : BasicPermission(name)
{
    //super(name);
}
...
/*public*/ RuntimePermission::RuntimePermission(QString name, QString actions) : BasicPermission(name, actions)
{
    //super(name, actions);
}
