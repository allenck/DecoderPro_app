...
/*public*/ void DefaultMutableTreeNode::insert(MutableTreeNode* newChild, int childIndex)
{
 ...
 if (oldParent != NULL)
 {
  ((DefaultMutableTreeNode*)oldParent)->remove(newChild);
 }
...
/*public*/ void DefaultMutableTreeNode::remove(int childIndex)
{
 ...
 ((DefaultMutableTreeNode*) child)->setParent(NULL);
}
...
/*public*/ void DefaultMutableTreeNode::removeFromParent()
{
    ...
    if (parent != NULL) {
        ((DefaultMutableTreeNode*)parent)->remove(this);
    }
}
...
/*public*/ bool DefaultMutableTreeNode::isNodeAncestor(TreeNode* anotherNode)
{
 ...
 } while((ancestor = ((DefaultMutableTreeNode*)ancestor)->getParent()) != NULL);
