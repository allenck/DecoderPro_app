...
//{
    ...
    ///*public*/ abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
         ...
         */
        /*public*/ /*final*/ /*static*/ int Calendar::AM = 0;

        /**
         * Value of the {@link #AM_PM} field indicating the
         * period of the day from noon to just before midnight.
         */
        /*public*/ /*final*/ /*static*/ int Calendar::PM = 1;
#if 0
        /**
        ...
        /*public*/ static class Builder {
            ...
            /*private*/ void internalSet(int field, int value) {
                ...
                fields.replace(NFIELDS + field, value);
         ...
         * @see     TimeZone#getDefault
         */
        /*protected*/ Calendar::Calendar(QObject* parent) : QObject(parent)
        {
         fields = QVector<int>(FIELD_COUNT);
         ...
         */
        /*protected*/ Calendar::Calendar(QTimeZone zone, QLocale aLocale)
        {
            fields = QVector<int>(FIELD_COUNT);
            isSet = QVector<bool>(FIELD_COUNT);
            stamp = QVector<int>(FIELD_COUNT);
         ...
         * @return a Calendar.
         */
        /*public*/ /*static*/ Calendar* Calendar::getInstance()
        {
         //return createCalendar(QTimeZone.getDefault(), Locale.getDefault(Locale.Category.FORMAT));
         QByteArray ianald = QTimeZone::systemTimeZoneId();
         return createCalendar(QTimeZone(ianald), QLocale::system());
        }
         ...
         * @return a Calendar.
         */
        /*public*/ /*static*/ Calendar* Calendar::getInstance(QTimeZone zone)
        {
         return createCalendar(zone, QLocale::system());
        }
         ...
         * @return a Calendar.
         */
        /*public*/ /*static*/ Calendar* Calendar::getInstance(QLocale aLocale)
        {
            QByteArray ianald = QTimeZone::systemTimeZoneId();
            return createCalendar(QTimeZone(ianald), aLocale);
        }
        ...
        /*private*/ /*static*/ Calendar* Calendar::createCalendar(QTimeZone zone,
                                               QLocale aLocale)
        {
#if 0
         ...
         * @see #computeFields()
         */
        /*protected*/ /*abstract*/ void Calendar::computeTime() {}
         ...
         * @see #get(int)
         */
        /*protected*/ /*final*/ int Calendar::internalGet(int field)
        {
            return fields[field];
        }
         ...
         * @see #set(int,int)
         */
        /*final*/ void Calendar::internalSet(int field, int value)
        {
         ...
         * @see #set(int,int,int,int,int,int)
         */
        /*public*/ /*final*/ void Calendar::set(int year, int month, int date)
        {
            set(YEAR, year);
            set(MONTH, month);
            set(DATE, date);
         ...
         */
        /*protected*/ void Calendar::complete()
        {
            if (!isTimeSet) {
                updateTime();
            }
         ...
         */
        /*private*/ void Calendar::setWeekCountData(QLocale desiredLocale)
        {
#if 0 // TODO:
         ...
         */
        /*private*/ void Calendar::updateTime() {
            computeTime();
         ...
         */
        /*private*/ void Calendar::adjustStamp() {
