...
template<class E>
class ManagerT : public QObject
{
 //Q_OBJECT
public:
    explicit ManagerT(QObject *parent = 0) : QObject(parent) {}
    ManagerT(SystemConnectionMemo* /*memo*/, QObject *parent = 0) : QObject(parent) {}
    virtual ~ManagerT() {}
#if 0
    /**
...
//     @Nonnull
  ...
  //@CheckReturnValue
  //@Nonnull
  /*public*/ /*SortedSet<E>*/virtual QSet<E> getNamedBeanSet() {return QSet<T>();}
      ...
      * @return requested NamedBean object or null if none exists
      */
     virtual  E getNamedBean(QString /*name*/) {return NULL;}
      ...
      /*public*/ /*final*/ class ManagerDataEvent  /*<E extends NamedBean>*/: public EventObject
      {
       public:
        ...
        private:
          ...
          /*final*/ /*private*/ ManagerT<E>* source;
             public:
          /**
           ...
           *                    otherwise null
           */
          /*public*/ ManagerDataEvent(/*@Nonnull*/ ManagerT<E>* source, int type, int index0, int index1, /*E*/NamedBean* changedBean);
