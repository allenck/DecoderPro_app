...
/*public*/ /*interface*/class JAVAQTSHARED_EXPORT ListSelectionModel : public QObject
{
 ...
 public:
     ...
     */
    virtual void setSelectionInterval(int index0, int index1) = 0;
     ...
     */
    virtual void addSelectionInterval(int index0, int index1) = 0;
     ...
     */
    virtual int getMinSelectionIndex() {return 0;}


    /**
     * Returns the last selected index or -1 if the selection is empty.
     */
    virtual int getMaxSelectionIndex() {return 0;}


    /**
     * Returns true if the specified index is selected.
     */
    virtual bool isSelectedIndex(int index) = 0;
     ...
     */
    virtual int getAnchorSelectionIndex() {return 0;}
     ...
     */
    virtual void setAnchorSelectionIndex(int /*index*/) {}
     ...
     * @see #addSelectionInterval
     */
    virtual int getLeadSelectionIndex() {return 0;}
     ...
     * @see #getLeadSelectionIndex
     */
    virtual void setLeadSelectionIndex(int /*index*/) {}
     ...
     * in the data model.
     */
    virtual void insertIndexInterval(int /*index*/, int /*length*/, bool /*before*/) {}
     ...
     */
    virtual void removeIndexInterval(int /*index0*/, int /*index1*/) {}
   ...
   virtual  bool getValueIsAdjusting() {return false;}
     ...
     * @see #setSelectionMode
     */
    virtual int getSelectionMode() {return 0;}
