...
/** Convenience object defining the Default layer. Equivalent to new Integer(0).*/
 /*public*/ /*final*/ /*static Integer*/ int JLayeredPane::DEFAULT_LAYER =(0);
/** Convenience object defining the Palette layer. Equivalent to new Integer(100).*/
 /*public*/ /*final*/ /*static Integer*/ int JLayeredPane::PALETTE_LAYER = (100);
/** Convenience object defining the Modal layer. Equivalent to new Integer(200).*/
 /*public*/ /*final*/ /*static Integer*/ int JLayeredPane::MODAL_LAYER = (200);
/** Convenience object defining the Popup layer. Equivalent to new Integer(300).*/
 /*public*/ /*final*/ /*static Integer*/ int JLayeredPane::POPUP_LAYER = (300);
/** Convenience object defining the Drag layer. Equivalent to new Integer(400).*/
 /*public*/ /*final*/ /*static Integer*/ int JLayeredPane::DRAG_LAYER = (400);
/** Convenience object defining the Frame Content layer.
  ...
  * @see JFrame
  */
 /*public*/ /*final*/ /*static Integer*/ int JLayeredPane::FRAME_CONTENT_LAYER = (-30000);

/** Bound property */
 /*public*/ /*final*/ /*static*/ QString JLayeredPane::LAYER_PROPERTY = "layeredContainerLayer";
...
//////////////////////////////////////////////////////////////////////////////
 ...
 /*public*/ JLayeredPane::JLayeredPane(QWidget *parent) : QFrame(parent)
{
 componentToLayer = QHash<QWidget*,int>();
 components = QList<QWidget*>();
    setLayout(nullptr);
}
#if 0
 ...
 * @see #getIndexOf
 */
 /*public*/ void JLayeredPane::remove(int index) {
    QWidget* c = getComponent(index);
    //super.remove(index);
    this->layout()->removeWidget(c);
    c->deleteLater();
//    if (c != nullptr/* && !(c instanceof JComponent)*/) {
// TODO:        getComponentToLayer().remove(c);
//    }
// TODO:    validateOptimizedDrawing();
}
 ...
 */
/*public*/ QWidget* JLayeredPane::getComponent(int n) {
    ...
    QObjectList _children = children();
    components.clear();
    foreach(QObject* obj, _children)
    {
...
/*public*/ QList<QWidget*> JLayeredPane::getComponents()
{
...
/*private*/ int JLayeredPane::getComponentCount()
{
 ...
 * @since 1.5
 */
 /*public*/ void JLayeredPane::removeAll() {
    QList<QWidget*> children = getComponents();
    QHash<QWidget*, int> cToL = getComponentToLayer();
    for (int counter = children.length() - 1; counter >= 0; counter--) {
        QWidget* c = children.at(counter);
        if (c != nullptr /*&& !(c instanceof JComponent)*/) {
            cToL.remove(c);
        }
    }
...
/** Gets the layer property for a JComponent, it
  ...
  */
 /*public*/ /*static*/ int JLayeredPane::s_getLayer(QWidget* c) {
    QVariant i;
    //if((i = c->getClientProperty(LAYER_PROPERTY)) != null)
    if((i=c->property(LAYER_PROPERTY.toLocal8Bit())) != QVariant())
        return i.toInt();
...
/** Sets the layer attribute on the specified component,
  ...
  */
 /*public*/ void JLayeredPane::setLayer(QWidget* c, int layer)  {
    setLayer(c, layer, -1);
}
...
/** Sets the layer attribute for the specified component and
  ...
  */
 /*public*/ void JLayeredPane::setLayer(QWidget* c, int layer, int position)  {
    int layerObj;
...
//    else
        getComponentToLayer().insert(c, layerObj);

    if(c->parent() == nullptr || c->parent() != this) {
        repaint(/*c->getBounds()*/);
        return;
    }
...
// TODO:    setComponentZOrder(c, index);
    repaint(/*c.getBounds()*/);
}
 ...
 */
 /*public*/ int JLayeredPane::getLayer(QWidget* c) {
    int i;
//    if(c instanceof JComponent)
//        i = (Integer)((JComponent)c).getClientProperty(LAYER_PROPERTY);
//    else
        i = getComponentToLayer().value(c);
 ...
 */
 /*public*/ int JLayeredPane::getIndexOf(QWidget* c) {
    int i, count;
 ...
 */
 /*public*/ void JLayeredPane::moveToFront(QWidget* c) {
    setPosition(c, 0);
}
 ...
 * @see #setPosition(Component, int)
 */
 /*public*/ void JLayeredPane::moveToBack(QWidget* c) {
    setPosition(c, -1);
}
 ...
 */
 /*public*/ void JLayeredPane::setPosition(QWidget* c, int position) {
 ...
 */
 /*public*/ int JLayeredPane::getPosition(QWidget* c) {
 ...
 */
/*protected*/ QHash<QWidget*,int> JLayeredPane::getComponentToLayer() {
//    if(componentToLayer == nullptr)
//        componentToLayer = new QHash<QWidget*,int>(/*4*/);
 ...
 */
/*protected*/ int JLayeredPane::getObjectForLayer(int layer) {
    int layerObj;
    switch(layer) {
    case 0:
 ...
 * @see #getIndexOf
 */
/*protected*/ int JLayeredPane::insertIndexForLayer(int layer, int position) {
 ...
 * @see #getIndexOf
 */
/*private*/ int JLayeredPane::insertIndexForLayer(QWidget* comp, int layer, int position) {
    int i, count, curLayer;
    int layerStart = -1;
    int layerEnd = -1;
    ...
    QList<QWidget*> compList =
        QList<QWidget*>(/*componentCount*/);

    for (int index = 0; index < componentCount; index++) {
        if (getComponent(index) != comp) {
            compList.append(getComponent(index));
        }
    }

    count = compList.size();
    for (i = 0; i < count; i++) {
        curLayer = getLayer(compList.value(i));
