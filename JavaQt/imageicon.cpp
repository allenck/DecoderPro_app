 ...
 */
/*public*/ ImageIcon::ImageIcon(QString filename, QString description, QObject* parent) : QObject(parent)
{
 init();
 ...
 * Creates an ImageIcon from the specified file. The image will
 * be preloaded by using MediaTracker to monitor the loading state
 * of the image. The specified QString can be a file name or a
 ...
 *
 * @param filename a QString specifying a filename or path
 * @see #getDescription
 */
//@ConstructorProperties({"description"})
///*public*/ ImageIcon (QString filename) {
//    this(filename, filename);
//}
...
// * @see #getDescription
// */
///*public*/ ImageIcon (QUrl location) {
 ...
 */
/*public*/ ImageIcon::ImageIcon(QImage image, QObject *parent) : QObject(parent)
{
 init();
 this->image = image;
 height = image.height();
...
//    if (o instanceof QString) {
//        description = (QString) o;
//    }
 _description = image.text("comment");
//    loadImage(image);
}
#if 0
/**
 ...
 */
public ImageIcon (byte[] imageData, QString description) {
 ...
 */
//@Transient
/*public*/ QImage ImageIcon::getImage() {
    return image;
}
 ...
 * @param image the image
 */
/*public*/ void ImageIcon::setImage(QImage image) {
    this->image = image;
    height = image.height();
    width = image.width();
 ...
 */
/*public*/ QString ImageIcon::getDescription() {
    return _description;
}
 ...
 * @param description a brief textual description of the image
 */
/*public*/ void ImageIcon::setDescription(QString description) {
    this->_description = description;
}
#if 0
/**
 ...
 */
/*public*/ int ImageIcon::getIconWidth() {
    return width;
}
 ...
 */
/*public*/ int ImageIcon::getIconHeight() {
    return height;
}
#if 0
/**
 ...
 */
/*public*/ QString ImageIcon::toString() {
    if (_description != "") {
        return _description;
    }
...
protected class AccessibleImageIcon extends AccessibleContext
     ...
     */
    public QString getAccessibleIconDescription() {
     ...
     */
    public void setAccessibleIconDescription(QString description) {
