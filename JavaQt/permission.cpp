...
/*public*/ Permission::Permission(QString name) {
    this->name = name;
}
#if 0
/**
...
/*public*/ /*abstract*/ bool Permission::implies(Permission* permission) {return false;}
...
/*public*/ /*abstract*/ bool Permission::equals(QObject* obj) {return false;}
#if 0
/**
...
/*public*/ /*final*/ QString Permission::getName() {
    return name;
}
...
/*public*/ /*abstract*/ QString Permission::getActions() {return "";}
#if 0
/**
 ...
 */
/*public*/ QString Permission::toString() {
    QString actions = getActions();
    if ((actions == "") || (actions.length() == 0)) { // OPTIONAL
        return "(\"" + QString(metaObject()->className()) + "\" \"" + name + "\")";
    } else {
        return "(\"" + QString(metaObject()->className()) + "\" \"" + name +
             "\" \"" + actions + "\")";
    }
