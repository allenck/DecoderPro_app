...
CSVPrinter::CSVPrinter(QTextStream* appendable, CSVFormat* format, QObject *parent) : QObject(parent)
{
...
public final class CSVPrinter implements Flushable, Closeable {
...
#endif
    //@Override
    /*public*/ void CSVPrinter::close() /*throws IOException*/ {
        close(false);
    }
     ...
     * @since 1.6
     */
    /*public*/ void CSVPrinter::close(/*final*/ bool _flush) /*throws IOException*/ {
        if (_flush || format->getAutoFlush()) {
            flush();
        }
//        if (appendable instanceof Closeable) {
//            ((Closeable) appendable).close();
//        }
        appendable->device()->close();
        QString err = appendable->device()->errorString();
    }
     ...
     */
    //@Override
    /*public*/ void CSVPrinter::flush() /*throws IOException*/ {
...
//        }
     ...
     *             If an I/O error occurs
     */
    /*public*/ void CSVPrinter::print(/*final*/ QVariant value) /*throws IOException*/ {
     ...
     *             If an I/O error occurs
     */
    /*public*/ void CSVPrinter::println() /*throws IOException*/ {
     ...
     *             If an I/O error occurs
     */
    /*public*/ void CSVPrinter::printRecord(/*final*/ /*Iterable<?>*/QVariantList values) /*throws IOException*/ {
        for (/*final*/ QVariant value : values) {
            print(value);
        }
        println();
    }
