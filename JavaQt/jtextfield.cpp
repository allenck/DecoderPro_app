 ...
 */
/*public*/ JTextField::JTextField(QWidget *parent) : QLineEdit(parent)
{
 //this(NULL, NULL, 0);
    init();
}
 ...
 */
/*public*/ JTextField::JTextField(QString text, QWidget *parent) : QLineEdit(parent)
{
    //this(NULL, text, 0);
    init();
 setText(text);
 ...
 */
/*public*/ JTextField::JTextField(int columns, QWidget *parent) : QLineEdit(parent)
{
 ...
 setMaximumWidth((columns+1)*fm.width("M"));
}
 ...
 *   the component implementation
 */
/*public*/ JTextField::JTextField(QString text, int columns, QWidget *parent) : QLineEdit(parent)
{
 ...
 */
/*public*/ JTextField::JTextField(Document* doc, QString text, int columns, QWidget *parent) : QLineEdit(parent)
{
    init();
 if (columns < 0)
 {
 ...
 *       expert: true
 */
/*public*/ void JTextField::setDocument(Document* doc)
{
 if (doc != NULL)
 {
// TODO: doc.putProperty("filterNewlines", true);
 }
 this->doc = doc;
 //setDocument(doc);
}

/*public*/ void JTextField::setShare(JTextField* share)
{
 ...
 */
/*public*/ int JTextField::getColumns() {
    return columns;
}
 ...
 */
/*public*/ void JTextField::setColumns(int columns)
{
 ...
 */
/*protected*/ int JTextField::getColumnWidth()
{
 if (columnWidth == 0)
 {
  QFontMetrics metrics = QFontMetrics(font());
  columnWidth = metrics.charWidth("m", 0);
 }
 return columnWidth;
}
 ...
 */
/*public*/ QSize JTextField::getPreferredSize()
{
  QSize size = /*super.getPreferredSize();*/ QLineEdit::sizeHint();
  if (columns != 0)
  {
   //Insets insets = getInsets();
   size.setWidth( columns * getColumnWidth());
 ...
 */
/*public*/ void JTextField::setFont(QFont f) {
    QLineEdit::setFont(f);
    columnWidth = 0;
}
#if 0
 ...
 */
/*public*/ /*synchronized*/ void JTextField::addActionListener(ActionListener* l)
{
...
{
 void emit enterField();
}
void JTextField::leaveEvent(QEvent *)
{
 void emit leaveField();
}
/**
 ...
 * @since JDK1.1
 */
/*public*/ void JTextField::setName(QString name) {
    QString oldName;
...
Document* JTextField::getDocument()
{
 return doc;
}
