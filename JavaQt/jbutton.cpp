 ...
 */
/*public*/ JButton::JButton(QWidget *parent) :
  QPushButton(parent) {
    //this(null, null);
 common("", QIcon());
}
 ...
 */
/*public*/ JButton::JButton(QIcon icon,QWidget *parent) :
...
/*public*/ JButton::JButton(QString text, QWidget *parent) :
 ...
 * @since 1.3
 */
/*public*/ JButton::JButton(Action* a,QWidget *parent) :
  QPushButton(parent)
{
 //this();
 setAction(a);
 ...
 * @param icon  the Icon image to display on the button
 */
/*public*/ JButton::JButton(QString text, QIcon icon, QWidget *parent) :
...
void JButton::common(QString, QIcon)
{
...
/*protected*/ QString paramString() {
    QString defaultCapableString = (defaultCapable ? "true" : "false");
