...
//        ("provider", "Provider");
     ...
     */
    /*protected*/ Provider::Provider(QString name, double version, QString info) {
        this->name = name;
     ...
     */
    /*public*/ QString Provider::getName() {
        return name;
    }
     ...
     */
    /*public*/ double Provider::getVersion() {
        return version;
    }
     ...
     */
    /*public*/ QString Provider::getInfo() {
        return info;
    }
     ...
     * for this provider.
     */
    /*public*/ QString Provider::toString() {
     ...
     */
    //@Override
    /*public*/ /*synchronized*/ void Provider::clear() {
     ...
     */
    //@Override
    /*public*/ /*synchronized*/ QVariant Provider::put(QVariant key, QVariant value) {
        check("putProviderProperty."+name);
#if 0
        if (debug != null) {
    ...
    //@Override
    /*public*/ QVariant Provider::get(QVariant key) {
        checkInitialized();
...
#endif
    /*private*/ void Provider::checkInitialized() {
        if (!initialized) {
            throw new IllegalStateException();
        }
    }

    /*private*/ void Provider::check(QString directive) {
        checkInitialized();
#if 0
    ...
    /*private*/ void Provider::putId() {
        // note: name and info may be null
        Properties::put("Provider.id name", (name));
        Properties::put("Provider.id version", (version));
        Properties::put("Provider.id info", (info));
        Properties::put("Provider.id className", this->metaObject()->className());
    }
#if 0
