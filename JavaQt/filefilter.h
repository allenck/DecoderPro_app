...
class File;
class QString;
/*public*/ /*abstract*/ class FileFilter : public QObject
{
    //Q_OBJECT
 public:
    FileFilter(QObject* parent = 0) : QObject(parent) {}
    /**
     * Whether the given file is accepted by this filter.
     */
    /*public*/ /*abstract*/ virtual bool accept(File* /*f*/) {return true;}

    /**
     * The description of this filter. For example: "JPG and GIF Images"
     * @see FileView#getName
     */
    /*public*/ /*abstract*/ virtual QString getDescription() {return "";}
signals:
