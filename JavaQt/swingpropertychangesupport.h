#ifndef SWINGSwingPropertyChangeSupport_H
#define SWINGSwingPropertyChangeSupport_H
...
class JAVAQTSHARED_EXPORT SwingPropertyChangeSupport : public QObject,  public PropertyChangeProvider, public PropertyChangeFirer
{
  Q_OBJECT
  Q_INTERFACES(PropertyChangeProvider PropertyChangeFirer)
 public:
    explicit SwingPropertyChangeSupport(QObject *parent = 0);
 /**
  * Constructs a <code>SwingPropertyChangeSupport</code> object.
  *
  * @param sourceBean  The bean to be given as the source for any events.
  */
 SwingPropertyChangeSupport(QObject* sourceBean, QObject *parent = 0);
 /**
  ...
  */
 /*public*/ void firePropertyChange(PropertyChangeEvent* event) const override;
 /**
  ...
  * @since 1.5
  */
//  /*public*/ void fireIndexedPropertyChange(QString propertyName, int index, int oldValue, int newValue)override;
 /**
  ...
  * @since 1.5
  */
//  /*public*/ void fireIndexedPropertyChange(QString propertyName, int index, bool oldValue, bool newValue)override;
...
#endif // SWINGSwingPropertyChangeSupport_H
