 ...
 */
//@Override
/*protected*/ QVector<PropertyChangeListener *> PropertyChangeListenerMap::newArray(int length) {
    return (0 < length)
            ? QVector< PropertyChangeListener*>()
            : /*EMPTY*/QVector< PropertyChangeListener*>();
}
