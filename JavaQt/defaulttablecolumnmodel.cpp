...
TableColumnModel(parent)
{
 ...
 tableColumns =  QVector<TableColumn*>();
 ...
 * @see     #removeColumn
 */
/*public*/ void DefaultTableColumnModel::addColumn(TableColumn* aColumn)
{
 if (aColumn == NULL)
 {
 ...
 * @see     #addColumn
 */
/*public*/ void DefaultTableColumnModel::removeColumn(TableColumn* column) {
 ...
 */
/*public*/ void DefaultTableColumnModel::setColumnMargin(int newMargin) {
 ...
 * @see     #getColumns
 */
/*public*/ int DefaultTableColumnModel::getColumnCount() {
 ...
 */
/*public*/ QListIterator<TableColumn*> DefaultTableColumnModel::getColumns()
{
 //return tableColumns.elements();
 return QListIterator<TableColumn*>(tableColumns.toList());
}
#if 0
/**
 ...
 * @see     #setColumnMargin
 */
/*public*/ int DefaultTableColumnModel::getColumnMargin() {
    return columnMargin;
}
#if 0
/**
 ...
 */
/*public*/ void DefaultTableColumnModel::setSelectionModel(ListSelectionModel* newModel)
{
 if (newModel == NULL)
 {
 ...
 */
/*public*/ ListSelectionModel* DefaultTableColumnModel::getSelectionModel() {
 ...
 */
/*public*/ void DefaultTableColumnModel::setColumnSelectionAllowed(bool flag) {
 ...
 * @see EventListenerList
 */
/*protected*/ void DefaultTableColumnModel::fireColumnMarginChanged()
{
//    // Guaranteed to return a non-NULL array
//    Object[] listeners = listenerList.getListenerList();
//    // Process the listeners last to first, notifying
...
#endif
/*private*/ void DefaultTableColumnModel::invalidateWidthCache() {
    totalColumnWidth = -1;
}
