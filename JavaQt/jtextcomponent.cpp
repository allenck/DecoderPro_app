...
//JTextComponent::JTextComponent(QWidget *parent) :
//    QLineEdit(parent)
//{
//}
/**
 ...
 */
/*public*/ JTextComponent::JTextComponent(QWidget *parent) : QTextBrowser(parent)
{
    //super();
 ...
 *       expert: true
 */
/*public*/ void JTextComponent::setDocument(Document* doc) {
    Document* old = model;
#if 0 // TODO:
    /*
 ...
 * @return the model
 */
/*public*/ Document* JTextComponent::getDocument() {
    return model;
}
#if 0
    ...
    if (dropMode == DropMode.USE_SELECTION) {
        if (textLocation == null) {
            if (state != null) {
                ...
                caret.setVisible(((Boolean)vals[2]).boolValue());
            }
        } else {
        ...
        if (textLocation == null) {
            if (state != null) {
                caret.setVisible(((Boolean)state).boolValue());
            }
        } else {
            if (dropLocation == null) {
                bool visible = caret instanceof DefaultCaret
...
/*public*/ void replaceSelection(String content) {
    ...
    if (doc != null) {
        try {
            bool composedTextSaved = saveComposedText(caret.getDot());
...
/**
 * Returns the bool indicating whether this
...
/**
 * Sets the specified bool to indicate whether or not this
 * <code>TextComponent</code> should be editable.
 * A PropertyChange event ("editable") is fired when the
 * state is changed.
 *
 * @param b the bool to be set
 * @see #isEditable
 * @beaninfo
 ...
 * {@link #print(MessageFormat, MessageFormat, bool, PrintService, PrintRequestAttributeSet, bool)
 ...
 *
 * @see #print(MessageFormat, MessageFormat, bool, PrintService, PrintRequestAttributeSet, bool)
 *
 * @since 1.6
 */
 ...
 * @since 1.6
 */
/*public*/ bool print(final MessageFormat headerFormat,
 ...
 *
 * <p>
 * {@code showPrintDialog bool} parameter allows you to specify whether
 ...
 *
 * <p>
 * {@code interactive bool} parameter allows you to specify
...
/*public*/ bool print(final MessageFormat headerFormat,
    ...
    final bool isHeadless = GraphicsEnvironment.isHeadless();
    final bool isEventDispatchThread =
        ...
        if (doc != null) {
            try {
                if (s != null && s.length() > 0) {
                    bool composedTextSaved = saveComposedText(index);
...
// call this new method instead and return only the string portion
     ...
     * @since 1.4
     */
    /*public*/ bool doAccessibleAction(int i) {
        Action [] actions = JTextComponent.this.getActions();
        if (i < 0 || i >= actions.length) {
            return false;
        }
...
static class DefaultTransferHandler extends TransferHandler implements
    ...
    /*public*/ bool canImport(JComponent comp,
 ...
 * has been checked.
 */
private bool checkedInputOverride;
private bool needToSendKeyTypedEvent;
...
static class DefaultKeymap implements Keymap {
    ...
    /*public*/ bool isLocallyDefined(KeyStroke key) {
...
static class KeymapActionMap extends ActionMap {
    ...
    /*public*/ Object[] keys() {
        ...
        int sCount = (sKeys == null) ? 0 : sKeys.length;
        int keymapCount = (keymapKeys == null) ? 0 : keymapKeys.length;
        bool hasDefault = (keymap.getDefaultAction() != null);
        if (hasDefault) {
            keymapCount++;
        }
        if (sCount == 0) {
 ...
 * @since 1.7
 */
protected bool saveComposedText(int pos) {
    if (composedTextExists()) {
 ...
 */
private bool shouldSynthensizeKeyEvents() {
...
//
private bool isProcessInputMethodEventOverridden() {
    if (overrideMap == null) {
