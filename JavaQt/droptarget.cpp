 ...
 * @see java.awt.GraphicsEnvironment#isHeadless
 */
//    /*public*/ DropTarget::DropTarget(QWidget* c, int ops, DropTargetListener* dtl)
////throw (HeadlessException)
//    {
////        this(c, ops, dtl, true);
//    }
...
/*public*/ /*synchronized*/ void DropTarget::setComponent(Component* c)
{
 if (component == c || (component != NULL && component==(c)))
  return;
...
/*public*/ /*synchronized*/ Component* DropTarget::getComponent()
{
 return component;
}
...
/*public*/ void DropTarget::setDefaultActions(int ops)
{
 ...
 */
void DropTarget::doSetDefaultActions(int ops) {
    actions = ops;
}
...
/*public*/ int DropTarget::getDefaultActions() {
    return actions;
}
...
/*public*/ /*synchronized*/ void DropTarget::setActive(bool isActive)
{
 if (isActive != active)
 {
  active = isActive;
...
/*public*/ bool DropTarget::isActive() {
    return active;
}
#if 0
/**
 ...
 */
#endif
/*public*/ /*synchronized*/ void DropTarget::addDropTargetListener(DropTargetListener* dtl) //throw (TooManyListenersException)
{
    if (dtl == NULL) return;

    if ((DropTargetListener*)this == (dtl)) throw new IllegalArgumentException("DropTarget may not be its own Listener");
...
/*public*/ /*synchronized*/ void DropTarget::removeDropTargetListener(DropTargetListener* dtl) {
 ...
 * @see #isActive
 */
/*public*/ /*synchronized*/ void DropTarget::dragExit(QDragLeaveEvent* dte) {
    isDraggingInside = false;
 ...
 * @see #isActive
 */
/*public*/ /*synchronized*/ void DropTarget::drop(QDropEvent* dtde) {
    isDraggingInside = false;
...
/*public*/ FlavorMap* DropTarget::getFlavorMap() { return flavorMap; }
...
/*public*/ void DropTarget::addNotify(ComponentPeer* peer) {
...
//    }
    ...
    if(qobject_cast<DropTargetPeer*>(peer)!= NULL)
    {
        nativePeer = peer;
...
/*public*/ void DropTarget::removeNotify(ComponentPeer* /*peer*/)
{
 if (nativePeer != NULL)
 ...
 /*synchronized (this)*/
 {
  if (isDraggingInside)
  {
   dragExit((QDragLeaveEvent*)new DropTargetEvent(getDropTargetContext()));
  }
 }
}
...
/*public*/ DropTargetContext* DropTarget::getDropTargetContext()
{
...
#endif
DropTargetListener* DropTarget::getListener()
{
 return dtListener;
}
