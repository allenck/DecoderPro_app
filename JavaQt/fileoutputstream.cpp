...
//{
     ...
     * @see        java.lang.SecurityManager#checkWrite(java.lang.String)
     */
    /*public*/ FileOutputStream::FileOutputStream(File* file) throw (FileNotFoundException) {
        this(file, false);
    }
#endif
    /**
...
//        fd.attach(this);
        ...
        throw (FileNotFoundException)
    {
     ...
     if(append)
     {
      isOpen = qf->open(QIODevice::WriteOnly | QIODevice::Append);
     }
     else
     {
      isOpen = qf->open(QIODevice::WriteOnly);
     }
    }
