...
//DataFlavor::DataFlavor(QObject *parent) :
//    QObject(parent)
//{
//}
/**
 ...
 */
/*protected*/ /*final*/ /*static*/ QObject* DataFlavor::tryToLoadClass(QString className,
...
//    }
    ...
    Q_UNUSED(id)
     ...
     {
      return (QObject*)new ReporterIcon();
     }
     else
#endif
       return NULL;
 ...
 * private initializer
 */
/*static*/ /*private*/ DataFlavor* DataFlavor::createConstant(QObject* rc, QString prn) {
    try {
 ...
 * private initializer
 */
/*static*/ /*private*/ DataFlavor* DataFlavor::createConstant(QString mt, QString prn) {
    try {
 ...
 * </pre>
 */
 /*public*/ /*static*/ /*final*/ DataFlavor* DataFlavor::stringFlavor = createConstant("text/plain", "Unicode String");
 ...
 * </pre>
 */
/*public*/ /*static*/ /*final*/ DataFlavor* DataFlavor::imageFlavor = createConstant("image/x-java-image; class=java.awt.Image", "Image");
#if 0
/**
 ...
 */
/*public*/ /*static*/ /*final*/ DataFlavor* DataFlavor::javaFileListFlavor = createConstant("application/x-java-file-list;class=java.util.List", "");
 ...
 */
/*public*/ /*static*/ /*final*/ QString DataFlavor::javaJVMLocalObjectMimeType = "application/x-java-jvm-local-objectref";
 ...
 * transferred.
 */
/*public*/ /*static*/ /*final*/ QString DataFlavor::javaRemoteObjectMimeType = "application/x-java-remote-object";
 ...
 */
/*private*/ DataFlavor::DataFlavor(QString primaryType, QString subType, MimeTypeParameterList* params, QObject* representationClass, QString humanPresentableName, QObject *parent) : QObject(parent)
{
    //super();
    if (primaryType == "") {
 ...
 */
/*public*/ DataFlavor::DataFlavor(QObject* representationClass, QString humanPresentableName, QObject *parent) : QObject(parent)
{
    //this("application", "x-java-serialized-object", NULL, representationClass, humanPresentableName);
    QString primaryType = "application";
    QString subType = "x-java-serialized-object";
    ...
    try {
        ...
        log->error("MimeType Parse Exception: " + mtpe->getMessage(), mtpe);
        throw new IllegalArgumentException("MimeType Parse Exception: " + mtpe->getMessage());
    }
...
/*public*/ DataFlavor::DataFlavor(QString mimeType, QString humanPresentableName, QObject *parent) : QObject(parent){
    ...
    try {
        ...
        log->error("failed to parse:" + mimeType, mtpe);
        throw new IllegalArgumentException("failed to parse:" + mimeType);
    } catch (ClassNotFoundException* cnfe) {
        log->error("can't find specified class: " + cnfe->getMessage(), cnfe);
 ...
 * @exception NullPointerException if <code>mimeType</code> is NULL
 */
/*public*/ DataFlavor(QString mimeType, QString humanPresentableName, ClassLoader classLoader) throws ClassNotFoundException {
    super();
    if (mimeType == NULL) {
        throw new NullPointerException("mimeType");
    }
...
/*private*/ void DataFlavor::initialize(QString mimeType, QString humanPresentableName, ClassLoader* /*classLoader*/) /*throw (MimeTypeParseException, ClassNotFoundException)*/
{
 ...
 QString rcn = getParameter("class");
 ...
 */
/*public*/ QString DataFlavor::toString() {
    QString string = /*getClass().getName();*/metaObject()->className();
    string += "["+paramString()+"]";
    return string;
}

/*private*/ QString DataFlavor::paramString() {
    QString params = "";
    params += "mimetype=";
    if (mimeType == NULL) {
        params += "NULL";
...
//    }
    QHashIterator<QString, QString> iter(*mimeType->parameters->parameters);
    while(iter.hasNext())
    {
        iter.next();
 ...
 * @since 1.3
 */
/*public*/ /*static*/ /*final*/ DataFlavor* DataFlavor::getTextPlainUnicodeFlavor() {
    QString encoding = "";
...
/*public*/ static /*final*/ DataFlavor* selectBestTextFlavor(
                                   QList<DataFlavor*>* availableFlavors) {
 ...
 */
/*public*/ QString DataFlavor::getMimeType() {
 ...
 */
/*public*/ QString DataFlavor::getHumanPresentableName() {
 ...
 */
/*public*/ QString DataFlavor::getPrimaryType() {
 ...
 */
/*public*/ QString DataFlavor::getSubType() {
 ...
 */
/*public*/ QString DataFlavor::getParameter(QString paramName) {
    if (paramName==("humanPresentableName")) {
        return humanPresentableName;
    } else {
 ...
 */
/*public*/ void DataFlavor::setHumanPresentableName(QString humanPresentableName)
{
 this->humanPresentableName = humanPresentableName;
}
 ...
 * @see #selectBestTextFlavor
 */
/*public*/ bool DataFlavor::equals(QObject* o)
{
 return ((qobject_cast<DataFlavor*>(o)!=NULL) && equals((DataFlavor*)o));
}
 ...
 * @see #selectBestTextFlavor
 */
/*public*/ bool DataFlavor::equals(DataFlavor* that)
{
 if (that == NULL)
 {
  return false;
...
#if 0
  if ("text"==(getPrimaryType()) &&
            DataTransferer.doesSubtypeSupportCharset(this) &&
            representationClass != NULL &&
            !(isRepresentationClassReader() ||
              QString.class.equals(representationClass) ||
 ...
 * @since 1.3
 */
/*public*/ bool DataFlavor::match(DataFlavor* that) {
    return equals(that);
}
...
/*public*/ /*final*/ bool DataFlavor::isMimeTypeEqual(DataFlavor* dataFlavor)
{
...
/*private*/ bool DataFlavor::isMimeTypeEqual(MimeType* mtype)
{
    if (this->mimeType == NULL) {
        return (mtype == NULL);
    }
...
#endif
void DataFlavor::setMimeTypeParameter(QString k, QString v)
{
 mimeType->setParameter(k,v);
}
