...
QString JLabel::LABELED_BY_PROPERTY = "labeledBy";
float JLabel::LEFT_ALIGNMENT = 0.0f;
/**
 ...
 *           <code>TRAILING</code>.
 */
///*public*/ JLabel::JLabel(QIcon* image, int horizontalAlignment, QWidget *parent) : QLabel(parent) {
//    init();
 ...
 */
/*public*/ void JLabel::setText(QString text)
{
    QString oldAccessibleName = NULL;
 ...
 * @see #setLabelFor
 */
/*public*/ int JLabel::getDisplayedMnemonic() {
    return mnemonic;
}
#if 0 // TODO::
/**
 ...
 *
 * @since 1.4
 * @param index Index into the QString to underline
 ...
 *        bound: true
 *    attribute: visualUpdate true
 *  description: the index into the QString to draw the keyboard character
 *               mnemonic at
 */
 ...
 */
/*protected*/ int JLabel::checkHorizontalKey(int key, QString message) {
    if ((key == LEFT) ||
        (key == CENTER) ||
        (key == RIGHT) ||
        (key == LEADING) ||
 ...
 * @see #setVerticalTextPosition
 */
/*protected*/ int JLabel::checkVerticalKey(int key, QString message) {
 ...
 * @see #setVerticalAlignment
 */
/*public*/ int JLabel::getVerticalAlignment() {
 ...
 */
/*public*/ void JLabel::setVerticalAlignment(int alignment) {
 ...
 * @see SwingConstants
 */
/*public*/ int JLabel::getHorizontalAlignment() {
...
//  if(getItem() != NULL)
//  {
//   getItem()->setPos(_x, _y);
//   getItem()->update();
//  }
// }
}
void JLabel::setLocation(int x, int y)
{
 setLocation((double)x,(double) y);
}

QPointF JLabel::getLocation()
{ return QPointF(_x,_y);}

void JLabel::setSize(double w, double h)
{
 _w = w;
 _h = h;
}
 ...
 * @see SwingConstants
 */
/*public*/ int JLabel::getHorizontalTextPosition() {
 ...
 *               relative to its image.
 */
/*public*/ void JLabel::setHorizontalTextPosition(int textPosition) {
 ...
 */
/*public*/ bool imageUpdate(Image img, int infoflags,
 ...
 */
/*protected*/ QString paramQString() {
    QString textQString = (text != NULL ?
                         text : "");
    QString defaultIconQString = ((defaultIcon != NULL)
                                && (defaultIcon != this)  ?
                                defaultIcon.toString() : "");
    QString disabledIconQString = ((disabledIcon != NULL)
                                 && (disabledIcon != this) ?
                                 disabledIcon.toString() : "");
    QString labelForQString = (labelFor  != NULL ?
                             labelFor.toString() : "");
    QString verticalAlignmentQString;
    if (verticalAlignment == TOP) {
        verticalAlignmentQString = "TOP";
    } else if (verticalAlignment == CENTER) {
        verticalAlignmentQString = "CENTER";
    } else if (verticalAlignment == BOTTOM) {
        verticalAlignmentQString = "BOTTOM";
    } else verticalAlignmentQString = "";
    QString horizontalAlignmentQString;
    if (horizontalAlignment == LEFT) {
        horizontalAlignmentQString = "LEFT";
    } else if (horizontalAlignment == CENTER) {
        horizontalAlignmentQString = "CENTER";
    } else if (horizontalAlignment == RIGHT) {
        horizontalAlignmentQString = "RIGHT";
    } else if (horizontalAlignment == LEADING) {
        horizontalAlignmentQString = "LEADING";
    } else if (horizontalAlignment == TRAILING) {
        horizontalAlignmentQString = "TRAILING";
    } else horizontalAlignmentQString = "";
    QString verticalTextPositionQString;
    if (verticalTextPosition == TOP) {
        verticalTextPositionQString = "TOP";
    } else if (verticalTextPosition == CENTER) {
        verticalTextPositionQString = "CENTER";
    } else if (verticalTextPosition == BOTTOM) {
        verticalTextPositionQString = "BOTTOM";
    } else verticalTextPositionQString = "";
    QString horizontalTextPositionQString;
    if (horizontalTextPosition == LEFT) {
        horizontalTextPositionQString = "LEFT";
    } else if (horizontalTextPosition == CENTER) {
        horizontalTextPositionQString = "CENTER";
    } else if (horizontalTextPosition == RIGHT) {
        horizontalTextPositionQString = "RIGHT";
    } else if (horizontalTextPosition == LEADING) {
        horizontalTextPositionQString = "LEADING";
    } else if (horizontalTextPosition == TRAILING) {
        horizontalTextPositionQString = "TRAILING";
    } else horizontalTextPositionQString = "";

    return super.paramQString() +
    ",defaultIcon=" + defaultIconQString +
    ",disabledIcon=" + disabledIconQString +
    ",horizontalAlignment=" + horizontalAlignmentQString +
    ",horizontalTextPosition=" + horizontalTextPositionQString +
    ",iconTextGap=" + iconTextGap +
    ",labelFor=" + labelForQString +
    ",text=" + textQString +
    ",verticalAlignment=" + verticalAlignmentQString +
...
/*protected*/ class AccessibleJLabel extends AccessibleJComponent
     ...
     */
    /*public*/ QString getAccessibleName() {
        QString name = accessibleName;

        if (name == NULL) {
            name = (QString)getClientProperty(AccessibleContext.ACCESSIBLE_NAME_PROPERTY);
        }
        if (name == NULL) {
     ...
     * returned.
     *
     * @param i the index into the QString
    ...
    /**
     * Returns the QString at a given index.
     *
     ...
     * @since 1.3
     */
    /*public*/ QString getAtIndex(int part, int index) {
        ...
        case AccessibleText.WORD:
            try {
                QString s = getText(0, getCharCount());
    ...
    /**
     * Returns the QString after a given index.
     *
     * @param part the AccessibleText.CHARACTER, AccessibleText.WORD,
     * or AccessibleText.SENTENCE to retrieve
     * @param index an index within the text >= 0
     ...
     * @since 1.3
     */
    /*public*/ QString getAfterIndex(int part, int index) {
        if (index < 0 || index >= getCharCount()) {
            return NULL;
        }
        switch (part) {
    ...
    /**
     * Returns the QString before a given index.
     *
     * @param part the AccessibleText.CHARACTER, AccessibleText.WORD,
     *   or AccessibleText.SENTENCE to retrieve
     * @param index an index within the text >= 0
     ...
     * @since 1.3
     */
    /*public*/ QString getBeforeIndex(int part, int index) {
     ...
     *
     * @return the QString portion of the text that is selected
     * @since 1.3
     */
    /*public*/ QString getSelectedText() {
        // Text cannot be selected.
        return NULL;
    }
     ...
     */
    /*private*/ QString getText(int offset, int length)
    ...
    /*private*/ Rectangle getTextRectangle() {
        ...
        QString text = JLabel.this.getText();
        ...
        QString clippedText = SwingUtilities.layoutCompoundLabel(
     ...
     * @since 1.4
     */
    /*public*/ QString getTitledBorderText() {
...
#endif
/*public*/ void JLabel::setAlignmentX(float alignmentX)
{
...
//}
/*public*/ void JLabel::setName(QString name)
{
