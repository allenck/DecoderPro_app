...
JmDNS::JmDNS(QObject *parent) : QObject(parent)
{

}

bool JmDNS::isClosing() {return false;}
bool JmDNS::isClosed() {return false;}
 ...
 /*public*/ abstract class JmDNS implements Closeable {
      ...
      */
     /*public*/ /*static*/ QString JmDNS::VERSION = "unknown";
#if 0
     static {
         try {
      ...
      */
     /*public*/ /*abstract*/ QString JmDNS::getName() {return "";}
      ...
      * @return Host name
      */
     /*public*/ /*abstract*/ QString JmDNS::getHostName() {return "";}
      ...
      */
     /*public*/ /*abstract*/ void JmDNS::unregisterService(ServiceInfo* /*info*/) {}

     /**
      * Unregister all services.
      */
     /*public*/ /*abstract*/ void JmDNS::unregisterAllServices() {}
#if 0
     /**
