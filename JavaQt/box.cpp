 ...
 */
/*public*/ Box::Box(QBoxLayout::Direction axis, QWidget *parent) :
  QWidget(parent)
{
    //super();
 ...
 * @return the box
 */
/*public*/ /*static*/ Box* Box::createHorizontalBox()
{
 return new Box(QBoxLayout::LeftToRight);
}
 ...
 * @return the box
 */
/*public*/ /*static*/ Box* Box::createVerticalBox() {
    return new Box(QBoxLayout::TopToBottom);
}
 ...
 */
/*public*/ /*static*/ QWidget* Box::createRigidArea(QSize d) {
 ...
 * @see #createRigidArea
 */
/*public*/ /*static*/ QWidget* Box::createHorizontalStrut(int width) {
 ...
 * @return the component
 */
/*public*/ /*static*/ QWidget* Box::createGlue() {
    return new Filler( QSize(0,0),  QSize(0,0),
                       QSize(SHRT_MAX, SHRT_MAX));
}
 ...
 * @return the component
 */
/*public*/ /*static*/ QWidget* Box::createHorizontalGlue() {
    return new Filler(QSize(0,0), QSize(0,0),
                      QSize(SHRT_MAX, 0));
}
 ...
 * @return the component
 */
/*public*/ /*static*/ QWidget* Box::createVerticalGlue() {
    return new Filler(QSize(0,0), QSize(0,0),
                      QSize(0, SHRT_MAX));
}
...
///*public*/ static class Filler extends JComponent implements Accessible {
    ...
    /*public*/ Filler::Filler(QSize min, QSize pref, QSize max)
    {
        setMinimumSize(min);
        resize(pref);
        setMaximumSize(max);
     ...
     */
    /*public*/ void Filler::changeShape(QSize min, QSize pref, QSize max) {
        setMinimumSize(min);
        resize(pref);
        setMaximumSize(max);
        repaint();
