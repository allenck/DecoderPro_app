#ifndef JVETOABLECHANGESUPPORT_H
#define JVETOABLECHANGESUPPORT_H
...
class JVetoableChangeSupport : public QObject
{
 Q_OBJECT
public:
 explicit JVetoableChangeSupport(QObject *source);
...
#endif // JVETOABLECHANGESUPPORT_H
