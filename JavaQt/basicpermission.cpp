 ...
 */
/*public*/ BasicPermission::BasicPermission(QString name) :Permission(name) {
    //super(name);
    init(name);
}
 ...
 * @throws IllegalArgumentException if {@code name} is empty.
 */
/*public*/ BasicPermission::BasicPermission(QString name, QString actions) : Permission(name) {
    //super(name);
    init(name);
}
 ...
 */
/*public*/ bool BasicPermission::implies(Permission* p) {
    if ((p == NULL) || (p->metaObject() != metaObject()))
        return false;
 ...
 */
/*public*/ bool BasicPermission::equals(QObject* obj) {
    if (obj == this)
        return true;

    if ((obj == NULL) || (obj->metaObject() != metaObject())) // className??
        return false;
