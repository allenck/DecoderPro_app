...
//{
/*private*/ /*static*/ /*final*/ QString JDialog::defaultLookAndFeelDecoratedKey = QString("JDialog.defaultLookAndFeelDecorated");

/**
     * The do-nothing default window close operation.
     */
    /*public*/ /*static*/ /*final*/ int JDialog::DO_NOTHING_ON_CLOSE = 0;

    /**
     * The hide-window default window close operation
     */
    /*public*/ /*static*/ /*final*/ int JDialog::HIDE_ON_CLOSE = 1;
/**
     ...
     */
    /*public*/ /*static*/ /*final*/ int JDialog::DISPOSE_ON_CLOSE = 2;
     ...
     */
    /*public*/ /*static*/ /*final*/ int JDialog::EXIT_ON_CLOSE = 3;
#if 0
/**
 ...
 * @see JComponent#getDefaultLocale
 */
/*public*/ JDialog::JDialog(QWidget* owner, bool modal)
    : QDialog(owner)
{
    //this(owner, "", modal);
 this->modal = modal;
 ...
 * @see JComponent#getDefaultLocale
 */
/*public*/ JDialog::JDialog(QWidget* owner, QString title, bool modal) : QDialog(owner)
{
 setTitle(title);
 ...
 */
/*protected*/ void JDialog::dialogInit()
{
 defaultCloseOperation = HIDE_ON_CLOSE;
 rootPaneCheckingEnabled = false;
 log = new Logger("JDialog");

 _listeners = new QList<WindowListener*>();
 ...
 */
/*public*/ void JDialog::setDefaultCloseOperation(int operation) {
...
* @see #setDefaultCloseOperation
*/
/*public*/ int JDialog::getDefaultCloseOperation() {
 ...
 */
/*public*/ QWidget* JDialog::getContentPane() {
...
void JDialog::setSize(int w, int h)
{
 resize(w,h);
}
void JDialog::toFront()
{
 raise();
 activateWindow();
 show();
...
void JDialog::setLocation(int x, int y)
{
 move(x,y);
}
/**
 ...
 * window smaller
 */
void JDialog::reSizeToFitOnScreen()
{
 ...
 this->move(positionX, this->pos().y());
    ...
    if (log->isDebugEnabled()) log->debug("reSizeToFitOnScreen sets height "+QString::number(height)+" width "+QString::number(width));
}
/**
 ...
 */
/*public*/ QSize JDialog::getPreferredSize() {
    ...
    if (log->isDebugEnabled()) log->debug("getPreferredSize returns width "+QString::number(width)+" height "+QString::number(height));
 ...
 */
/*public*/ QSize JDialog::getMaximumSize()
{
...
#endif
void JDialog::setTitle(QString t) { setWindowTitle(t);}
QPoint JDialog::getLocationOnScreen()
{
 return pos();
}
void JDialog::setLocation(QPoint p)
{
 setLocation(p.x(),p.y());
}
/*public*/ void JDialog::windowClosing(QCloseEvent* /*e*/) {
    handleModified();
}
void JDialog::addWindowListener(WindowListener* l)
{
 _listeners->append(l);
}
void JDialog::closeEvent(QCloseEvent* e)
{
 foreach(WindowListener* l, *_listeners)
 {
  l->windowClosing(e);
 }
}
