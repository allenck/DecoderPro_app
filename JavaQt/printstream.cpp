...
//{
    ...
    /*private*/ PrintStream::PrintStream(bool autoFlush, QDataStream* out, QObject *parent = nullptr)
    : FilterOutputStream(out, parent)
    {
        //super(out);
        common(autoFlush, out);
    }

    void   PrintStream::common(bool autoFlush, QDataStream *out)
    {
        if (out == nullptr)
    ...
    /*private*/ void PrintStream::init(OutputStreamWriter* osw) {
        this->charOut = osw;
     ...
     */
    /*public*/ PrintStream::PrintStream(QDataStream* out, bool autoFlush, QObject* parent) :FilterOutputStream(parent) {
        common(autoFlush, out);
...
#endif
    /*private*/ void PrintStream::write(QString s) {
        try {
            /*synchronized (this)*/ {
                ensureOpen();
                ((Writer*)textOut)->write(s);
                textOut->flushBuffer();
                charOut->flushBuffer();
#if 0
...
//        }
    ...
    /*private*/ void PrintStream::newLine() {
        try {
            /*synchronized (this)*/ {
                ensureOpen();
                textOut->newLine();
...
//        }
     ...
     */
    /*public*/ void PrintStream::print(QString s) {
        if (s.isEmpty()) {
            s = "null";
        }
        write(s);
     ...
     * character (<code>'\n'</code>).
     */
    /*public*/ void PrintStream::println() {
        newLine();
    }
#if 0
    /**
    ...
    /*public*/ void PrintStream::println(QString x) {
        /*synchronized (this)*/ {
            print(x);
            newLine();
        }
