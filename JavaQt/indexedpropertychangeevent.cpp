...
//IndexedPropertyChangeEvent::IndexedPropertyChangeEvent(QObject *parent)
//{
//}
/**
...
//public class IndexedPropertyChangeEvent extends PropertyChangeEvent {
     ...
     */
    IndexedPropertyChangeEvent::IndexedPropertyChangeEvent(QObject* source, QString propertyName,
     ...
     *         changed.
     */
    /*public*/ int IndexedPropertyChangeEvent::getIndex() {
        return index;
    }

    void IndexedPropertyChangeEvent::appendTo(QString sb) {
        sb.append("; index=").append(QString("%1").arg(getIndex()));
    }
