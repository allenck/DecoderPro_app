 ...
 */
 ...
 class QAction;
 class QFrame;
/*public*/ /*interface*/ class JAVAQTSHARED_EXPORT WindowInterface : public QWidget
 {
  Q_OBJECT
 public:
     WindowInterface(QWidget* parent = 0);
     WindowInterface(const WindowInterface&) :QWidget() {}
     /**
     ...
     */
    /*public*/ virtual void show(JmriPanel* /*child*/, QAction* /*action*/ ) {}
     ...
     */
    /*public*/ virtual void show(JmriPanel* /*child*/, QAction* /*action*/, Hint /*hint*/ ) {}
