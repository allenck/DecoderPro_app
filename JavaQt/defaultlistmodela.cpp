#include "defaultlistmodela.h"
#include <QVector>

//template <class T>
//DefaultListModelA::DefaultListModelA(QObject *parent) :
...
//{
     ...
     */
    template<class T>
    /*public*/ int DefaultListModelA<T>::getSize() {
        return delegate->size();
    }

     template<class T>
    /*public*/ int DefaultListModelA<T>::rowCount(const QModelIndex &parent) const{
    return delegate->size();
}
    /**
     ...
     */
    template<class T>
    /*public*/ T DefaultListModelA<T>::getElementAt(int index) {
        return delegate->at(index);
    }
    template<class T>
    QVariant DefaultListModelA<T>::data(const QModelIndex &index, int role) const{
        if(role == Qt::DisplayRole)
        {
         //QVariant var = delegate->at(index.row());
         return delegate->at(index.row()).toString();
        }
        return QVariant();
    }
#if 0
     ...
     */
    template <class T>
    /*public*/ int DefaultListModelA<T>::indexOf(QString elem) {
     ...
     */
    template<class T>
    /*public*/ T DefaultListModelA<T>::elementAt(int index) {
        return delegate->at(index);
    }
#if 0
    /**
     ...
     */
    template<class T>
    /*public*/ void DefaultListModelA<T>::removeElementAt(int index) {
   ...
   /*public*/ String toString() {
     ...
     */
    template<class T>
    /*public*/ void DefaultListModelA<T>::add(int index, T element) {
...
//    /*public*/ E remove(int index) {
    template<class T>
    /*public*/ T DefaultListModelA<T>::remove(int index) {
        T rv = delegate->at(index);
        delegate->remove(index);
//        fireIntervalRemoved(this, index, index);
        return rv;
    }
