...
//
CharBuffer::CharBuffer(int mark, int pos, int lim, int cap,   // package-private
            QByteArray hb, int offset, QObject* parent) : Buffer(mark, pos, lim, cap, parent)
{
...
//
CharBuffer::CharBuffer(int mark, int pos, int lim, int cap, QObject* parent) : Buffer(mark, pos, lim, cap, parent)
{ // package-private
...
/*public*/ int CharBuffer::read(CharBuffer* target) throw (IOException) {
    ...
    if (_remaining == 0)
        return -1;
    int n = qMin(_remaining, targetRemaining);
    int _limit = limit();
    ...
    /*finally*/ {
        limit(_limit); // restore real limit
    }
    return n;
}
#if 0
 ...
 */
/*public*/ /*abstract*/ char CharBuffer::get() {return ' ';}
 ...
 */
/*public*/ /*abstract*/ CharBuffer* CharBuffer::put(char c) {return this;}
#if 0
/**
 ...
 *          If this buffer is read-only
 */
/*public*/ CharBuffer*CharBuffer:: put(QByteArray src, int offset, int length) {
 ...
 *          If this buffer is read-only
 */
/*public*/ /*final*/ CharBuffer* CharBuffer::put(QByteArray src) {
 ...
 *          If this buffer is read-only
 */
/*public*/ CharBuffer* CharBuffer::put(QString src, int start, int end) {
 ...
 *          If this buffer is read-only
 */
/*public*/ /*final*/ CharBuffer* CharBuffer::put(QString src) {
    return put(src, 0, src.length());
}
