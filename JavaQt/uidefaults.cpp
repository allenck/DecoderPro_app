...
UIDefaults::UIDefaults(QObject *parent)
    : QObject{parent}
{
    hashtable = {

        {"Tree.selectionBackground", "#FFFF"},
        {"Tree.font", "Times,10,-1, 0"},
        {"Tree.selectionForeground", "#0000"}
...
//        return (value != null) ? value : getFromResourceBundle(key, null);
     ...
     *          <code>null</code>
     */
    /*public*/ QFont UIDefaults::getFont(QString key) {
//        Object value = get(key);
//        return (value instanceof Font) ? (Font)value : null;
     QVariant v = hashtable.value(key);
     QStringList sl = v.toString().split(",");
     return QFont(sl.at(0), sl.at(1).toInt(), sl.at(2).toInt(), sl.at(3).toInt());
    }
     ...
     * @since 1.4
     */
    /*public*/ QFont UIDefaults::getFont(QString key, QLocale l) {
...
//        return (value instanceof Font) ? (Font)value : null;
     ...
     *          <code>null</code>
     */
    /*public*/ QColor UIDefaults::getColor(QString key) {
        //        Object value = get(key);
