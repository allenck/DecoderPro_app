    ...
    ui(new Ui::Booster7Widget)
{
    ...
    Turnout* t =(Turnout*)((ProxyTurnoutManager*)InstanceManager::getDefault("TurnoutManager"))->TurnoutManager::getBySystemName("LT"+QString::number(data->getAddr(channel)))->self();
    if(t)
    {
