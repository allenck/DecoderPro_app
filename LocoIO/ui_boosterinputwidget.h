...
public:
    ...
    void setupUi(QWidget *BoosterInputWidget)
    {
        if (BoosterInputWidget->objectName().isEmpty())
            BoosterInputWidget->setObjectName(QString::fromUtf8("BoosterInputWidget"));
    ...
    {
        BoosterInputWidget->setWindowTitle(QCoreApplication::translate("BoosterInputWidget", "Form", nullptr));
        lblfiller->setText(QString());
#if QT_CONFIG(tooltip)
        rbBlockDetectionActiveLow->setToolTip(QCoreApplication::translate("BoosterInputWidget", "<html><head/><body><p>Block detection active high.  Generate an OPC_INPUT_REP (0xB2) message.</p></body></html>", nullptr));
