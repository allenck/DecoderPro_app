...
public:
    ...
    void setupUi(QWidget *BoosterOutputWidget)
    {
        if (BoosterOutputWidget->objectName().isEmpty())
            BoosterOutputWidget->setObjectName(QString::fromUtf8("BoosterOutputWidget"));
        ...
        tbPower->setObjectName(QString::fromUtf8("tbPower"));
    ...
    {
        BoosterOutputWidget->setWindowTitle(QCoreApplication::translate("BoosterOutputWidget", "Form", nullptr));
        ...
        tbPower->setToolTip(QCoreApplication::translate("BoosterOutputWidget", "<html><head/><body><p><span style=\" font-family:'sans-serif'; font-size:15px;\">The relays will NOT be switched on with a fixed contact output = ON if one or both feedback are not been available or an OPC_GPOFF (0x82) or OPC_IDLE (0x85) command is received</span></p><p><br/></p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        tbPower->setText(QCoreApplication::translate("BoosterOutputWidget", "On", nullptr));
        label_3->setText(QString());
#if QT_CONFIG(tooltip)
        rb1On->setToolTip(QCoreApplication::translate("BoosterOutputWidget", "<html><head/><body><p>Push button on at power up <span style=\" font-family:'sans-serif'; font-size:15px;\">and when receiving an input signal, will switch on the output.</span></p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        rb1On->setText(QString());
#if QT_CONFIG(tooltip)
        rb1Off->setToolTip(QCoreApplication::translate("BoosterOutputWidget", "<html><head/><body><p>Push button off at power up. Booster will have to be switched on by a command.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
