...
public:
    ...
    void setupUi(QWidget *BoosterOutputWidget)
    {
        if (BoosterOutputWidget->objectName().isEmpty())
            BoosterOutputWidget->setObjectName(QLatin1String("BoosterOutputWidget"));
        ...
        tbPower->setObjectName(QLatin1String("tbPower"));
    ...
    {
        BoosterOutputWidget->setWindowTitle(QApplication::translate("BoosterOutputWidget", "Form", nullptr));
...
#endif // QT_NO_TOOLTIP
        tbPower->setText(QApplication::translate("BoosterOutputWidget", "On", nullptr));
        label_3->setText(QString());
#ifndef QT_NO_TOOLTIP
        rb1On->setToolTip(QApplication::translate("BoosterOutputWidget", "<html><head/><body><p>Push button on at power up <span style=\" font-family:'sans-serif'; font-size:15px;\">and when receiving an input signal, will switch on the output.</span></p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        rb1On->setText(QString());
#ifndef QT_NO_TOOLTIP
        rb1Off->setToolTip(QApplication::translate("BoosterOutputWidget", "<html><head/><body><p>Push button off at power up. Booster will have to be switched on by a command.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
