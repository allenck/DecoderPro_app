...
namespace Operations
{
 ...
 public:
  ...
  /*public*/ QString getNumber() const;
  /*public*/ void setRoadName(QString road) ;
  /*public*/ QString getRoadName() const;
  ...
  /*public*/ Train* getTrain() const;
  /*public*/ QString getTrainName() const;
  /*public*/ virtual void setTypeName(QString type);
  /*public*/ virtual QString getTypeName()const ;
  /*public*/ Location* getDestination() ;
  /*public*/ void setDestination(Location* destination);
  /*public*/ QString getDestinationName() const;
  /*public*/ QString getDestinationId();
  /*public*/ void setDestinationTrack(Track* track);
  /*public*/ Track* getDestinationTrack() ;
  /*public*/ QString getDestinationTrackName() const;
  ...
  /*public*/ QString getValue() const;
  /*public*/ void setMoves(int moves);
  /*public*/ int getMoves() const;
  ...
  /*public*/ QString getBuilt() const;
  /*public*/ QString getStatus() const;
  /*public*/ Location* getLocation() ;
  /*public*/ QString getLocationName() const;
  /*public*/ QString getLocationId();
  /*public*/ void setTrack(Track* track);
  /*public*/ QString getTrackName() const;
  /*public*/ QString getTrackId();
  /*public*/ void setOwner(QString owner) ;
  /*public*/ QString getOwner() const;
  /*public*/ void setLocationUnknown(bool unknown);
  /*public*/ bool isLocationUnknown() const;
  /*public*/ void setOutOfService(bool outOfService);
  /*public*/ void setBlocking(int number);
  /*public*/ int getBlocking() const;
  /*public*/ bool isOutOfService() const;
