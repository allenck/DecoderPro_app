 ...
 * </pre>
 */
//export/*public*/ class ExportTimetable extends XmlFile {

    /*public*/ ExportTimetable::ExportTimetable(QObject* parent) : XmlFile(parent){
        // nothing to do
    }
...
//    }
    ...
    /*public*/ void ExportTimetable::writeOperationsTimetableFile() {
#if 0
...
#endif
    /*public*/ File* ExportTimetable::getExportFile() {
        return new File(findFile(defaultOperationsFilename())->fileName());
    }

    // Operation files always use the same directory
    /*public*/ /*static*/ QString ExportTimetable::defaultOperationsFilename() {
        return Operations::OperationsSetupXml::getFileLocation() +
                Operations::OperationsSetupXml::getOperationsDirectoryName() +
                File::separator +
                getOperationsFileName();
    }

    /*public*/ /*static*/ void ExportTimetable::setOperationsFileName(QString name) {
        operationsFileName = name;
    }

    /*public*/ /*static*/ QString ExportTimetable::getOperationsFileName() {
        return operationsFileName;
    }

    /*private*/ /*static*/ QString ExportTimetable::operationsFileName = "ExportOperationsTimetable.csv"; // NOI18N

    /*private*/ /*final*/ /*static*/ Logger* ExportTimetable::log = LoggerFactory::getLogger("ExportTimetable");
}
