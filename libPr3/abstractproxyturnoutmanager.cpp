...
/*protected*/ int AbstractProxyTurnoutManager::matchTentative(QString systemname) const
{
 ...
 for (int i = 0; i<nMgrs(); i++)
 {
  ...
  char tl = ((AbstractManager*)mgr->self())->typeLetter();
#endif
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ /*synchronized*/ void AbstractProxyTurnoutManager::addVetoableChangeListener(VetoableChangeListener* listener) {
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ /*synchronized*/ void AbstractProxyTurnoutManager::removeVetoableChangeListener(VetoableChangeListener* listener) {
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ void AbstractProxyTurnoutManager::addVetoableChangeListener(QString propertyName, VetoableChangeListener* listener) {
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ void AbstractProxyTurnoutManager::removeVetoableChangeListener(QString propertyName, VetoableChangeListener* listener) {
...
//@Override
//@Nonnull
/*public*/ SystemConnectionMemo* AbstractProxyTurnoutManager::getMemo() const{
    try {
