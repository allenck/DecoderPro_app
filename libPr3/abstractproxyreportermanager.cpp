...
/*protected*/ AbstractManager* AbstractProxyReporterManager::getMgr(int index) const
{
 // make sure internal present
 initInternal();
 ...
 */
/*public*/ QList<AbstractManager *> AbstractProxyReporterManager::getManagerList() const
{
 // make sure internal present
 initInternal();
 ...
 */
/*public*/ QList<AbstractManager *> AbstractProxyReporterManager::getDisplayOrderManagerList() const {
    // make sure internal present
    initInternal();

    QList<AbstractManager*> retval =  QList<AbstractManager*>();
    if (defaultManager != nullptr) { retval.append((AbstractManager*)defaultManager->self()); }
...
/*public*/ AbstractManager *AbstractProxyReporterManager::getInternalManager() const{
    initInternal();
 ...
 */
/*public*/ AbstractManager* AbstractProxyReporterManager::getDefaultManager() const {
    if (defaultManager != nullptr) return defaultManager;

    return getInternalManager();
}

/*public*/ void AbstractProxyReporterManager::addManager(AbstractManager *m)
{
...
/*private*/ AbstractManager *AbstractProxyReporterManager::initInternal() const
{
...
/*abstract protected*/ AbstractManager* AbstractProxyReporterManager::makeInternalManager() const
{
 return nullptr;
}
...
//@Override
//@CheckReturnValue
/*public*/ /*@Nonnull*/ QString AbstractProxyReporterManager::normalizeSystemName(/*@Nonnull*/ QString inputName) const /*throw new (NamedBean::BadSystemNameException)*/ {
 ...
 */
/*protected*/ NamedBean* AbstractProxyReporterManager::provideNamedBean(QString name)
{
 ...
 */
/*public*/ NamedBean* AbstractProxyReporterManager::newNamedBean(QString systemName, QString userName) {
 // make sure internal present
 initInternal();
...
/*public*/ void AbstractProxyReporterManager::dispose() {
...
/*public synchronized*/ void AbstractProxyReporterManager::addPropertyChangeListener(PropertyChangeListener* l)
{
...
/*public synchronized*/ void AbstractProxyReporterManager::removePropertyChangeListener(PropertyChangeListener* l)
{
// if (propertyListenerList.contains(l)) {
...
/*public*/ void AbstractProxyReporterManager::addPropertyChangeListener(QString propertyName, PropertyChangeListener* listener) {
...
//@Override
//@OverridingMethodsMustInvokeSuper
///*public*/ QVector<PropertyChangeListener*> AbstractProxyReporterManager::getPropertyChangeListeners() {
...
//@Override
//@OverridingMethodsMustInvokeSuper
///*public*/ QVector<PropertyChangeListener*> AbstractProxyReporterManager::getPropertyChangeListeners(QString propertyName) {
//    if (!namedPropertyListenerMap.contains(propertyName)) {
//        namedPropertyListenerMap.insert(propertyName, new QVector<PropertyChangeListener*>());
//    }
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ void AbstractProxyReporterManager::removePropertyChangeListener(QString propertyName, PropertyChangeListener* listener) {
//    if (!namedPropertyListenerMap.contains(propertyName)) {
//        namedPropertyListenerMap.insert(propertyName, new QVector<PropertyChangeListener*>());
//    }
...
//@Override
//@OverridingMethodsMustInvokeSuper
///*public*/ QVector<VetoableChangeListener*> AbstractProxyReporterManager::getVetoableChangeListeners() {
...
//@Override
//@OverridingMethodsMustInvokeSuper
///*public*/ QVector<VetoableChangeListener*> AbstractProxyReporterManager::getVetoableChangeListeners(QString propertyName) {
...
//@Override
//@Nonnull
/*public*/ SystemConnectionMemo* AbstractProxyReporterManager::getMemo() const{
    try {
...
//@CheckReturnValue
//@Override
/*public*/ int AbstractProxyReporterManager::getObjectCount() {
    int count = 0;
    for (Manager/*<E>*/* m : mgrs) { count += m->getObjectCount(); }
    return count;
}

/*public*/ QStringList AbstractProxyReporterManager::getSystemNameArray() {
 ...
 */
/*public*/ QStringList AbstractProxyReporterManager::getSystemNameList() {
    //TreeSet<QString> ts = new TreeSet<String>(new SystemNameComparator());
    QSet<QString>* ts = new QSet<QString>();
    for (int i = 0; i<nMgrs(); i++) {
...
/*protected*/ void AbstractProxyReporterManager::updateOrderList() {
...
/*public*/ QStringList AbstractProxyReporterManager::getSystemNameAddedOrderList() {
...
//@Deprecated  // will be removed when Manager method is removed due to @Override
//@Nonnull
/*public*/ QList<NamedBean*>* AbstractProxyReporterManager::getNamedBeanList() {
...
NamedBeanComparator<NamedBean*> comparator5 = NamedBeanComparator<NamedBean*>();

bool sortLessThanconst5( NamedBean* s1,  NamedBean* s2)
{
 return comparator5.compare(s1, s2) < 0;
}
...
// initialize logging
/*private*/ /*final*/ /*static*/ Logger* AbstractProxyReporterManager::log = LoggerFactory::getLogger("AbstractProxyTurnoutManager");
