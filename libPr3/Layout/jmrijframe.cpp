 ...
 */
/*public*/ JmriJFrame::JmriJFrame(bool saveSize, bool savePosition, QObject* parent)  : QWidget(parent)
{
super();
 ...
 */
/*public*/ JmriJFrame::JmriJFrame(QObject* parent) : QWidget(parent)
{
    this(true, true);
}
 ...
 */
/*public*/ JmriJFrame::JmriJFrame(QString name, QObject* parent) : QWidget(parent){
    this(name, true, true);
}
 ...
 * @param savePosition - Set true to save the last known location
 */
/*public*/ JmriJFrame::JmriJFrame(QString name, bool saveSize, bool savePosition,, QObject* parent) : QWidget(parent){
...
/*public*/ void generateWindowRef(){
    QString initref = this.getClass().getName();
    if((this.getTitle()!=null) && (!this.getTitle().equals(""))){
...
/*public*/ QString getWindowFrameRef(){ return windowFrameRef; }
...
void addWindowCloseShortCut() {
    ...
    // build a key code
    QString modifier = KeyStroke.getKeyStroke(KeyEvent.VK_W, stdMask).toQString();
    QString keyCode = modifier.substring(0, modifier.length()-1)+Bundle.getMessage("VkKeyWindowClose").substring(0,1);
    ...
    try {
        ...
        try {
            ...
            if (widthInset == 0 && heightInset == 0) {
                QString osName = SystemType.getOSName();
            ...
            QString sw = System.getProperty("jmri.inset.width");
            if (sw!=null) try {
                widthInset = Integer.parseInt(sw);
            } catch (Exception e1) {log.error("Error parsing jmri.inset.width: "+e1);}
            QString sh = System.getProperty("jmri.inset.height");
            if (sh!=null) try {
 ...
 */
/*public*/ bool getModifiedFlag() { return modifiedFlag; }
...
/*protected*/ void handleModified() {
    if (getModifiedFlag()) {
        ...
        int result = javax.swing.JOptionPane.showOptionDialog(this,
            ...
            null, // icon
            new QString[]{Bundle.getMessage("WarnYesSave"),Bundle.getMessage("WarnNoClose")},
 ...
 * coding pattern.
 */
/*protected*/ HashMap<QString, Object> properties = new HashMap<QString, Object>();

/*public*/ void setIndexedProperty(QString key, int index, Object value) {
...
/*public*/ Object getIndexedProperty(QString key, int index) {
...
/*public*/ void setProperty(QString key, Object value) {
    if (Beans.hasIntrospectedProperty(this, key)) {
...
// subclasses should override this method with something more direct and faster
/*public*/ Object getProperty(QString key) {
    if (properties.containsKey(key)) {
...
/*public*/ Set<QString> getPropertyNames() {
    HashSet<QString> names = new HashSet<QString>();
