#ifndef CONNECTIONTYPELIST_H
#define CONNECTIONTYPELIST_H
...
public:
     ...
     */
    //@Nonnull
 /*public*/ virtual QStringList getAvailableProtocolClasses() {return QStringList();}
     ...
     */
    //@Nonnull
    /*public*/ virtual QStringList  getManufacturers() {return QStringList();}
};
#endif // CONNECTIONTYPELIST_H
