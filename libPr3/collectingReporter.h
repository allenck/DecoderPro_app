#ifndef COLLECTINGREPORTER_H
#define COLLECTINGREPORTER_H
 ...
 * @see jmri.Reporter
 */
/*public*/ /*interface*/class CollectingReporter /*: public Reporter*/ {
  //Q_INTERFACES(Reporter)
 public:
     /**
      * @return the collection of elements associated with this reporter.
      */
     /*public*/virtual Collection getCollection()=0;

};
Q_DECLARE_INTERFACE(CollectingReporter, "CollectingReporter")
#endif // COLLECTINGREPORTER_H
