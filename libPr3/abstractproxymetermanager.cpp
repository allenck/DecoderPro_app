 ...
 */
/*protected*/ int AbstractProxyMeterManager::nMgrs() const
{
...
/*protected*/ Manager* AbstractProxyMeterManager::getMgr(int index) const
{
 // make sure internal present
 initInternal();
 ...
 */
/*public*/ NamedBean* AbstractProxyMeterManager::getNamedBean(QString name) const
{
 ...
 */
/*protected*/ NamedBean* AbstractProxyMeterManager::provideNamedBean(QString name)
{
 ...
 */
/*abstract protected*/ NamedBean* AbstractProxyMeterManager::makeBean(int /*index*/, QString /*systemName*/, QString /*userName*/) /*const*/
{
// Q_UNUSED(index);
// Q_UNUSED(systemName);
// Q_UNUSED(userName);
...
//@Override
/*public*/ NamedBean* AbstractProxyMeterManager::getBeanBySystemName(QString systemName) const
{
 //NamedBean* t = nullptr;
...
//@Override
/*public*/ NamedBean* AbstractProxyMeterManager::getBeanByUserName(QString userName) const
{
 foreach (Manager* m, this->mgrs) {
 ...
 */
/*public*/ NamedBean* AbstractProxyMeterManager::newNamedBean(QString systemName, QString userName) {
 // make sure internal present
 initInternal();
 ...
 * error
 */
/*protected*/ int AbstractProxyMeterManager::matchTentative(QString systemname) const
{
...
#endif
//  if ( systemname.startsWith(((AbstractManager*)mgr)->getSystemPrefix()+((AbstractProxyMeterManager*)mgr)->typeLetter()))
 ...
 */
/*protected*/ int AbstractProxyMeterManager::match(QString systemname)const {
    int index = matchTentative(systemname);
 ...
 */
/*public*/ void AbstractProxyMeterManager::deregister(NamedBean* s) const{
    QString systemName = s->getSystemName();
    getMgr(match(systemName))->deregister(s);
}

/*public synchronized*/ void AbstractProxyMeterManager::addPropertyChangeListener(PropertyChangeListener* l)
{
...
/*public synchronized*/ void AbstractProxyMeterManager::removePropertyChangeListener(PropertyChangeListener* l)
{
 if (propertyListenerList.contains(l)) {
...
/*public*/ void AbstractProxyMeterManager::addPropertyChangeListener(QString propertyName, PropertyChangeListener* listener) {
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ QVector<PropertyChangeListener*> AbstractProxyMeterManager::getPropertyChangeListeners() {
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ QVector<PropertyChangeListener*> AbstractProxyMeterManager::getPropertyChangeListeners(QString propertyName) {
    if (!namedPropertyListenerMap.contains(propertyName)) {
        namedPropertyListenerMap.insert(propertyName, new QVector<PropertyChangeListener*>());
    }
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ void AbstractProxyMeterManager::removePropertyChangeListener(QString propertyName, PropertyChangeListener* listener) {
    if (!namedPropertyListenerMap.contains(propertyName)) {
        namedPropertyListenerMap.insert(propertyName, new QVector<PropertyChangeListener*>());
    }
 ...
 */
/*public*/ QString AbstractProxyMeterManager::getSystemPrefix() const {
//    try {
 ...
 */
/*public*/ char AbstractProxyMeterManager::typeLetter() const
{
 ...
 */
/*public*/ QString AbstractProxyMeterManager::makeSystemName(QString s) const {
...
//@CheckReturnValue
//@Override
/*public*/ int AbstractProxyMeterManager::getObjectCount() {
    int count = 0;
    for (Manager/*<E>*/* m : mgrs) { count += m->getObjectCount(); }
    return count;
}

/*public*/ QStringList AbstractProxyMeterManager::getSystemNameArray() {
 ...
 */
/*public*/ QStringList AbstractProxyMeterManager::getSystemNameList() {
    //TreeSet<QString> ts = new TreeSet<String>(new SystemNameComparator());
    QSet<QString>* ts = new QSet<QString>();
    for (int i = 0; i<nMgrs(); i++) {
...
/*protected*/ void AbstractProxyMeterManager::updateOrderList() {
...
/*public*/ QStringList AbstractProxyMeterManager::getSystemNameAddedOrderList() {
...
//@Deprecated  // will be removed when Manager method is removed due to @Override
//@Nonnull
/*public*/ QList<NamedBean*>* AbstractProxyMeterManager::getNamedBeanList() {
...
/*protected*/ void AbstractProxyMeterManager::recomputeNamedBeanSet() {
...
/*protected*/ void AbstractProxyMeterManager::updateNamedBeanSet()
{
 //if (namedBeanSet.isEmpty()) return; // only maintain if requested
 namedBeanSet.clear();
 for (Manager* m : mgrs)
...
NamedBeanComparator<NamedBean*> comparator6 = NamedBeanComparator<NamedBean*>();

bool sortLessThanconst6( NamedBean* s1,  NamedBean* s2)
{
 return comparator6.compare(s1, s2)  < 0;
}

/** {@inheritDoc} */
//@Override
//@Nonnull
/*public*/ /*SortedSet<E>*/QSet<NamedBean*> AbstractProxyMeterManager::getNamedBeanSet() {
    ...
    qSort(list.begin(), list.end(), sortLessThanconst6); //NamedBeanComparator<NamedBean*>::compare);
    return list.toSet();
}
 ...
 */
///*public*/ QStringList AbstractProxyMeterManager::getUserNameList() const
//{
// //TreeSet<QString> ts = new TreeSet<String>(new SystemNameComparator());
// QSet<QString>* ts = new QSet<QString>();
// for (int i = 0; i<nMgrs(); i++)
...
void AbstractProxyMeterManager::propertyChange(PropertyChangeEvent */*e*/)
{
 //emit this->propertyChange(e);
}
// initialize logging
/*private*/ /*final*/ /*static*/ Logger* AbstractProxyMeterManager::log = LoggerFactory::getLogger("AbstractProxyMeterManager");
