...
///*public*/ class CodeButtonSimulator {
    ...
    /*public*/ CodeButtonSimulator::CodeButtonSimulator(QObject *parent) : QObject(parent) {
        // Used to satisfy test requirement
        _mCodeButtonSensor = nullptr;
        _mSwitchLeverSensor = nullptr;
        _mLeftSensor = nullptr;
        _mNormalSensor = nullptr;
        _mRightSensor = nullptr;
        _mDispatcherSensorLockToggle = nullptr;
        _mAnySensorPropertyChangeListener = nullptr;
        _mPauseTimer = nullptr;
        _mPauseActionListener = nullptr;
    }

    /*public*/ CodeButtonSimulator::CodeButtonSimulator( int                     pauseTimeInMilliseconds,
        ...
        if (switchDirectionLever != nullptr) {
        ...
        if (signalDirectionLever != nullptr) {
        ...
        _mAnySensorPropertyChangeListener = new AnySensorPropertyChangeListener(this);
        ...
        _mPauseActionListener = new PauseActionListener(this);
        _mPauseTimer = new Timer(pauseTimeInMilliseconds, _mPauseActionListener);
        _mPauseTimer->setRepeats(false);
    }

    /*public*/ void CodeButtonSimulator::removeAllListeners() {
...
//  (i.e. within the pause time interval), then we do nothing here:
    /*private*/ void CodeButtonSimulator::anySensorPropertyChangeEvent() {
