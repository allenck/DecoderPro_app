#ifndef VARIABLELIGHT_H
#define VARIABLELIGHT_H
#include "analogio.h"
#include "light.h"
...
//    @InvokeOnLayoutThread
    ...
    /** {@inheritDoc} */
    //@Override
    virtual /*default*/ /*public*/ bool isConsistentState() {
#if 1
        return (Light::getState() == ON)
                || (Light::getState() == OFF)
                || (Light::getState() == INTERMEDIATE);
#endif
    }

    /** {@inheritDoc} */
    //@Override
    virtual/*default*/ /*public*/ bool isConsistentValue() {
     ...
     */
    //@InvokeOnLayoutThread
    virtual /*public*/ void setTargetIntensity(double intensity) =0;
     ...
     */
    virtual /*public*/ double getCurrentIntensity()=0;
     ...
     */
    virtual /*public*/ double getTargetIntensity() = 0;
     ...
     */
    //@InvokeOnLayoutThread
    virtual /*public*/ void setMaxIntensity(double intensity) = 0;
     ...
     */
    virtual /*public*/ double getMaxIntensity() = 0;
     ...
     */
    //@InvokeOnLayoutThread
    virtual /*public*/ void setMinIntensity(double intensity) =0;
     ...
     */
    virtual /*public*/ double getMinIntensity() =0;
     ...
     */
    virtual /*public*/ bool isTransitionAvailable() = 0;
     ...
     */
    //@InvokeOnLayoutThread
    virtual /*public*/ void setTransitionTime(double minutes) =0;
     ...
     */
    virtual /*public*/ double getTransitionTime() = 0;
