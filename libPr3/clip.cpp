...
///*public*/ interface Clip extends DataLine {
     ...
     * @see #loop
     */
    /*public*/ /*static*/ /*final*/ int Clip::LOOP_CONTINUOUSLY = -1;
/*public*/ Clip::Clip(QObject *parent) : DataLine(parent) {}
     ...
     * @see LineListener
     */
    /*public*/ bool Clip::open(QAudioFormat* /*format*/, QByteArray* /*data*/, int /*offset*/, int /*bufferSize*/) /*throws LineUnavailableException*/ {return false;}
     ...
     * @see LineListener
     */
    /*public*/ void Clip::open(AudioInputStream* stream) /*throws LineUnavailableException, IOException*/ {}
     ...
     */
    /*public*/ int Clip::getFrameLength() {return 0;}
     ...
     * @see AudioSystem#NOT_SPECIFIED
     */
    /*public*/ long Clip::getMicrosecondLength() {return 0;}
     ...
     */
    /*public*/ void Clip::setFramePosition(int /*frames*/) {}
     ...
     */
    /*public*/ void Clip::setMicrosecondPosition(long /*microseconds*/) {}
     ...
     */
    /*public*/ void Clip::setLoopPoints(int /*start*/, int /*end*/) {}
     ...
     */
    /*public*/ void Clip::loop(int count) {}
