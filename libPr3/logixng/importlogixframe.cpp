...
//        contentPanel.setLayout(new GridLayout( 0, 1));
        ...
        addAction(new QAction(tr("Which Logixs to import?")));
...
//        r2.setSelected(true);
        ...
        layout()->addWidget(new JTitledSeparator(tr("What to do with the Logixs after the import?")));
...
//        _whatToDo_Disable.setSelected(true);
        ...
        layout()->addWidget(new JTitledSeparator(tr("Import system Logixs also?")));
...
//            }
//        });
        layout()->addWidget(_includeSystemLogixs);

        contentPanel->layout()->addWidget(Box::createRigidArea(QSize(0, 15)));    // vertical space.

        layout()->addWidget(new JTitledSeparator(tr("Select which Logixs to import")));
