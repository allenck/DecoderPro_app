...
//public  class DigitalBooleanFactory implements DigitalBooleanActionFactory {
    ...
    /*public*/ QSet<QHash<Category*, /*Class<? extends Base>*/QString>> DigitalBooleanFactory::getClasses() {
        ...
        digitalBooleanActionClasses.insert(QHash<Category*, QString> {{Category::COMMON, "DigitalBooleanMany"}});
        digitalBooleanActionClasses.insert(QHash<Category*, QString> {{Category::COMMON, "DigitalBooleanOnChange"}});
