...
namespace Actions {
 ...
 class Data;
 class LogData : public AbstractDigitalAction, public PropertyChangeListener, VetoableChangeListener
 {
   Q_OBJECT
...
//   /*public*/  QString toString()override;
  ...
  private:
   ...
   /*private*/ /*final*/ QList<LogData::Data>* _dataList = new QList<LogData::Data>();
   /*private*/ QList<QVariant> getDataValues()  /*throws JmriException*/;


 };
}
Q_DECLARE_METATYPE(Actions::LogData)
#endif // LOGDATA_H
