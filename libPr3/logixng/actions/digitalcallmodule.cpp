...
// /*public*/  class DigitalCallModule extends AbstractDigitalExpression implements VetoableChangeListener {
 ...
 /*public*/  DigitalCallModule::DigitalCallModule(QString sys, QString user, QObject* parent)
  : AbstractDigitalAction(sys, user, parent) /*throws BadUserNameException, BadSystemNameException*/
 {
     //super(sys, user);
 }
 ...
 /** {@inheritDoc} */
 //@Override
 /*public*/  void DigitalCallModule::execute() /*throws JmriException*/ {
     if (_moduleHandle == nullptr) return ;
     ...
     if (! (qobject_cast<FemaleDigitalActionSocket*>(femaleSocket->bself()))) {
     ...
     ((FemaleDigitalActionSocket*)femaleSocket->bself())->execute();
