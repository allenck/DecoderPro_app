#ifndef EX_DIGITALCALLMODULESWING_H
#define EX_DIGITALCALLMODULESWING_H
...
{
 class DigitalCallModuleSwing : public AbstractDigitalExpressionSwing
 {
   Q_OBJECT
  public:
...
Q_DECLARE_METATYPE(Expressions::DigitalCallModuleSwing)
#endif // EX_DIGITALCALLMODULESWING_H
