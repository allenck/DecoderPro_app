...
public:
    ...
    void retranslateUi(QMainWindow *RosterFrame)
    {
        ...
        throttleLaunch->setText(QApplication::translate("RosterFrame", "Throttle", nullptr));
        btnRosterMedia->setText(QApplication::translate("RosterFrame", "Labels && Media", nullptr));
        prog1Button->setText(QApplication::translate("RosterFrame", "Program", nullptr));
