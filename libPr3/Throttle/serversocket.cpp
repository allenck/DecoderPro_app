 ...
 */
ServerSocket::ServerSocket(QTcpSocket* impl, QObject *parent) : QObject(parent) {
    this->impl = impl;
 ...
 */
/*public*/ int ServerSocket::getLocalPort() {
    if (!isBound())
        return -1;
//    try {
        return /*getImpl().getLocalPort();*/ impl->localPort();
//    } catch (SocketException e) {
//        // nothing
//        // If we're bound, the impl has been created
//        // so we shouldn't get here
 ...
 * @since 1.4
 */
/*public*/ bool ServerSocket::isBound() {
 ...
 * @since 1.4
 */
/*public*/ bool ServerSocket::isClosed() {
    /*synchronized(closeLock)*/ {
        return closed;
    }
}
