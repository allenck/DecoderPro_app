 ...
 */
/*public*/ /*interface*/class Signals : public AbstractNamedBean
{
Q_OBJECT
public:
 Signals(QObject* parent) : AbstractNamedBean(parent) {}
 Signals(QString systemName, QObject* parent) :AbstractNamedBean(systemName, parent) {}
 Signals(QString systemName, QString userName, QObject* parent) : AbstractNamedBean(systemName, userName, parent) {}
     ...
     */
    virtual /*public*/ bool isCleared() {return false;}
     ...
     *         otherwise
     */
    virtual /*public*/ bool isShowingRestricting() {return false;}
     ...
     */
    virtual /*public*/ bool isAtStop() {return false;}
     ...
     */
    virtual /*public*/ bool getHeld() = 0;

    virtual /*public*/ void setHeld(bool /*newHeld*/) {}
