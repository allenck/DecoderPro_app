...
/*public*/ void AbstractProxySensorManager::addManager(Manager* m)
{
...
/*protected*/ int AbstractProxySensorManager::matchTentative(QString systemname) const
{
 ...
 for (int i = 0; i<nMgrs(); i++)
 {
  ...
  char tl = ((AbstractProxySensorManager*)mgr)->typeLetter();
#endif
  if ( systemname.startsWith(((AbstractManager*)mgr)->getSystemPrefix()+((AbstractProxySensorManager*)mgr)->typeLetter()))
  {
   return i;
  }
 }
 ...
 */
/*public*/ void AbstractProxySensorManager::deregister(NamedBean* s) {
    QString systemName = s->getSystemName();
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ /*synchronized*/ void AbstractProxySensorManager::addVetoableChangeListener(VetoableChangeListener* l) {
