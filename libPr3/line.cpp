 ...
 */
/*public*/ void Line::open() /*throws LineUnavailableException*/ {}
 ...
 * @see #close()
 */
/*public*/ bool Line::isOpen() { return false;}
 ...
 * @see #getControl
 */
/*public*/ QList<Control*> Line::getControls() {return QList<Control*>();}
 ...
 */
/*public*/ bool Line::isControlSupported(Control::Type* /*control*/) { return false;}
 ...
 */
/*public*/ Control* Line::getControl(Control::Type* /*control*/) {return NULL;}
 ...
 * @see LineEvent
 */
/*public*/ void Line::addLineListener(LineListener* listener) {}
...
template<class T>
    /*public*/ QString Line::Info<T>::toString() {
        ...
        if (index != -1) {
            finalString = initialString.mid(0, index) + initialString.mid( (index + fullPackagePath.length()), initialString.length() );
        } else {
