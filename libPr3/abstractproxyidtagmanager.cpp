 ...
 */
/*protected*/ NamedBean* AbstractProxyIdTagManager::provideNamedBean(QString name)
{
 ...
 */
/*abstract protected*/ NamedBean* AbstractProxyIdTagManager::makeBean(int /*index*/, QString /*systemName*/, QString /*userName*/) /*const*/
{
// Q_UNUSED(index);
// Q_UNUSED(systemName);
// Q_UNUSED(userName);
 ...
 */
/*public*/ NamedBean* AbstractProxyIdTagManager::newNamedBean(QString systemName, QString userName) {
 // make sure internal present
 initInternal();
...
/*public*/ void AbstractProxyIdTagManager::dispose() {
...
/*protected*/ int AbstractProxyIdTagManager::matchTentative(QString systemname) const
{
 ...
 for (int i = 0; i<nMgrs(); i++)
 {
  ...
  char tl = ((AbstractProxyIdTagManager*)mgr)->typeLetter();
#endif
  if ( systemname.startsWith(((AbstractManager*)mgr)->getSystemPrefix()+((AbstractProxyIdTagManager*)mgr)->typeLetter()))
  {
   return i;
  }
 }
...
/*public synchronized*/ void AbstractProxyIdTagManager::addPropertyChangeListener(PropertyChangeListener* l)
{
...
/*public synchronized*/ void AbstractProxyIdTagManager::removePropertyChangeListener(PropertyChangeListener* l)
{
// if (propertyListenerList.contains(l)) {
...
/*public*/ void AbstractProxyIdTagManager::addPropertyChangeListener(QString propertyName, PropertyChangeListener* listener) {
...
//    }
 AbstractManager::addPropertyChangeListener(listener);
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ QVector<PropertyChangeListener*> AbstractProxyIdTagManager::getPropertyChangeListeners() {
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ QVector<PropertyChangeListener*> AbstractProxyIdTagManager::getPropertyChangeListeners(QString propertyName) {
    if (!namedPropertyListenerMap.contains(propertyName)) {
        namedPropertyListenerMap.insert(propertyName, new QVector<PropertyChangeListener*>());
    }
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ void AbstractProxyIdTagManager::removePropertyChangeListener(QString propertyName, PropertyChangeListener* listener) {
//    if (!namedPropertyListenerMap.contains(propertyName)) {
//        namedPropertyListenerMap.insert(propertyName, new QVector<PropertyChangeListener*>());
//    }
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ /*synchronized*/ void AbstractProxyIdTagManager::addVetoableChangeListener(VetoableChangeListener* listener) {
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ /*synchronized*/ void AbstractProxyIdTagManager::removeVetoableChangeListener(VetoableChangeListener* listener) {
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ void AbstractProxyIdTagManager::addVetoableChangeListener(QString propertyName, VetoableChangeListener* listener) {
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ QVector<VetoableChangeListener*> AbstractProxyIdTagManager::getVetoableChangeListeners() {
...
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ QVector<VetoableChangeListener*> AbstractProxyIdTagManager::getVetoableChangeListeners(QString propertyName) {
    return getVetoableChangeListeners(propertyName);
}

/** {@inheritDoc} */
//@Override
//@OverridingMethodsMustInvokeSuper
/*public*/ void AbstractProxyIdTagManager::removeVetoableChangeListener(QString propertyName, VetoableChangeListener* listener) {
...
//@Override
//@Nonnull
/*public*/ SystemConnectionMemo* AbstractProxyIdTagManager::getMemo() const{
    try {
...
//@CheckReturnValue
//@Override
/*public*/ int AbstractProxyIdTagManager::getObjectCount() {
    int count = 0;
    for (Manager/*<E>*/* m : mgrs) { count += m->getObjectCount(); }
    return count;
}

/*public*/ QStringList AbstractProxyIdTagManager::getSystemNameArray() {
 ...
 */
/*public*/ QStringList AbstractProxyIdTagManager::getSystemNameList() {
    //TreeSet<QString> ts = new TreeSet<String>(new SystemNameComparator());
    QSet<QString>* ts = new QSet<QString>();
    for (int i = 0; i<nMgrs(); i++) {
...
/*protected*/ void AbstractProxyIdTagManager::updateOrderList() {
...
/*public*/ QStringList AbstractProxyIdTagManager::getSystemNameAddedOrderList() {
...
//@Deprecated  // will be removed when Manager method is removed due to @Override
//@Nonnull
/*public*/ QList<NamedBean*>* AbstractProxyIdTagManager::getNamedBeanList() {
...
// initialize logging
/*private*/ /*final*/ /*static*/ Logger* AbstractProxyIdTagManager::log = LoggerFactory::getLogger("AbstractProxyTurnoutManager");
