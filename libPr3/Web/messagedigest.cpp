 ...
 *     QByteArray toChapter1Digest = tc1.digest();
...
///*public*/ abstract class MessageDigest extends MessageDigestSpi {
    ...
    /*private*/ /*static*/ /*final*/ int MessageDigest::INITIAL = 0;
    /*private*/ /*static*/ /*final*/ int MessageDigest::IN_PROGRESS = 1;
     ...
     */
    /*protected*/ MessageDigest::MessageDigest(QString algorithm, QObject* parent) : MessageDigestSpi(parent) {
     ...
     * @see Provider
     */
    /*public*/ static MessageDigest* getInstance(QString algorithm)
     ...
     * @see Provider
     */
    /*public*/ static MessageDigest getInstance(QString algorithm, QString provider)
     ...
     * {@code offset}.
     */
    /*public*/ void update(QByteArray input, int offset, int len) {
        if (input == null) {
     ...
     * @param input the array of bytes.
     */
    /*public*/ void update(QByteArray input) {
    ...
    /*public*/ QByteArray digest() {
        ...
        QByteArray result = engineDigest();
        state = INITIAL;
        return result;
    }
     ...
     */
    /*public*/ int digest(QByteArray buf, int offset, int len) throws DigestException {
        if (buf == null) {
     ...
     * method first calls {@link #update(QByteArray) update(input)},
     ...
     * @return the array of bytes for the resulting hash value.
     */
    /*public*/ QByteArray digest(QByteArray input) {
        update(input);
        return digest();
    }
     ...
     */
    /*public*/ static boolean isEqual(QByteArray digesta, QByteArray digestb) {
     ...
     */
    /*public*/ /*final*/ QString getAlgorithm() {
    ...
    static class Delegate extends MessageDigest {
        ...
        // constructor
        /*public*/ Delegate(MessageDigestSpi digestSpi, QString algorithm) {
            super(algorithm);
        ...
        /*protected*/ void engineUpdate(QByteArray input, int offset, int len) {
        ...
        /*protected*/ QByteArray engineDigest() {
            return digestSpi.engineDigest();
        }

        /*protected*/ int engineDigest(QByteArray buf, int offset, int len)
