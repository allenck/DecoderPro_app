...
MessageDigestSpi::MessageDigestSpi(QObject *parent) : QObject(parent)
{
 ...
 * @since 1.2
 */
/*protected*/ int MessageDigestSpi::engineGetDigestLength() {
    return 0;
}
 ...
 */
/*protected*/ /*abstract*/ void MessageDigestSpi::engineUpdate(char input) {}
 ...
 * {@code offset}.
 */
/*protected*/ /*abstract*/ void MessageDigestSpi::engineUpdate(QByteArray /*input*/, int /*offset*/, int /*len*/) {}
#if 0
/**
