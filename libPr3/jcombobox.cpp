...
//JComboBox::JComboBox(QWidget *parent) :
//    QComboBox(parent)
//{
//}
/**
...
/*public*/ JComboBox<E>::JComboBox(ComboBoxModel<F>* aModel, QWidget *parent)
    : QComboBox(parent)
{
 //super();
 setModel(aModel);
 ...
 */
template <class E>
/*public*/ JComboBox::JComboBox(QList<E>* items, QWidget *parent)
    : QComboBox(parent)
{
 //super();
 ...
 */
template <class E>
/*public*/ JComboBox::JComboBox(QVector<E>* items, QWidget *parent)
    : QComboBox(parent)
{
 //super();
 setModel(new DefaultComboBoxModel<E>(items));
 ...
 */
template <class E>
/*public*/ JComboBox::JComboBox(QWidget *parent)
    : QComboBox(parent)
{
 //super();
 ...
 */
//template <class E>
///*public*/ void JComboBox::setModel(ComboBoxModel<E>* aModel)
//{
...
// emit propertyChange(new PropertyChangeEvent(this, "model", VPtr<ComboBoxModel<E> >::asQVariant(oldModel), VPtr<ComboBoxModel<E> >::asQVariant(dataModel)));
//}
 ...
 */
template <class E>
/*public*/ ComboBoxModel<E>* JComboBox::getModel() {
    return dataModel;
}
#if 0
/*
