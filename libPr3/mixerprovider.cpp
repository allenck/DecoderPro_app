...
MixerProvider::MixerProvider(QObject *parent) : QObject(parent)
{
 ...
 * @see #getMixerInfo()
 */
/*public*/ bool MixerProvider::isMixerSupported(Mixer::Info* info) {

    QList<Mixer::Info*>* infos = getMixerInfo();
 ...
 */
/*public*/ /*abstract*/ QList<Mixer::Info*>* MixerProvider::getMixerInfo() {return nullptr;}
 ...
 * @see #isMixerSupported(javax.sound.sampled.Mixer.Info) isMixerSupported(Mixer.Info)
 */
/*public*/ /*abstract*/ QList<Mixer::Info*>* MixerProvider::getMixer(Mixer::Info* /*info*/) { return nullptr;}
