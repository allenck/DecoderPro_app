...
//FloatControl::FloatControl(QObject *parent) :
//  Control(parent)
//{
//}
/**
 ...
 */
/*protected*/ FloatControl::FloatControl(Type* type, float minimum, float maximum,
        float precision, int updatePeriod, float initialValue,
        QString units, QString minLabel, QString midLabel, QString maxLabel, QObject *parent) :
  Control(type, parent)
{
 //super(type);

 if (minimum > maximum) {
     throw new IllegalArgumentException("Minimum value " + QString::number(minimum)
             + " exceeds maximum value " + QString::number(maximum) + ".");
 }
 if (initialValue < minimum) {
     throw new IllegalArgumentException("Initial value " + QString::number(initialValue)
             + " smaller than allowable minimum value " + QString::number(minimum) + ".");
 }
 if (initialValue > maximum) {
     throw new IllegalArgumentException("Initial value " + QString::number(initialValue)
             + " exceeds allowable maximum value " + QString::number(maximum) + ".");
 }
 ...
 this->units = units;
 this->minLabel = ( (minLabel == "") ? "" : minLabel);
 this->midLabel = ( (midLabel == "") ? "" : midLabel);
 this->maxLabel = ( (maxLabel == "") ? "" : maxLabel);
}
 ...
 * within the allowable range
 */
/*public*/ void FloatControl::setValue(float newValue)
{
 if (newValue > maximum)
 {
  throw new IllegalArgumentException("Requested value " + QString::number(newValue) + " exceeds allowable maximum value " + QString::number(maximum) + ".");
 }

 if (newValue < minimum)
 {
  throw new IllegalArgumentException("Requested value " + QString::number(newValue) + " smaller than allowable minimum value " + QString::number(minimum) + ".");
 }
 ...
 */
/*public*/ float FloatControl::getValue() {
    return value;
}
 ...
 */
/*public*/ float FloatControl::getMaximum() {
    return maximum;
}
 ...
 */
/*public*/ float FloatControl::getMinimum() {
    return minimum;
}
 ...
 */
/*public*/ QString FloatControl::getUnits() {
    return units;
}
 ...
 */
/*public*/ QString FloatControl::getMinLabel() {
    return minLabel;
}
 ...
 */
/*public*/ QString FloatControl::getMidLabel() {
    return midLabel;
}
 ...
 */
/*public*/ QString FloatControl::getMaxLabel() {
    return maxLabel;
}
 ...
 */
/*public*/ float FloatControl::getPrecision() {
    return precision;
}
 ...
 * @see #shift
 */
/*public*/ int FloatControl::getUpdatePeriod() {
    return updatePeriod;
}
 ...
 * @see #getUpdatePeriod
 */
/*public*/ void FloatControl::shift(float from, float to, int microseconds) {
    // test "from" value, "to" value will be tested by setValue()
    if (from < minimum) {
        throw new IllegalArgumentException("Requested value " + QString::number(from)
                + " smaller than allowable minimum value " + QString::number(minimum) + ".");
    }
    if (from > maximum) {
        throw new IllegalArgumentException("Requested value " + QString::number(from)
 ...
 */
/*public*/ QString FloatControl::toString() {
    return QString(getType()->toString() + " with current value: " + QString::number(getValue()) + " " + units +
                      " (range: " + QString::number(minimum) + " - " + QString::number(maximum) + ")");
}
...
///*public*/ static class Type extends Control.Type {
     ...
     * @see #VOLUME
     */
    /*public*/ /*static*/ /*final*/ FloatControl::Type* FloatControl::Type::MASTER_GAIN            = new FloatControl::Type("Master Gain");
     ...
     * @see #AUX_RETURN
//     */
    /*public*/ /*static*/ /*final*/ FloatControl::Type* FloatControl::Type::AUX_SEND                       = new FloatControl::Type("AUX Send");
     ...
     * @see #AUX_SEND
     */
    /*public*/ /*static*/ /*final*/ FloatControl::Type* FloatControl::Type::AUX_RETURN                     = new FloatControl::Type("AUX Return");
     ...
     */
    /*public*/ /*static*/ /*final*/ FloatControl::Type* FloatControl::Type::REVERB_SEND            = new FloatControl::Type("Reverb Send");
     ...
     * @see #REVERB_SEND
     */
    /*public*/ /*static*/ /*final*/ FloatControl::Type* FloatControl::Type::REVERB_RETURN          = new FloatControl::Type("Reverb Return");
     ...
     */
    /*public*/ /*static*/ /*final*/ FloatControl::Type* FloatControl::Type::VOLUME                         = new FloatControl::Type("Volume");
     ...
     * @see #BALANCE
     */
    /*public*/ /*static*/ /*final*/ FloatControl::Type* FloatControl::Type::PAN                            = new FloatControl::Type("Pan");
     ...
     * @see #PAN
     */
    /*public*/ /*static*/ /*final*/ FloatControl::Type* FloatControl::Type::BALANCE                        = new FloatControl::Type("Balance");
     ...
     */
    /*public*/ /*static*/ /*final*/ FloatControl::Type* FloatControl::Type::SAMPLE_RATE            = new FloatControl::Type("Sample Rate");
     ...
     */
/*protected*/ FloatControl::Type::Type(QString name, QObject* parent) : Control::Type(name, parent)
{
 //super(name);
}
