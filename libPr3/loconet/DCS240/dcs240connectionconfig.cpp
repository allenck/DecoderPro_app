 ...
 */
/*public*/ DCS240ConnectionConfig::DCS240ConnectionConfig(SerialPortAdapter* p, QObject* parent)
 ...
 */
/*public*/ DCS240ConnectionConfig::DCS240ConnectionConfig(QObject* parent) : AbstractSerialConnectionConfig(parent) {
    //super();
}

//@Override
/*public*/ QString DCS240ConnectionConfig::name() {
    return "DCS240 USB Interface"; // NOI18N
}

//@Override
/*protected*/ void DCS240ConnectionConfig::setInstance() {
    if (adapter == nullptr) {
