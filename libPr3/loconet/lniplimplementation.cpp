...
//        });
     ...
     */
    /*public*/ /*static*/ /*final*/ LocoNetMessage* LnIPLImplementation::createQueryAllIplDevicesPacket() {
    ...
    /*public*/ void LnIPLImplementation::sendIplQueryAllDevices() {
     ...
     */
    /*public*/ void LnIPLImplementation::connect(LnTrafficController* t) {
        if (t != nullptr) {
            // connect to the LnTrafficController
     ...
     */
    //@CheckForNull
    /*public*/ /*static*/ QString LnIPLImplementation::getManufacturer(int manuf) {
        switch (manuf) {
            case LnConstants::RE_IPL_MFR_DIGITRAX:
    ...
    //@CheckForNull
    /*public*/ /*static*/ QString LnIPLImplementation::getDeviceName(int manuf, int device, int slaveManuf, int slave) {
