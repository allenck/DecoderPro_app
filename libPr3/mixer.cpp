...
/* Qt replacement for Java Mixer class */
Mixer::Mixer(QAudioDeviceInfo* deviceInfo, QObject *parent) : QObject(parent)
{
 common();
...
void Mixer::common()
{
 log = new Logger("Mixer");
}

// TODO: move these two methods to a QMixerClass
void Mixer::setDeviceInfo(QAudioDeviceInfo* deviceInfo)
{
 this->_deviceInfo = deviceInfo;
 format = _deviceInfo->preferredFormat();
}

QAudioDeviceInfo* Mixer::deviceInfo() { return _deviceInfo;}
 ...
 * @see Mixer.Info
 */
/*public*/ Mixer::Info* Mixer::getMixerInfo() { return NULL;}
 ...
 */
/*public*/ QList<Line*> Mixer::getSourceLines() { return QList<Line*>();}
 ...
 * are not available due to security restrictions
 */
/*public*/ QList<Line*> Mixer::getTargetLines() { return QList<Line*>();}
 ...
 */
/*public*/ void Mixer::synchronize(QList<Line*> lines, bool maintainSync) {}
 ...
 */
/*public*/ void Mixer::unsynchronize(QList<Line*> lines) {}
 ...
 * otherwise
 */
/*public*/ bool Mixer::isSynchronizationSupported(QList<Line*> lines, bool maintainSync) {return false;}
 ...
 */
/*protected*/ Mixer::Info::Info(QString name, QString vendor, QString description, QString version)
{
 ...
 */
/*public*/ /*final*/ bool Mixer::Info::equals(QObject* obj)
{
 //return equals(obj);
 return this == obj;
}
 ...
 */
/*public*/ /*final*/ int Mixer::Info::hashCode() {
 ...
 */
/*public*/ /*final*/ QString Mixer::Info::getName() {
    return name;
}
 ...
 */
/*public*/ /*final*/ QString Mixer::Info::getVendor() {
    return vendor;
}
 ...
 */
/*public*/ /*final*/ QString Mixer::Info::getDescription() {
    return description;
}
 ...
 */
/*public*/ /*final*/ QString Mixer::Info::getVersion() {
    return version;
}
 ...
 */
/*public*/ /*final*/ QString Mixer::Info::toString() {
