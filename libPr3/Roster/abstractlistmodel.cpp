...
AbstractListModel::AbstractListModel(QObject *parent) //: ListModel(parent)
{
 ...
 */
/*public*/ void AbstractListModel::addListDataListener(ListDataListener* l) {
 ...
 */
/*public*/ void AbstractListModel::removeListDataListener(ListDataListener* l) {
 ...
 * @since 1.4
 */
/*public*/ QList<ListDataListener*>* AbstractListModel::getListDataListeners() {
