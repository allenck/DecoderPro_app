...
//FnMapPanelESU::FnMapPanelESU(QWidget *parent) :
//    QWidget(parent)
//{
//}
/**
...
/*public*/ FnMapPanelESU::FnMapPanelESU(VariableTableModel* v, QList<int>* varsUsed, QDomElement model, RosterEntry* rosterEntry, CvTableModel* cvModel, QWidget *parent) : QWidget(parent)
{
#if 0
