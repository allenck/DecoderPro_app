...
DefaultCabSignalManager::DefaultCabSignalManager(QObject* parent) : AbstractCabSignalManager(parent)
{
...
///*public*/ class DefaultCabSignalManager extends AbstractCabSignalManager {
     ...
     */
    //@Override
    /*protected*/ CabSignal* DefaultCabSignalManager::createCabSignal(LocoAddress* address){
