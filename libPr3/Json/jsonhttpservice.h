#ifndef JSONHTTPSERVICE_H
#define JSONHTTPSERVICE_H
#include "jsonqt.h"
...
/*public*/ /*abstract*/ class JsonHttpService : public QObject
{
protected:
    /*protected*/ /*final*/ ObjectMapper mapper;

    /*protected*/ JsonHttpService(ObjectMapper mapper, QObject* parent = 0) : QObject(parent) {
        this->mapper = mapper;
    }
public:
    /**
