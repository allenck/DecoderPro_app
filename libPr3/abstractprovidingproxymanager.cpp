...
// abstract public class AbstractProvidingProxyManager<E extends NamedBean> extends AbstractProxyManager/*<E>*/* implements ProvidingManager/*<E>*/* {
     ...
     */
    //@Nonnull
    /*protected*/ /*E*/NamedBean* AbstractProvidingProxyManager::provideNamedBean(QString name) /*throws IllegalArgumentException*/ {
        // make sure internal present
        initInternal();

        /*E*/NamedBean* t = AbstractProxyManager::getNamedBean(name);
        if (t != nullptr) {
            return t;
        }
        ...
        log->debug(QString("provideNamedBean did not find manager for name %1, defer to default").arg(name)); // NOI18N
        return makeBean(getDefaultManager(), getDefaultManager()->makeSystemName(name), nullptr);
    }
    ...
    /*public*/ /*E*/NamedBean* AbstractProvidingProxyManager::newNamedBean(/*@Nonnull*/ QString systemName, QString userName)  /*throws IllegalArgumentException*/ {
        ...
        log->debug(QString("Did not find manager for system name %1, delegate to primary").arg(systemName)); // NOI18N
    ...
    // initialize logging
    /*private*/ /*final*/ Logger* AbstractProvidingProxyManager::log = LoggerFactory::getLogger("AbstractProvidingProxyManager");
