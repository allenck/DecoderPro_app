...
// /*public*/ class CabSignalTableModel extends javax.swing.table.AbstractTableModel {
     ...
     */
    //@Override
    /*public*/ int CabSignalTableModel::getRowCount() {
        return cabSignalManager->getCabSignalList().size();
    }

    //@Override
    /*public*/ int CabSignalTableModel::getColumnCount() {
        return MAX_COLUMN;
    }
     ...
     */
    //@Override
    /*public*/ QString CabSignalTableModel::getColumnName(int col) { // not in any order
        switch (col) {
            case LOCO_ID_COLUMN:
                return tr("LocoID");
            case CURRENT_BLOCK:
                return tr("Block");
            case BLOCK_DIR:
                return tr("BlockDirection");
            case REVERSE_BLOCK_DIR_BUTTON_COLUMN:
                return tr("BlockButton");
            case NEXT_BLOCK:
                return tr("NextBlock");
            case NEXT_SIGNAL:
                return tr("NextSignal");
            case NEXT_ASPECT:
                return tr("NextAspect");
     ...
     */
    //@Override
    /*public*/ QString CabSignalTableModel::getColumnClass(int col) {
        switch (col) {
            case LOCO_ID_COLUMN:
                return "LocoAddress";
            case CURRENT_BLOCK:
