#ifndef ABSTRACTPROXYSENSORMANAGER_H
#define ABSTRACTPROXYSENSORMANAGER_H
...
class LIBPR3SHARED_EXPORT AbstractProxySensorManager :  public SensorManager, public ProxyManager
{
    Q_OBJECT
    Q_INTERFACES(ProxyManager)
public:
    explicit AbstractProxySensorManager(QObject *parent = 0);
    /**
...
//    /*public*/ NamedBean* getBeanByUserName(QString userName) const override;
    ...
    QT_DEPRECATED/*public*/ QStringList getSystemNameList();
...
#endif // ABSTRACTPROXYSENSORMANAGER_H
