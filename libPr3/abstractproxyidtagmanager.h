#ifndef ABSTRACTPROXYIDTAGMANAGER_H
#define ABSTRACTPROXYIDTAGMANAGER_H
#include "manager.h"
...
class LIBPR3SHARED_EXPORT AbstractProxyIdTagManager :  public IdTagManager, public ProxyManager
{
    Q_OBJECT
    Q_INTERFACES(ProxyManager)
public:
    explicit AbstractProxyIdTagManager(QObject *parent = 0);
    /**
...
#endif // ABSTRACTPROXYIDTAGMANAGER_H
