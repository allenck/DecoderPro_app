...
/*public*/ void LnOpsModeProgrammer::addPropertyChangeListener(PropertyChangeListener* listener) {
 ...
 connect(this, SIGNAL(propertyChange(PropertyChangeEvent*)), listener->pself(), SLOT(propertyChange(PropertyChangeEvent*)));
}
...
//    SwingPropertyChangeSupport.removePropertyChangeListener(listener);
 disconnect(this, SIGNAL(propertyChange(PropertyChangeEvent*)), listener->pself(), SLOT(propertyChange(PropertyChangeEvent*)));
}
